...
```powershell
# Quick reference
notepad .\scripts\ops\CODEX_QUICK_REF.txt

# Windows-specific guide
notepad .\scripts\ops\CODEX_WINDOWS_QUICK_START.txt

# Complete setup guide
notepad .\scripts\ops\CODEX_WSL_SETUP.md

# All commands
notepad .\scripts\ops\CODEX_INDEX.txt

# Start here guide
notepad .\scripts\ops\CODEX_START_HERE.txt
```
...
3. `.\scripts\ops\setup-codex-wsl.bat`
