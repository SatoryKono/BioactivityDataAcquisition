...
summary: 'Aligned resolve_neo4j_connection audit mode with documented audit-instance
  defaults: use neo4j/[REDACTED] and port 7475 when audit-specific env
...
- Aligned resolve_neo4j_connection audit mode with documented audit-instance defaults: use neo4j/[REDACTED] and port 7475 when audit-specific env vars are absent, without falling back to default MCP credentials.
