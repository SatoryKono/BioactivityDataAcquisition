...
- Short-lived task context belongs in episodic memory until the pattern repeats or
  becomes a stable engineering rule.
- Promote a note only when it captures an architectural constraint, recurring operational
  response, or domain rule that will help future tasks.
