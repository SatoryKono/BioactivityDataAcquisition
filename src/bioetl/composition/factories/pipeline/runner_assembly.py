...
if TYPE_CHECKING:
    ...
    from bioetl.application.core.lifecycle import CheckpointManagerService, LockCoordinator
...
def _build_postrun_service_for_pipeline(
    ...
    *,
    ...
    return _build_postrun_service_for_pipeline_impl(
        context,
...
def _assemble_runner_parts(
    ...
    return _assemble_runner_parts_impl(
        ...
        postrun_service_builder=_build_postrun_service_for_pipeline,
