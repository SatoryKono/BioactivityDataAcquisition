"""Unified storage adapter for Bronze/Silver/Gold layers.

StorageAdapter implements StoragePort protocol from domain/ports.py.
Extracted from storage_factory.py for better separation of concerns.
"""
