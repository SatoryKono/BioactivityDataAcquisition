# src/bioetl/composition/factories/storage.py
"""Consolidated Storage module for Bronze/Silver/Gold layers.

Provides:
- StorageAdapter: Unified storage adapter implementing StoragePort protocol
- StorageContext: Context object with adapter and paths
- StorageFactory: Factory for creating configured StorageAdapters
