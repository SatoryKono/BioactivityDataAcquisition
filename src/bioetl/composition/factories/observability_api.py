"""Observability/data-source wiring helpers for the service bundle factory.

This module is the single owner of the observability wiring seam (#10595):
the former ``_observability_wiring`` private module was folded in here.
"""
