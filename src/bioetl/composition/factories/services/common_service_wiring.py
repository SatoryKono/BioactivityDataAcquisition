...
def assemble_pipeline_service(
    *,
    ...
    return PipelineService(
        ...
        bronze_dq_analyzer=cast(
            "BronzeDQAnalyzerPort | None", dq_services.bronze_analyzer
        ),
        silver_dq_analyzer=cast(
            "SilverDQAnalyzerPort | None", dq_services.silver_analyzer
        ),
