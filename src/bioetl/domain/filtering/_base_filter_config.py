"""Shared filter configuration logic for Gold and Silver layers."""
...
class BaseFilterConfig:
    """Базовая конфигурация фильтров для Gold/Silver слоёв."""
    ...
    def from_base(cls, other: BaseFilterConfig) -> Self:
        """Create config instance from another BaseFilterConfig instance."""
        return cls(
