...
class ChEMBLActivityGoldSchema(pa.DataFrameModel):
    ...
    publication_doi: Series[str] = pa.Field(nullable=True, required=False)
    publication_pmid: Series[str] = pa.Field(nullable=True, required=False)
    publication_pmc_id: Series[str] = pa.Field(nullable=True, required=False)
