...
class ChEMBLActivityGoldSchema(pa.DataFrameModel):
    ...
    publication_doi: Series[str] | None = pa.Field(nullable=True)
    publication_pmid: Series[str] | None = pa.Field(nullable=True)
    publication_pmc_id: Series[str] | None = pa.Field(nullable=True)
...
class ChEMBLDocumentGoldSchema(pa.DataFrameModel):
    ...
    publication_doi: Series[str] | None = pa.Field(nullable=True, required=False)
    publication_pmid: Series[str] | None = pa.Field(nullable=True, required=False)
    publication_pmc_id: Series[str] | None = pa.Field(nullable=True, required=False)
