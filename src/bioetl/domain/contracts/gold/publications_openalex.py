...
class OpenAlexPublicationGoldSchema(PublicationGoldCommonSchema):
    ...
    primary_topic_raw_json: Series[str] = pa.Field(nullable=True)
    primary_topic_canonical_json: Series[str] = pa.Field(nullable=True)
    grants: Series[str] = pa.Field(nullable=True)
    grants_raw_json: Series[str] = pa.Field(nullable=True)
    grants_canonical_json: Series[str] = pa.Field(nullable=True)
