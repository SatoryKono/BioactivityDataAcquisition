...
class ChEMBLAssayGoldSchema(StrictGoldContractSchema):
    ...
    src_id: Series[float] = pa.Field(nullable=True, ge=0, coerce=True)
    ...
    assay_taxonomy_id: Series[float] = pa.Field(nullable=True, ge=0, coerce=True)
    ...
    confidence_score: Series[float] = pa.Field(nullable=True, ge=0, le=9, coerce=True)
    ...
    score: Series[float] = pa.Field(nullable=True, ge=0, coerce=True)
    ...
    variant_taxonomy_id: Series[float] = pa.Field(nullable=True, ge=0, coerce=True)
