...
class SemanticScholarPublicationGoldSchema(PublicationGoldCommonSchema):
    ...
    subject_fields_raw_json: Series[str] = pa.Field(nullable=True)
    subject_fields_canonical_json: Series[str] = pa.Field(nullable=True)
    publication_types: Series[str] = pa.Field(nullable=True)
    publication_types_raw_json: Series[str] = pa.Field(nullable=True)
    publication_types_canonical_json: Series[str] = pa.Field(nullable=True)
    citation_contexts: Series[str] = pa.Field(nullable=True)
    citation_contexts_raw_json: Series[str] = pa.Field(nullable=True)
    citation_contexts_canonical_json: Series[str] = pa.Field(nullable=True)
    ...
    author_h_indices_raw_json: Series[str] = pa.Field(nullable=True)
    author_h_indices_canonical_json: Series[str] = pa.Field(nullable=True)
