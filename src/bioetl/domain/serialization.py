...
def flatten_arrow_table_for_export(table: pa.Table) -> pa.Table:
    ...
    def serialize_column_to_json(col: pa.ChunkedArray) -> pa.Array:
        ...
        # Performance optimization: Use walrus operator to evaluate v.as_py() once
        # instead of multiple times per element to avoid expensive pyarrow scalar conversions
        vals = [
