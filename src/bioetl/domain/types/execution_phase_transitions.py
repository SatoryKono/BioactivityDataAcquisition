...
def _build_not_started_transitions(
    ...
    """Build transitions from NOT_STARTED phase."""
    return [
...
def _build_preflight_transitions(
    ...
    """Build transitions from PREFLIGHT phase."""
    return [
        phase_transition_rule(
...
def _build_dependency_execution_transitions(
    ...
    """Build transitions from DEPENDENCY_EXECUTION phase."""
    return [
        phase_transition_rule(
...
def _build_enrichment_transitions(
    ...
    """Build transitions from ENRICHMENT phase."""
    return [
        phase_transition_rule(
...
def _build_merge_transitions(
    ...
    """Build transitions from MERGE phase."""
    return [
        phase_transition_rule(
...
def _build_cross_validation_transitions(
    ...
    """Build transitions from CROSS_VALIDATION phase."""
    return [
        phase_transition_rule(
...
def _build_write_finalize_transitions(
    ...
    """Build transitions from WRITE_FINALIZE phase."""
    return [
        phase_transition_rule(
...
def _get_terminal_phases(
    ...
    """Get list of terminal phases with no outgoing transitions."""
    return [
