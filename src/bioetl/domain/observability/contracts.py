"""Domain-level observability ports.

Defines ABCs for structured logging, tracing, and pipeline metrics.
These ports are consumed by the domain and application layers, while
infrastructure and interface layers provide concrete implementations.
"""
