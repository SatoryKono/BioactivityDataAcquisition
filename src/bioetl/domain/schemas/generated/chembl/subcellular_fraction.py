...
class ChemblSubcellularFractionSilverSchema(pa.DataFrameModel):
    ...
    assay_count: Series[int] | None = pa.Field(nullable=True)
    example_assay_id: Series[str] | None = pa.Field(nullable=True)
    subcellular_fraction: Series[str] | None = pa.Field(nullable=True)
