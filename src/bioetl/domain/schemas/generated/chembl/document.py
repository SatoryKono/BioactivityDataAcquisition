...
class ChemblDocumentSilverSchema(pa.DataFrameModel):
    ...
    chembl_release: Series[str] | None = pa.Field(nullable=True)
    creation_date: Series[str] | None = pa.Field(nullable=True)
