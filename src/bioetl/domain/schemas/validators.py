...
def _typed_register_check_method(*args: Any, **kwargs: Any) -> Callable[[F], F]:
    """Type-safe wrapper around pandera register_check_method decorator."""
    return cast(Callable[[F], F], register_check_method(*args, **kwargs))
