...
_REFERENCE_IDENTIFIER_FAMILY_SPECS: tuple[tuple[str, str, str, str, str], ...] = (
    ...
    ("ror", "string", "set_like", "ror", "ROR institution identifiers stored as canonical ROR URLs."),
    (
        "openalex_author",
        "string",
        "set_like",
    ...
    ("openalex_work", "string", "scalar", "openalex_work", "OpenAlex work IDs with W-prefix canonical form."),
    (
    ...
    ("uniprot_accession", "string", "scalar_or_set_like", "uniprot_accession", "UniProt accession identifiers."),
    ("go", "json_array", "set_like", "go", "Gene Ontology cross-reference identifiers."),
    ("interpro", "json_array", "set_like", "interpro", "InterPro cross-reference identifiers."),
    ("pfam", "json_array", "set_like", "pfam", "Pfam cross-reference identifiers."),
    ("reactome", "json_array", "set_like", "reactome", "Reactome pathway cross-reference identifiers."),
    ("pdb", "json_array", "set_like", "pdb", "PDB structure cross-reference identifiers."),
    ("chembl", "string", "scalar_or_set_like", "chembl", "ChEMBL identifiers used by non-ChEMBL provider references."),
    ("drugbank", "string", "set_like", "drugbank", "DrugBank identifiers used by UniProt cross-references."),
)
