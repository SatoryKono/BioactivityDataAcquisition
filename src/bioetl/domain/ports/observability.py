...
class LoggerPort(Protocol):
    ...
    def info(self, _event: str | None = None, *args: Any, **kwargs: Any) -> Any:
        """Log an informational message."""
        ...

    def warning(self, _event: str | None = None, *args: Any, **kwargs: Any) -> Any:
        """Log a warning message."""
        ...

    def error(self, _event: str | None = None, *args: Any, **kwargs: Any) -> Any:
        """Log an error message."""
        ...

    def debug(self, _event: str | None = None, *args: Any, **kwargs: Any) -> Any:
        """Log a debug message."""
        ...

    def exception(self, _event: str | None = None, *args: Any, **kwargs: Any) -> Any:
