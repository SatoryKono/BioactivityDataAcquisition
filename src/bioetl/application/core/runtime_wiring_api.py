...
This module intentionally re-exports the batch-runtime classes that
composition factories need to assemble pipeline execution collaborators.
Composition should prefer this seam over importing many individual
``application.core`` implementation modules directly.
"""
