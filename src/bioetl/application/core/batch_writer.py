...
class BatchWriter:
    ...
    def __init__(
        ...
        # Pre-calculate schema columns for efficient filtering in hot path (write_gold)
    ...
    async def write_gold(self, records: list[dict[str, Any]]) -> None:
        ...
        try:
            ...
            # OPTIMIZATION: Use pre-calculated columns to avoid schema conversion overhead
