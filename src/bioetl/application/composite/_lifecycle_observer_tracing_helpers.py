"""Internal tracing helper mixins for composite lifecycle publication."""
...
from bioetl.application.composite.port_types import LoggerPort, MetricsPort, TracingPort
...
class CompositeLifecycleSpanManagementMixin:
    """Span lifecycle helpers for composite lifecycle flows."""
