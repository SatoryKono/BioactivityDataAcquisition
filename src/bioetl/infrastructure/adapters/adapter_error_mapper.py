"""Unified adapter error -> domain error mapping."""
...
class DomainErrorMappingInput:
    """Normalized data needed to map adapter failures into domain exceptions."""
...
class AdapterErrorMapper:
    """Map adapter errors to stable domain exception taxonomy."""
    ...
    def _map_with_status_code(
        ...
        if status_code == _RATE_LIMIT_STATUS_CODE:
            effective_retry_after = payload.retry_after or _DEFAULT_RETRY_AFTER_SECONDS
            self._logger.info(
