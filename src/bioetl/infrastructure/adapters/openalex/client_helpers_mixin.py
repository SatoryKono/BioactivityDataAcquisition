"""Helper mixin for OpenAlex adapter utility and metadata methods."""
...
class _OpenAlexAdapterHelpersMixin:
    """Small utility helpers extracted from the main OpenAlex adapter."""
