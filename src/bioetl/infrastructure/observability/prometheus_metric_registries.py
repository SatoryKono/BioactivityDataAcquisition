...
PIPELINE_RUNTIME_REGISTRY = MetricRegistryFamily(
    ...
    counters={
        ...
        "structural_policy_events_total": STRUCTURAL_POLICY_EVENTS_TOTAL,
        "structural_policy_shadow_comparisons_total": (
            STRUCTURAL_POLICY_SHADOW_COMPARISONS_TOTAL
        ),
        ...
        "checkpoint_load_events_total": CHECKPOINT_LOAD_EVENTS_TOTAL,
...
STORAGE_MEDALLION_REGISTRY = MetricRegistryFamily(
    ...
    counters={
        ...
        "bronze_write_attempts_total": BRONZE_WRITE_ATTEMPTS_TOTAL,
        ...
        "silver_filter_rejections_total": SILVER_FILTER_REJECTIONS_TOTAL,
    ...
    histograms={
        ...
        "bronze_write_total_duration_seconds": BRONZE_WRITE_TOTAL_DURATION_SECONDS,
