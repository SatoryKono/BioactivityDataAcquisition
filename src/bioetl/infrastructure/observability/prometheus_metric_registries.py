...
PIPELINE_RUNTIME_REGISTRY = MetricRegistryFamily(
    ...
    counters={
        ...
        "bioetl_shutdown_initiated_total": _metrics.SHUTDOWN_INITIATED,
        "bioetl_shutdown_completed_total": _metrics.SHUTDOWN_COMPLETED,
...
DQ_VALIDATION_REGISTRY = MetricRegistryFamily(
    ...
    counters={
        ...
        "bioetl_dq_anomaly_detected_total": _metrics.DQ_ANOMALY_DETECTED,
        "bioetl_dq_baseline_updated_total": _metrics.DQ_BASELINE_UPDATED,
        ...
        "bioetl_dq_soft_threshold_exceeded_total": _metrics.DQ_SOFT_THRESHOLD_EXCEEDED,
