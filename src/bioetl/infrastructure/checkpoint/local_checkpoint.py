...
class LocalCheckpointAdapter(LocalCheckpointSyncMixin):
    ...
    async def exists(self, pipeline: str) -> bool:
        ...
        return await asyncio.to_thread(self._exists_sync, pipeline)
    ...
    async def load_for_run(
        ...
        return await asyncio.to_thread(self._load_for_run_sync, pipeline, run_id)
    ...
    async def load_for_manifest_id(
        ...
        return await asyncio.to_thread(self._load_for_manifest_id_sync, manifest_id)
    ...
    async def load_latest_for_pipeline(
        ...
        return await asyncio.to_thread(self._load_latest_for_pipeline_sync, pipeline)
