...
This schema validates the structure and content of tissue data
after normalization.
"""
...
class TissueTableSchema(BaseGeneratedColumnsSchema):
    ...
    Validates tissue sample definitions including:
    - ChEMBL identifier
    - Tissue metadata (name, type, organism)
    - Descriptions
    """
    ...
    tissue_description: Series[str] = pa.Field(
        nullable=True, description="Free text tissue description"
    )
