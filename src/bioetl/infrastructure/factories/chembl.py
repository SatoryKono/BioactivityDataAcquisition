"""Factories for ChEMBL components.

Handles the creation of ChEMBL-related adapters and pipelines,
wiring up necessary dependencies.
"""
...
class ChEMBLActivityPipelineFactory:
    ...
    async def create(
        ...
        # Data source (ChEMBL)
        chembl_config = settings.chembl
        bucket = TokenBucket(
            rate=chembl_config.rate_limit,
            capacity=chembl_config.burst_capacity,
        )
