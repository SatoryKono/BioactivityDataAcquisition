...
# Schema for GtoPdb Target
# See: https://www.guidetopharmacology.org/webServices.jsp
GTOPDB_TARGET_SCHEMA = pa.schema(
    [
        # System fields
        pa.field("entity_id", pa.string()),
        pa.field("content_hash", pa.string()),
        ...
        pa.field("systematic_name", pa.string()),
        pa.field("target_type", pa.string()),
        # Family hierarchy
        pa.field("family_id", pa.int64()),
        pa.field("family_name", pa.string()),
        pa.field("family_ids", pa.string()),  # JSON list
        # Species information
        pa.field("species", pa.string()),
        pa.field("species_id", pa.int64()),
        # Gene information
        pa.field("gene_symbol", pa.string()),
        pa.field("gene_id", pa.int64()),
        pa.field("ensembl_gene_id", pa.string()),
        # UniProt cross-references
        pa.field("uniprot_ids", pa.string()),  # JSON list
        # Additional identifiers
        pa.field("hgnc_id", pa.int64()),
        pa.field("hgnc_symbol", pa.string()),
        pa.field("hgnc_name", pa.string()),
        # Nomenclature
        pa.field("nomenclature_status", pa.string()),
        # Lineage metadata
        pa.field("_run_id", pa.string()),
        pa.field("_run_type", pa.string()),
        pa.field("_source_batch_id", pa.string()),
...
# Schema for GtoPdb Ligand
# See: https://www.guidetopharmacology.org/webServices.jsp
GTOPDB_LIGAND_SCHEMA = pa.schema(
    [
        # System fields
        pa.field("entity_id", pa.string()),
        pa.field("content_hash", pa.string()),
        # Primary identifier
        pa.field("ligand_id", pa.int64()),
        # Core metadata
        pa.field("name", pa.string()),
        pa.field("ligand_type", pa.string()),
        pa.field("approved", pa.bool_()),
        pa.field("withdrawn", pa.bool_()),
        pa.field("labelled", pa.bool_()),
        pa.field("radioactive", pa.bool_()),
        ...
        pa.field("iupac_name", pa.string()),
        # Drug status
        pa.field("inn", pa.string()),
        pa.field("approved_source", pa.string()),
        # Species
        pa.field("species", pa.string()),
        # Cross-references
        pa.field("pubchem_sid", pa.int64()),
        pa.field("pubchem_cid", pa.int64()),
        pa.field("chembl_id", pa.string()),
        pa.field("drugbank_id", pa.string()),
        pa.field("cas_number", pa.string()),
        # Comments
...
# Schema for GtoPdb Interaction
# See: https://www.guidetopharmacology.org/webServices.jsp
GTOPDB_INTERACTION_SCHEMA = pa.schema(
    [
        # System fields
        pa.field("entity_id", pa.string()),
        pa.field("content_hash", pa.string()),
        ...
        pa.field("action_comment", pa.string()),
        pa.field("selectivity", pa.string()),
        # Affinity data
        pa.field("affinity_type", pa.string()),
        pa.field("affinity_value", pa.float64()),
        pa.field("affinity_low", pa.float64()),
        pa.field("affinity_high", pa.float64()),
        pa.field("affinity_median", pa.float64()),
        pa.field("affinity_units", pa.string()),
        pa.field("affinity_qualifier", pa.string()),
        # Species context
        pa.field("species", pa.string()),
        pa.field("species_id", pa.int64()),
        # Flags
        pa.field("endogenous", pa.bool_()),
        pa.field("primary_target", pa.bool_()),
        # References
        pa.field("pubmed_ids", pa.string()),  # JSON list
        # Lineage metadata
        pa.field("_run_id", pa.string()),
        pa.field("_run_type", pa.string()),
        pa.field("_source_batch_id", pa.string()),
