...
CHEMBL_TARGET_SCHEMA = pa.schema(
    [
        ...
        *build_silver_system_prefix_fields(),
        ...
        pa.field("target_xref_hgnc_ids", pa.string()),
...
CHEMBL_TARGET_PROTEIN_CLASSIFICATION_SCHEMA = pa.schema(
    [
        ...
        *build_silver_system_prefix_fields(),
        ...
        pa.field("path_ids", pa.string()),
        pa.field("path_names", pa.string()),
        pa.field("path_labels", pa.string()),
        pa.field("depth", pa.int64()),
        pa.field("root_id", pa.string()),
        pa.field("is_leaf", pa.bool_()),
        pa.field("l1_id", pa.string()),
        pa.field("l1_name", pa.string()),
        pa.field("l1_desc", pa.string()),
        pa.field("l2_id", pa.string()),
        pa.field("l2_name", pa.string()),
        pa.field("l2_desc", pa.string()),
        pa.field("l3_id", pa.string()),
        pa.field("l3_name", pa.string()),
        pa.field("l3_desc", pa.string()),
        pa.field("l4_id", pa.string()),
        pa.field("l4_name", pa.string()),
        pa.field("l4_desc", pa.string()),
        pa.field("l5_id", pa.string()),
        pa.field("l5_name", pa.string()),
        pa.field("l5_desc", pa.string()),
        pa.field("canonical_l1", pa.string()),
        pa.field("l1_counts_for_target_type", pa.bool_()),
        pa.field("l1_mapping_version", pa.string()),
        pa.field("target_type_rule_version", pa.string()),
        pa.field("l1_normalization_status", pa.string()),
        pa.field("l1_normalization_notes", pa.string()),
        pa.field("dataset_version", pa.string()),
        pa.field("source_url", pa.string()),
        pa.field("chembl_release", pa.string()),
        pa.field("chembl_api_version", pa.string()),
        pa.field("source_manifest_status", pa.string()),
        pa.field("source_snapshot_fingerprint", pa.string()),
        pa.field("target_snapshot_row_count", pa.int64()),
        pa.field("target_component_snapshot_row_count", pa.int64()),
        pa.field("protein_class_snapshot_row_count", pa.int64()),
        # === DQ_FIELDS_SUFFIX ===
        *build_silver_dq_suffix_fields(),
    ]
)
