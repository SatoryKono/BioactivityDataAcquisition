...
CHEMBL_TARGET_SCHEMA = pa.schema(
    [
        ...
        *build_silver_system_prefix_fields(),
        ...
        pa.field("target_protein_class_id_L1", pa.string()),
        pa.field("target_protein_class_name_L1", pa.string()),
        pa.field("target_protein_class_desc_L1", pa.string()),
        pa.field("target_protein_class_id_L2", pa.string()),
        pa.field("target_protein_class_name_L2", pa.string()),
        pa.field("target_protein_class_desc_L2", pa.string()),
        pa.field("target_protein_class_id_L3", pa.string()),
        pa.field("target_protein_class_name_L3", pa.string()),
        pa.field("target_protein_class_desc_L3", pa.string()),
        pa.field("target_protein_class_id_L4", pa.string()),
        pa.field("target_protein_class_name_L4", pa.string()),
        pa.field("target_protein_class_desc_L4", pa.string()),
        pa.field("target_protein_class_id_L5", pa.string()),
        pa.field("target_protein_class_name_L5", pa.string()),
        pa.field("target_protein_class_desc_L5", pa.string()),
