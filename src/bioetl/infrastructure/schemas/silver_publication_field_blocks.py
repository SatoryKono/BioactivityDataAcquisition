...
def build_pubmed_publication_fields() -> list[pa.Field]:
    ...
    return [
        ...
        pa.field("affiliation_structured_canonical_json", pa.string()),
        pa.field("affiliation_structured_raw_json", pa.string()),
        pa.field("author_count", pa.int64()),
        pa.field("author_keys", pa.string()),
        pa.field("authors", pa.string()),
        pa.field("authors_with_affiliations", pa.string()),
        pa.field("authors_with_affiliations_canonical_json", pa.string()),
        pa.field("authors_with_affiliations_raw_json", pa.string()),
...
def build_semanticscholar_publication_fields() -> list[pa.Field]:
    ...
    return [
        ...
        pa.field("author_h_indices_canonical_json", pa.string()),
        pa.field("author_h_indices_raw_json", pa.string()),
        pa.field("author_keys", pa.string()),
        pa.field("author_orcids", pa.string()),
        pa.field("author_s2_ids", pa.string()),
        pa.field("authors", pa.string()),
        pa.field("citation_contexts", pa.string()),
        pa.field("citation_contexts_canonical_json", pa.string()),
        pa.field("citation_contexts_raw_json", pa.string()),
        pa.field("citations_made", pa.int64()),
        ...
        pa.field("publication_type_unified", pa.string()),
        pa.field("publication_types", pa.string()),
        pa.field("publication_types_canonical_json", pa.string()),
        pa.field("publication_types_raw_json", pa.string()),
        pa.field("publication_year", pa.int64()),
        pa.field("subject_fields", pa.string()),
        pa.field("subject_fields_canonical_json", pa.string()),
        pa.field("subject_fields_raw_json", pa.string()),
        pa.field("title", pa.string()),
...
def build_crossref_publication_fields() -> list[pa.Field]:
    ...
    return [
        ...
        pa.field("author_details_raw_json", pa.string()),
        pa.field("author_details_canonical_json", pa.string()),
        pa.field("author_keys", pa.string()),
        pa.field("author_orcids", pa.string()),
        pa.field("authors", pa.string()),
        pa.field("citations_made", pa.int64()),
        ...
        pa.field("references_raw_json", pa.string()),
        pa.field("references_canonical_json", pa.string()),
        pa.field("subject_keywords", pa.string()),
        pa.field("title", pa.string()),
        pa.field("volume", pa.string()),
    ]
...
def build_openalex_publication_fields() -> list[pa.Field]:
    ...
    return [
        ...
        pa.field("grants_canonical_json", pa.string()),
        pa.field("grants_raw_json", pa.string()),
        ...
        pa.field("primary_topic_canonical_json", pa.string()),
        pa.field("primary_topic_raw_json", pa.string()),
        pa.field("publication_class", pa.string()),
        pa.field("publication_date", pa.string()),
        pa.field("publication_subclass", pa.string()),
        pa.field("publication_type", pa.string()),
