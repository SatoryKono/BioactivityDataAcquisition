...
PUBCHEM_COMPOUND_SCHEMA = pa.schema(
    [
        ...
        *build_silver_system_prefix_fields(),
        ...
        pa.field("chemical_standardization_policy_version", pa.string()),
        pa.field("chemical_standardization_status", pa.string()),
        pa.field("chemical_standardization_warnings", pa.string()),
        ...
        pa.field("standardized_canonical_smiles", pa.string()),
        pa.field("standardized_inchi", pa.string()),
        pa.field("standardized_inchi_key", pa.string()),
        pa.field("standardized_isomeric_smiles", pa.string()),
        pa.field("structure_parent_key", pa.string()),
