...
def _extract_hotspot_fields(
    ...
    """Extract and strictly type-check hotspot budget fields."""
    ...
    if (
        ...
        return None
    return hotspot_name, path_prefixes, registry_budgets


def _parse_hotspot_entry(
    entry: object,
) -> tuple[str, tuple[str, ...], dict[str, int]] | None:
    """Parse and validate a single hotspot budget dictionary."""
    ...
    hotspot_name, path_prefixes, registry_budgets = fields
