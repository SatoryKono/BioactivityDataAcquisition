...
def _render_replay_view_lines(replay_view: dict[str, object]) -> list[str]:
    ...
    return [
        ...
        f"  exact_replay_eligible: {replay_view.get('exact_replay_eligible')}",
...
def _render_checkpoint_compatibility_lines(payload: dict[str, object]) -> list[str]:
    ...
    return [
        ...
        f"  compatibility_replay_mode: {compatibility.get('replay_mode')}",
        ...
        f"  compatibility_exact_replay_eligible: {compatibility.get('exact_replay_eligible')}",
