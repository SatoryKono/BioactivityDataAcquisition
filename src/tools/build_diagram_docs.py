...
MANIFEST: dict[str, dict] = {
    ...
    "domain": {
        ...
        "sections": [
            ("Port Contracts", [
                ("Domain Ports — all 29 Protocol interfaces",       C / "01-domain-ports.png"),
                ("Port → Protocol Contracts (architecture view)",   A / "13-port-protocol-contracts.png"),
                ("Port → Adapter mapping reference",                F / "30-port-adapter-mapping.png"),
                ("Hexagonal Ports & Adapters",                      F / "26-hexagonal-ports-adapters.png"),
            ]),
            ("Class Diagrams", [
            ...
            ("Structure & DDD", [
                ("Domain Layer — ports, entities, config",          F / "04-domain-layer-class-diagram.png"),
                ("Domain-Driven Design diagram",                    F / "08-domain-ddd.png"),
                ("Domain Model Relationships",                      F / "13-domain-models-relationship.png"),
            ]),
            ("Exceptions", [
                ("Exception Hierarchy (full tree)",                 F / "50-exception-hierarchy.png"),
                ("Error Classification Tree",                       F / "41-error-classification-tree.png"),
    ...
    "application": {
        ...
        "sections": [
            ("Core Classes", [
                ("Application Core Services (PipelineRunner, BatchExecutor, LockManager)", C / "07-application-core-services.png"),
                ("Application Services (DQ, Health, Export, Vacuum, Quarantine)",         C / "08-application-services.png"),
                ("PipelineRunner Class — all 14 DI dependencies",                         F / "42-pipeline-runner-class.png"),
                ("Application Core Collaboration",                                         F / "40-application-core-collaboration.png"),
            ]),
            ("Pipeline Lifecycle", [
                ("Pipeline Execution Flow (sequence)",              A / "04-pipeline-execution-flow.png"),
                ("Pipeline Execution — happy path",                 F / "03-pipeline-execution-happy-path.png"),
                ("Pipeline Sequence Diagram",                       F / "03-pipeline-sequence.png"),
                ("Pipeline Lifecycle States (FSM)",                 F / "05-pipeline-lifecycle-states.png"),
            ...
            ("Batch & Transform", [
                ...
                ("Template Method — BaseTransformer hierarchy",     F / "45-template-method-transformer.png"),
                ("Batch Processing Flow",                           F / "34-batch-processing-flow.png"),
                ("Fan-Out / Fan-In — asyncio.gather",               F / "43-fan-out-fan-in-pattern.png"),
            ]),
            ("Data Quality", [
            ...
            ("Data Journey", [
                ("Single Record Journey — API → Bronze → Silver → Gold", F / "32-single-record-journey.png"),
                ("Activity Entity Data Flow",                       F / "21-activity-entity-data-flow.png"),
    ...
    "infrastructure": {
        ...
        "sections": [
            ("Adapters", [
                ...
                ("Provider Adapter Hierarchy",                      A / "05-provider-adapter-hierarchy.png"),
                ("Infrastructure Layer Classes",                    F / "10-infrastructure-layer-class-diagram.png"),
                ("Cross-Provider Enrichment (5-provider flow)",     F / "44-cross-provider-enrichment.png"),
                ("Client API Request Sequence",                     F / "22-client-api-request-sequence.png"),
            ]),
            ("Storage", [
                ("Storage Layer (Bronze/Silver/Gold/Delta)",        A / "06-storage-layer.png"),
                ("Storage class diagram",                           C / "11-storage.png"),
                ("Bronze Write Sequence",                           F / "18-bronze-write-sequence.png"),
                ("Delta Lake Write Sequence",                       F / "19-delta-lake-write-sequence.png"),
                ("SilverWriter Class",                              F / "23-silver-writer-class.png"),
            ]),
            ("Resilience", [
                ("Resilience Patterns (circuit breaker, retry, rate limiter)", A / "10-resilience-patterns.png"),
                ("Circuit Breaker States",                          F / "07-circuit-breaker-states.png"),
                ("CircuitBreaker & Observer Class",                 F / "25-circuit-breaker-observer-class.png"),
            ...
            ("Security & Observability", [
                ...
                ("Observability Stack (logging, metrics, tracing)", A / "09-observability-stack.png"),
    ...
    "composition": {
        ...
        "sections": [
            ("Bootstrap & Dependency Injection", [
                ("Factories & Bootstrap class diagram",             C / "16-factories-bootstrap.png"),
                ("Bootstrap / DI Container",                        A / "12-bootstrap-di-container.png"),
                ("Composition Root DI Graph",                       F / "28-composition-root-di-graph.png"),
                ("Bootstrap 9-step Sequence",                       F / "35-bootstrap-sequence.png"),
                ("Runtime Assembly Sequence (phases 1–8)",          F / "38-runtime-assembly-sequence.png"),
            ]),
            ("Configuration", [
                ("Configuration System",                            A / "11-configuration-system.png"),
                ("YAML Config Resolution — hierarchical merge",     F / "46-yaml-config-resolution.png"),
            ]),
            ("Composite Pipeline", [
                ("Composite Pipeline class diagram",                C / "12-composite-pipeline.png"),
                ("Composite Pipeline (architecture)",               A / "08-composite-pipeline.png"),
                ("Composite Pipeline Workflow (Seed→Deps→FanOut→Merge→Gold)", F / "29-composite-pipeline-workflow.png"),
                ("Composite Pipeline FSM — 10-state lifecycle",     F / "48-composite-phase-lifecycle.png"),
                ("CompositePipelineRunner component diagram",        F / "49-composite-runner-class.png"),
                ("Publication Composite — multi-source merge",      F / "47-publication-merge-sources.png"),
            ]),
            ("Locking & Checkpoints", [
                ("Lock, Checkpoint & Shutdown",                     A / "18-lock-checkpoint-shutdown.png"),
                ("Locking Mechanism",                               F / "05-locking.png"),
                ("Lock Acquisition Sequence",                       F / "11-lock-acquisition-sequence.png"),
    ...
    "overview": {
        ...
        "sections": [
            ("System Overview", [
                ("High-Level Hexagonal Architecture",               A / "01-high-level-hexagonal.png"),
                ("Full System Component Diagram (C4-style)",        F / "01-full-system-component.png"),
                ("High-Level System Overview",                      F / "01-high-level.png"),
                ("Architecture Principles Mindmap",                 F / "36-architecture-principles-mindmap.png"),
            ]),
            ("Architecture Rules", [
                ("Layer Dependency Matrix (ARCH-001)",              A / "02-layer-dependency-matrix.png"),
                ("Import Matrix Enforcement",                       F / "27-import-matrix-enforcement.png"),
                ("Layers Interaction",                              F / "05-layers-interaction.png"),
            ]),
            ("Medallion Architecture", [
                ("Medallion Data Flow (Bronze→Silver→Gold)",        A / "03-medallion-data-flow.png"),
                ("Full Medallion Data Flow (detailed)",             F / "02-full-medallion-data-flow.png"),
                ("Medallion (simplified)",                          F / "02-medallion.png"),
                ("Medallion Invariants — ARCH-007 RunType policy",  F / "39-medallion-invariants.png"),
            ]),
            ("CLI / Interfaces", [
                ("CLI Interface Layer",                             A / "14-cli-interface-layer.png"),
                ("CLI → PipelineRunnerService interaction",         F / "33-cli-run-interaction.png"),
                ("CLI Entry → Exit Code full chain",                F / "37-cli-entry-full-chain.png"),
            ]),
            ("Data Model & Deployment", [
                ("Full Entity-Relationship Diagram",                F / "09-full-er-diagram.png"),
                ("Local Deployment Architecture (ADR-010)",         F / "12-local-deployment-architecture.png"),
            ]),
        ],
    },
}
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build architecture Word docs from PNG diagrams")
    parser.add_argument("--out", default="reports/diagrams", help="Output directory (default: reports/diagrams)")
    parser.add_argument("--only", nargs="+", choices=list(MANIFEST.keys()), help="Build only specified layers")
