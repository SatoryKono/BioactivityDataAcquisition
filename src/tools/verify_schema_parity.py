...
def check_parity(name, domain_cls, silver_schema, gold_model):
    ...
    system_fields = {
        ...
        "entity_id", "content_hash", "ingestion_ts", "run_id", "run_type", "source_batch_id"
    }

    missing_in_silver = {f for f in domain_fields if f not in silver_fields and f not in system_fields}
