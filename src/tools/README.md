...
**Canonical location:** `scripts/diagrams/fix/apply_elk_layout.py`
...
**Canonical location:** `scripts/diagrams/fix/differentiate_linkstyle.py`
...
**Canonical location:** `scripts/diagrams/fix/harmonize_link_styles.py`
