...
- **Рефакторинг модулей**:
  - Перед рефакторингом обязательна карта зависимостей (импорты, использования, тесты, re-exports).
  - Формат: список файлов-импортёров, список файлов-пользователей, список тестов, рекомендации по порядку миграции.
