...
class TestPmidBaseValidation:
    ...
    def test_pmid_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid pmid value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_pmid_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestDoiBaseValidation:
    ...
    def test_doi_null_fails(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestPmcIdBaseValidation:
    ...
    def test_pmc_id_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid pmc_id value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_pmc_id_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestTitleBaseValidation:
    ...
    def test_title_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid title value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_title_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestAbstractBaseValidation:
    ...
    def test_abstract_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid abstract value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_abstract_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestAuthorsBaseValidation:
    ...
    def test_authors_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid authors value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_authors_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestAffiliationListBaseValidation:
    ...
    def test_affiliation_list_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid affiliation_list value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_affiliation_list_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestJournalBaseValidation:
    ...
    def test_journal_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid journal value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_journal_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestPublicationYearBaseValidation:
    ...
    def test_publication_year_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid publication_year value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_publication_year_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestPublicationDateBaseValidation:
    ...
    def test_publication_date_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid publication_date value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_publication_date_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestPublicationTypeBaseValidation:
    ...
    def test_publication_type_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid publication_type value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_publication_type_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestLanguageBaseValidation:
    ...
    def test_language_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid language value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_language_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestPageFirstBaseValidation:
    ...
    def test_page_first_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid page_first value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_page_first_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestPageLastBaseValidation:
    ...
    def test_page_last_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid page_last value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_page_last_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestCitationsReceivedBaseValidation:
    ...
    def test_citations_received_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid citations_received value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_citations_received_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestCitationsMadeBaseValidation:
    ...
    def test_citations_made_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid citations_made value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_citations_made_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestIsOaBaseValidation:
    ...
    def test_is_oa_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid is_oa value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_is_oa_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestLookupMethodBaseValidation:
    ...
    def test_lookup_method_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid lookup_method value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_lookup_method_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestOriginalIdBaseValidation:
    ...
    def test_original_id_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid original_id value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_original_id_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestSourceBaseValidation:
    ...
    def test__source_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid _source value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test__source_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestIssnBaseValidation:
    ...
    def test_issn_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestIssnListBaseValidation:
    ...
    def test_issn_list_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid issn_list value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_issn_list_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestPublisherBaseValidation:
    ...
    def test_publisher_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid publisher value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_publisher_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestPublishedPrintBaseValidation:
    ...
    def test_published_print_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid published_print value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_published_print_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestPublishedOnlineBaseValidation:
    ...
    def test_published_online_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid published_online value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_published_online_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestLicenseUrlBaseValidation:
    ...
    def test_license_url_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid license_url value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_license_url_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestSubjectKeywordsBaseValidation:
    ...
    def test_subject_keywords_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid subject_keywords value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_subject_keywords_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestContentDomainDomainsBaseValidation:
    ...
    def test_content_domain_domains_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid content_domain_domains value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_content_domain_domains_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestContentDomainCrossmarkRestrictionBaseValidation:
    ...
    def test_content_domain_crossmark_restriction_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid content_domain_crossmark_restriction value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_content_domain_crossmark_restriction_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestAlternativeIdBaseValidation:
    ...
    def test_alternative_id_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid alternative_id value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_alternative_id_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestPublishedBaseValidation:
    ...
    def test_published_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid published value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_published_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestJournalNameShortBaseValidation:
    ...
    def test_journal_name_short_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid journal_name_short value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_journal_name_short_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestIssnPrintBaseValidation:
    ...
    def test_issn_print_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid issn_print value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_issn_print_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestIssnElectronicBaseValidation:
    ...
    def test_issn_electronic_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid issn_electronic value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_issn_electronic_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestAuthorOrcidListBaseValidation:
    ...
    def test_author_orcid_list_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid author_orcid_list value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_author_orcid_list_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestAuthorDetailsBaseValidation:
    ...
    def test_author_details_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid author_details value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_author_details_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
...
class TestReferencesBaseValidation:
    ...
    def test_references_valid(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
        """PASS: valid references value."""
        PublicationEnrichedSchema.validate(minimal_crossref_publication_df)

    def test_references_null_allowed(self, minimal_crossref_publication_df: pd.DataFrame) -> None:
