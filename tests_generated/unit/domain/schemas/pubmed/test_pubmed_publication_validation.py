...
class TestDoiBaseValidation:
    ...
    def test_doi_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestPmcIdBaseValidation:
    ...
    def test_pmc_id_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestTitleBaseValidation:
    ...
    def test_title_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestAbstractBaseValidation:
    ...
    def test_abstract_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestAuthorsBaseValidation:
    ...
    def test_authors_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestAffiliationListBaseValidation:
    ...
    def test_affiliation_list_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid affiliation_list value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_affiliation_list_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestJournalBaseValidation:
    ...
    def test_journal_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestPublicationYearBaseValidation:
    ...
    def test_publication_year_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid publication_year value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_publication_year_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestPublicationDateBaseValidation:
    ...
    def test_publication_date_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid publication_date value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_publication_date_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestPublicationTypeBaseValidation:
    ...
    def test_publication_type_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid publication_type value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_publication_type_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestLanguageBaseValidation:
    ...
    def test_language_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestPageFirstBaseValidation:
    ...
    def test_page_first_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid page_first value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_page_first_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestPageLastBaseValidation:
    ...
    def test_page_last_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestCitationsReceivedBaseValidation:
    ...
    def test_citations_received_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid citations_received value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_citations_received_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestCitationsMadeBaseValidation:
    ...
    def test_citations_made_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid citations_made value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_citations_made_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestIsOaBaseValidation:
    ...
    def test_is_oa_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestLookupMethodBaseValidation:
    ...
    def test_lookup_method_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid lookup_method value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_lookup_method_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestOriginalIdBaseValidation:
    ...
    def test_original_id_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid original_id value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_original_id_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestSourceBaseValidation:
    ...
    def test__source_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestPiiBaseValidation:
    ...
    def test_pii_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestMidBaseValidation:
    ...
    def test_mid_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestPublisherIdBaseValidation:
    ...
    def test_publisher_id_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid publisher_id value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_publisher_id_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestAbstractStructuredBaseValidation:
    ...
    def test_abstract_structured_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid abstract_structured value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_abstract_structured_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestJournalNameShortBaseValidation:
    ...
    def test_journal_name_short_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid journal_name_short value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_journal_name_short_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestJournalIsoAbbrevBaseValidation:
    ...
    def test_journal_iso_abbrev_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid journal_iso_abbrev value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_journal_iso_abbrev_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestIssnBaseValidation:
    ...
    def test_issn_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestJournalIssnTypeBaseValidation:
    ...
    def test_journal_issn_type_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid journal_issn_type value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_journal_issn_type_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestNlmUniqueIdBaseValidation:
    ...
    def test_nlm_unique_id_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid nlm_unique_id value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_nlm_unique_id_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestCountryBaseValidation:
    ...
    def test_country_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestMedlinePgnBaseValidation:
    ...
    def test_medline_pgn_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid medline_pgn value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_medline_pgn_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestPageRangeBaseValidation:
    ...
    def test_page_range_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid page_range value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_page_range_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestPubMonthBaseValidation:
    ...
    def test_pub_month_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestPubDayBaseValidation:
    ...
    def test_pub_day_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestPublicationStatusBaseValidation:
    ...
    def test_publication_status_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid publication_status value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_publication_status_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestPublicationTypeListBaseValidation:
    ...
    def test_publication_type_list_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid publication_type_list value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_publication_type_list_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestDateCompletedBaseValidation:
    ...
    def test_date_completed_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid date_completed value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_date_completed_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestDateRevisedBaseValidation:
    ...
    def test_date_revised_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid date_revised value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_date_revised_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestCitationSubsetBaseValidation:
    ...
    def test_citation_subset_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid citation_subset value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_citation_subset_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestAffiliationStructuredBaseValidation:
    ...
    def test_affiliation_structured_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid affiliation_structured value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_affiliation_structured_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestAuthorCountBaseValidation:
    ...
    def test_author_count_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid author_count value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_author_count_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestMeshHeadingCountBaseValidation:
    ...
    def test_mesh_heading_count_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid mesh_heading_count value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_mesh_heading_count_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestKeywordCountBaseValidation:
    ...
    def test_keyword_count_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid keyword_count value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_keyword_count_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestGrantCountBaseValidation:
    ...
    def test_grant_count_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid grant_count value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_grant_count_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestChemicalCountBaseValidation:
    ...
    def test_chemical_count_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid chemical_count value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_chemical_count_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestSubjectMeshBaseValidation:
    ...
    def test_subject_mesh_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid subject_mesh value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_subject_mesh_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestChemicalsBaseValidation:
    ...
    def test_chemicals_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestSubjectKeywordsBaseValidation:
    ...
    def test_subject_keywords_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid subject_keywords value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_subject_keywords_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestDatabanksBaseValidation:
    ...
    def test_databanks_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestGeneSymbolsBaseValidation:
    ...
    def test_gene_symbols_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid gene_symbols value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_gene_symbols_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestPublicationTypesBaseValidation:
    ...
    def test_publication_types_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid publication_types value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_publication_types_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
...
class TestAuthorsWithAffiliationsBaseValidation:
    ...
    def test_authors_with_affiliations_valid(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
        """PASS: valid authors_with_affiliations value."""
        PubMedPublicationSchema.validate(minimal_pubmed_publication_df)

    def test_authors_with_affiliations_null_allowed(self, minimal_pubmed_publication_df: pd.DataFrame) -> None:
