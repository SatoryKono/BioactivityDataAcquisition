...
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ------------------------------------- |
| **ChEMBL**             | Activity, Assay, Assay Parameters, Molecule, Target, Target Component, Target Protein Classification, Protein Class, Cell Line, Compound Record, Publication, Publication Term, Publication Similarity, Subcellular Fraction, Tissue | Production | 0.1 req/sec (`chembl.yaml`, burst 1; upstream courtesy is 3 req/sec)  |
...
1. **Configure Environment** *(optional)*:
   ...
   **Environment Variables:**
   ...
   > **Note:** This table shows commonly used environment variables. Additional
   > provider/runtime keys are listed in
   > [Environment Variables Reference](docs/04-reference/environment-variables.md)
   > (partial published list) and `.env.example`.
