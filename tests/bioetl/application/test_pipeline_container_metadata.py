...
# WriterABC and MetadataWriterABC were removed from contracts

# Legacy classes commented out - not used in active tests
...
# Legacy helper - not used in active tests
