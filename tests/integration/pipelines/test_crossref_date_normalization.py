...
class TestCrossRefDateEdgeCases:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # Note: _compute_publication_date receives already-normalized dates
            # so it just passes them through
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # Normalization happens in format_date_parts() before this method
