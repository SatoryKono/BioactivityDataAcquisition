...
class TestHelperFunctions:
    ...
    def test_dict_or_empty_with_dict(self):
        """Test dict_or_empty with dict input."""
        result = dict_or_empty({"key": "value"})
        assert result == {"key": "value"}

    def test_dict_or_empty_with_non_dict(self):
        """Test dict_or_empty with non-dict input."""
        result = dict_or_empty("not_a_dict")
        assert result == {}

    def test_dict_or_empty_with_none(self):
        """Test dict_or_empty with None."""
        result = dict_or_empty(None)
        assert result == {}

    def test_dict_or_empty_with_list(self):
        """Test dict_or_empty with list."""
        result = dict_or_empty(["item1", "item2"])
        assert result == {}

    def test_artifact_refs_with_valid_list(self):
        """Test artifact_refs with valid artifact refs."""
        diagnostics = {
            "artifact_refs": [
    ...
    def test_metadata_sidecar_missing_count(self):
        """Test metadata_sidecar_missing_count."""
        diagnostics = {
            "artifact_refs": [
                {"artifact_path": "/path1", "metadata_path": "/meta1"},
    ...
    def test_lineage_closure_payload_missing(self):
        """Test lineage_closure_payload with missing boundary."""
        mock_result = MagicMock()
        mock_result.manifest.manifest_id = "test-manifest"
    ...
    def test_lineage_closure_payload_missing_boundary_key(self):
        """Test lineage_closure_payload when boundary key is missing."""
        mock_result = MagicMock()
        mock_result.manifest.manifest_id = "test-manifest"
    ...
    def test_inspection_service_factory_with_provided_factory(self):
        """Test inspection_service_factory_from_ports with provided factory."""
        mock_factory = MagicMock()
        mock_port = MagicMock()

        result = inspection_service_factory_from_ports(
    ...
    def test_inspection_service_factory_without_provided_factory(self):
        """Test inspection_service_factory_from_ports without provided factory."""
        mock_port = MagicMock()
    ...
    def test_missing_evidence_with_all_missing(self):
        """Test missing_evidence when all evidence is missing."""
        mock_result = MagicMock()
        ...
        result = missing_evidence(mock_result)
    ...
    def test_missing_evidence_with_complete_evidence(self):
        """Test missing_evidence when evidence is complete."""
        mock_result = MagicMock()
    ...
    def test_missing_evidence_with_partial_evidence(self):
        """Test missing_evidence with partial evidence."""
        mock_result = MagicMock()
        mock_result.ledger_entries = [MagicMock()]
        mock_result.diagnostics = {
            "published_artifact_count": 5,
    ...
    def test_forensic_diff_payload_backfills_missing_verdict(self):
        ...
        payload = forensic_diff_payload(manifest_diff)
