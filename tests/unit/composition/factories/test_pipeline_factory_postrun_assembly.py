...
class TestBuildPostrunService:
    ...
    def test_build_postrun_service_constructs_data_quality_service(self) -> None:
        ...
        with (
            patch(
                "bioetl.composition.factories.pipeline_factory_postrun_assembly.DataQualityService",
                return_value=dq_service,
            ) as mock_dq_service_cls,
            patch(
                "bioetl.composition.factories.pipeline_factory_postrun_assembly.build_postrun_dependency_context",
                return_value=dependencies,
            ) as mock_build_dependencies,
            patch(
                "bioetl.composition.factories.pipeline_factory_postrun_assembly.PostrunService",
...
class TestBuildPostrunDependencyContext:
    ...
    def test_build_postrun_dependency_context_returns_expected_collaborators(
        ...
        with (
            patch(
                "bioetl.composition.factories.pipeline_factory_postrun_assembly.PostrunCleanupService",
                return_value=cleanup,
            ),
            patch(
                "bioetl.composition.factories.pipeline_factory_postrun_assembly.PostrunDQReportService",
                return_value=dq_report,
            ),
            patch(
                "bioetl.composition.factories.pipeline_factory_postrun_assembly.PostrunMetadataVersionResolver",
                return_value=metadata_version,
            ),
            patch(
                "bioetl.composition.factories.pipeline_factory_postrun_assembly.PostrunCompactService",
