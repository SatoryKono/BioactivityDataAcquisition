...
def test_iter_family_python_files_falls_back_when_git_reports_no_files(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    """Do not convert an existing family prefix into a zero-metric baseline."""
    source_file = tmp_path / "src/bioetl/application/core/runtime_module.py"
