"""Boundary tests for run-composite helper/support compatibility seams."""
...
@pytest.mark.unit
@pytest.mark.parametrize(("path_text", "target_module"), RUN_COMPOSITE_SUPPORT_SEAMS)
def test_run_composite_support_seam_aliases_expected_canonical_module(
    path_text: str,
    target_module: str,
) -> None:
    """Each run-composite support seam should alias exactly one canonical module."""
