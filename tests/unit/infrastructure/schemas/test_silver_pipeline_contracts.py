...
PIPELINE_SCHEMA_EXPECTATIONS: dict[str, list[tuple[str, pa.DataType]]] = {
    "chembl_activity": [
        ...
        ("_index", pa.int64()),
        ("action_type_action_type", pa.string()),
        ...
        ("manual_curation_flag", pa.float64()),  # nullable int → double (EXC-007)
        ("molecule_chembl_id", pa.string()),
        ("molecule_pref_name", pa.string()),
        ("original_activity_id", pa.float64()),  # nullable int → double (EXC-007)
        ...
        ("toid", pa.float64()),  # nullable int → double (EXC-007)
        ("type", pa.string()),
        ("units", pa.string()),
        ("uo_units", pa.string()),
    ...
    "chembl_assay": [
        ...
        ("assay_taxonomy_id", pa.float64()),  # nullable int → double (EXC-007)
        ...
        ("variant_taxonomy_id", pa.float64()),  # nullable int → double (EXC-007)
        ("_dq_error", pa.bool_()),
        ("_dq_warn", pa.bool_()),
    ],
    ...
    "chembl_molecule": [
        ...
        ("first_approval", pa.float64()),  # nullable int → double (EXC-007)
        ...
        ("pref_name", pa.string()),
        ("prodrug", pa.int64()),
        ("property_alogp", pa.float64()),
        ("property_aromatic_rings", pa.int64()),
        ("property_full_molformula", pa.string()),
        ("property_full_mwt", pa.float64()),
        ("property_hba", pa.int64()),
        ("property_hbd", pa.int64()),
        ("property_heavy_atoms", pa.int64()),
        ("property_mw_freebase", pa.float64()),
        ("property_psa", pa.float64()),
        ("property_qed_weighted", pa.float64()),
        ("property_ro3_pass", pa.string()),
        ("property_ro5_violations", pa.int64()),
        ("property_rtb", pa.int64()),
        ...
        ("usan_year", pa.float64()),  # nullable int → double (EXC-007)
    ...
    "chembl_target": [
        ...
        ("taxonomy_id", pa.float64()),  # nullable int → double (EXC-007)
        ("_dq_error", pa.bool_()),
        ("_dq_warn", pa.bool_()),
    ],
    "chembl_target_component": [
        ...
        ("protein_classification_ids", pa.list_(pa.int64())),
    ...
    "chembl_subcellular_fraction": [
        ...
        ("example_assay_chembl_id", pa.string()),
    ...
    "crossref_publication": [
        ...
        ("content_domain_domains", pa.list_(pa.string())),
        ("doi", pa.string()),
        ("issn", pa.string()),
...
PIPELINE_PRIMARY_KEYS: dict[str, str] = {
    ...
    "chembl_assay": "assay_chembl_id",
    "chembl_assay_parameters": "assay_param_id",
    "chembl_cell_line": "cell_chembl_id",
    "chembl_compound_record": "record_id",
    "chembl_publication": "document_chembl_id",
    "chembl_publication_similarity": "sim_id",
    "chembl_publication_term": "document_chembl_id",
