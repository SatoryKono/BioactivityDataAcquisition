...
def test_scoring_helper_edges_fail_closed_and_sort_evidence() -> None:
    ...
    saturated = scoring_module._count_hotspot_families_at_budget(
        {
            "families": [
                None,
                {"name": "zeta", "budget_review_notes": ["at_budget:cc"]},
                {"name": "alpha", "budget_review_notes": ["at_budget:size"]},
                {"name": 1, "budget_review_notes": ["at_budget:ignored"]},
            ]
        }
    )
