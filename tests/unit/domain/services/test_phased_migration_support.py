...
class TestPhasedMigrationSupportService:
    ...
    def test_get_current_migration_status(self, service: PhasedMigrationSupportService) -> None:
    ...
    def test_get_current_migration_status_specific_version(self) -> None:
        ...
        with patch('bioetl.domain.services.phased_migration_support.get_version', return_value='1.1.5'):
    ...
    def test_get_current_migration_status_unknown_version(self) -> None:
        ...
        with patch('bioetl.domain.services.phased_migration_support.get_version', return_value='unknown'):
            service = PhasedMigrationSupportService()
            status = service.get_current_migration_status()
    ...
    def test_get_migration_guide_same_phase(self, service: PhasedMigrationSupportService) -> None:
    ...
    def test_get_migration_guide_v1_0_to_v1_1(self, service: PhasedMigrationSupportService) -> None:
    ...
    def test_get_migration_guide_v1_1_to_v1_2(self, service: PhasedMigrationSupportService) -> None:
    ...
    def test_get_migration_guide_invalid_phases(self, service: PhasedMigrationSupportService) -> None:
    ...
    def test_apply_migration_fallback_v1_0(self, service: PhasedMigrationSupportService) -> None:
    ...
    def test_apply_migration_fallback_v1_1(self, service: PhasedMigrationSupportService) -> None:
    ...
    def test_apply_migration_fallback_error_behavior(self, service: PhasedMigrationSupportService) -> None:
    ...
    def test_apply_migration_fallback_silent_behavior(self, service: PhasedMigrationSupportService) -> None:
        """Test migration fallback with silent behavior."""
        config = {"aggregation": {}}
        modified_config, warnings = service.apply_migration_fallback(config, "v1.0", fallback_behavior="silent")
        
        assert "provenance_tracking" in modified_config["aggregation"]
        assert len(warnings) == 1  # Still collects warnings, just doesn't raise error

    def test_apply_migration_fallback_invalid_phase(self, service: PhasedMigrationSupportService) -> None:
        """Test migration fallback with invalid phase."""
        config = {}
        modified_config, warnings = service.apply_migration_fallback(config, "invalid_phase")
    ...
    def test_version_comparison_equal(self, service: PhasedMigrationSupportService) -> None:
        """Test version comparison for equal versions."""
        result = service._version_compare("1.2.3", "1.2.3")
        assert result == 0

    def test_version_comparison_greater(self, service: PhasedMigrationSupportService) -> None:
        """Test version comparison for greater version."""
        result = service._version_compare("1.2.4", "1.2.3")
        assert result == 1

    def test_version_comparison_less(self, service: PhasedMigrationSupportService) -> None:
        """Test version comparison for lesser version."""
        result = service._version_compare("1.2.2", "1.2.3")
        assert result == -1

    def test_version_comparison_major_difference(self, service: PhasedMigrationSupportService) -> None:
        """Test version comparison for major version difference."""
        result = service._version_compare("2.0.0", "1.2.3")
        assert result == 1

    def test_version_comparison_minor_difference(self, service: PhasedMigrationSupportService) -> None:
        """Test version comparison for minor version difference."""
        result = service._version_compare("1.3.0", "1.2.3")
        assert result == 1

    def test_version_comparison_patch_difference(self, service: PhasedMigrationSupportService) -> None:
        """Test version comparison for patch version difference."""
        result = service._version_compare("1.2.4", "1.2.3")
        assert result == 1

    def test_version_comparison_different_lengths(self, service: PhasedMigrationSupportService) -> None:
