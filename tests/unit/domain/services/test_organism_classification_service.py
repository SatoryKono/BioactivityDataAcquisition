...
class TestNormalizeName:
    ...
    def test_service_normalize_name__none_input__57cb8c05(
        self, service: OrganismClassifier
    ) -> None:
        assert service.normalize_name(None) is None

    def test_service_normalize_name__empty_input__146e4b0d(
        self, service: OrganismClassifier
    ) -> None:
...
class TestClassifyRecords:
    ...
    def test_classify_records__empty_input__f0035c74(
        self, service: OrganismClassifier
    ) -> None:
...
class TestEnrichRecords:
    ...
    def test_service_enrich_records__empty_input__e65fef77(
        self, service: OrganismClassifier
    ) -> None:
...
class TestFilterByCellularity:
    ...
    def test_filter_by_cellularity__empty_input__3697a12d(
        self, service: OrganismClassifier
    ) -> None:
