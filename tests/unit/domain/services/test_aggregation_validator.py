...
class TestAggregationValidator:
    ...
    def test_validate_valid_config(self, validator: AggregationValidator, valid_config: AggregationConfig, source_schema: dict) -> None:
    ...
    def test_validate_missing_group_by(self, validator: AggregationValidator, source_schema: dict) -> None:
    ...
    def test_validate_group_by_field_not_in_schema(self, validator: AggregationValidator, source_schema: dict) -> None:
    ...
    def test_validate_missing_aggregations(self, validator: AggregationValidator, source_schema: dict) -> None:
    ...
    def test_validate_unsupported_aggregation_function(self, validator: AggregationValidator, source_schema: dict) -> None:
    ...
    def test_validate_source_field_not_in_schema(self, validator: AggregationValidator, source_schema: dict) -> None:
    ...
    def test_validate_field_shadowing(self, validator: AggregationValidator, source_schema: dict) -> None:
    ...
    def test_validate_multiple_issues(self, validator: AggregationValidator, source_schema: dict) -> None:
    ...
    def test_validate_post_aggregation_uniqueness_valid(self, validator: AggregationValidator) -> None:
    ...
    def test_validate_post_aggregation_uniqueness_duplicates(self, validator: AggregationValidator) -> None:
        """Test post-aggregation uniqueness validation with duplicate groups."""
        aggregation_results = [
            {"molecule_id": "mol1", "assay_type": "IC50", "activity_count": 5},
            {"molecule_id": "mol1", "assay_type": "IC50", "activity_count": 8},  # Duplicate
            {"molecule_id": "mol2", "assay_type": "EC50", "activity_count": 3},
        ]
    ...
    def test_validate_post_aggregation_uniqueness_missing_fields(self, validator: AggregationValidator) -> None:
    ...
    def test_generate_aggregation_provenance(self, validator: AggregationValidator, valid_config: AggregationConfig) -> None:
        ...
        provenance = validator.generate_aggregation_provenance(valid_config, source_records)
    ...
    def test_generate_aggregation_provenance_missing_fields(self, validator: AggregationValidator) -> None:
    ...
    def test_generate_aggregation_provenance_no_source_field(self, validator: AggregationValidator) -> None:
    ...
    def test_validate_with_alternative_schema_format(self, validator: AggregationValidator) -> None:
        ...
        schema = {
            "fields": ["molecule_id", "activity_value", "unit"]
        }
    ...
    def test_supported_aggregation_functions(self, validator: AggregationValidator, source_schema: dict) -> None:
        """Test all supported aggregation functions."""
        supported_functions = ["sum", "avg", "min", "max", "count", "first", "last", "concat", "list"]
