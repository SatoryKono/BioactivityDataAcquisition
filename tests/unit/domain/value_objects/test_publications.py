...
class TestORCID:
    ...
    def test_compact_without_x__test_o_r_c_i_d_domain_value_objects_test_publications_436(self) -> None:
    ...
    def test_compact_property_with_x__test_o_r_c_i_d_domain_value_objects_test_publications_476(self) -> None:
        """Test compact property with X check digit."""
        orcid = ORCID("0000-0001-5109-370X")
