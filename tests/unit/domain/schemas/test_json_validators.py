...
class TestIsValidJson:
    """Tests for is_valid_json validator."""
...
class TestIsValidJsonArray:
    """Tests for is_valid_json_array validator."""
...
class TestIsValidJsonObject:
    """Tests for is_valid_json_object validator."""
