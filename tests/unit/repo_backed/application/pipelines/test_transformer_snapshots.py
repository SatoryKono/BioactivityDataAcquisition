...
Run with: pytest tests/unit/repo_backed/application/pipelines/test_transformer_snapshots.py -v
Update snapshots: pytest tests/unit/repo_backed/application/pipelines/test_transformer_snapshots.py --snapshot-update
