...
def test_build_diagnostics_summary_merges_ledger_derived_input_snapshots() -> None:
    ...
    assert summary["post_capture_replayable_parent_supported"] is True
    assert summary["post_capture_replayable_parent_boundary"] == (
...
def test_build_diagnostics_summary_exposes_bounded_historical_upgrade_policy() -> None:
    ...
    assert summary["historical_live_run_upgrade_reason"] == (
...
def test_build_diagnostics_summary_projects_composite_dossier_correlation() -> None:
    ...
    manifest = replace(
        ...
        code_provenance=replace(
            ...
            dq_policy_ref="composite_activity.gold",
        ),
        launch_context={
            **base_manifest.launch_context,
            "execution_context": "composite",
