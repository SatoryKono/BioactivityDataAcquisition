...
from bioetl.application.services.dq_report_service import DQReportService, DQReportContext
...
@pytest.fixture
def service(mock_logger, mock_bronze_analyzer, mock_silver_analyzer, mock_gold_analyzer, mock_writer):
...
@pytest.mark.asyncio
async def test_generate_bronze_report_writer_error(service, context, mock_bronze_analyzer, mock_writer):
