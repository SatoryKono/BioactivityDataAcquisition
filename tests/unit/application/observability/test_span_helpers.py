...
class TestTracedAsyncOperation:
    ...
    @pytest.mark.asyncio
    async def test_creates_span_with_name_and_attributes__test_traced_async_operation_application_observability_test_span_helpers_121(self, mock_tracer):
        """Test span is created with correct name and attributes."""
    ...
    @pytest.mark.asyncio
    async def test_can_set_attributes_inside_context__test_traced_async_operation_application_observability_test_span_helpers_169(self, mock_tracer):
    ...
    @pytest.mark.asyncio
    async def test_custom_tracer_name__test_traced_async_operation_application_observability_test_span_helpers_179(self, mock_tracer):
