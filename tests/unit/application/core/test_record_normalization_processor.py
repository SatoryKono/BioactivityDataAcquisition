...
@pytest.mark.unit
def test_crossref_publication_profile_stabilizes_identifier_date_and_json_like_text() -> None:
    processor = RecordNormalizationProcessor(
        provider="crossref",
    ...
    record_a = {
        ...
        "title": " Example <b>Title</b> ",
        "publication_date": "2024-02",
        "authors": ' [{"name":"B","orcid":"2"},{"orcid":"1","name":"A"}] ',
        "_run_id": "run-a",
    }
    record_b = {
        "entity_id": "crossref:2",
        "content_hash": "stale-b",
        "doi": "10.1000/abc",
        "title": "Example Title",
        "publication_date": "2024-02-29",
        "authors": '[{"orcid":"2","name":"B"},{"name":"A","orcid":"1"}]',
        "_run_id": "run-b",
    }
    ...
    assert normalized_a["authors"] == normalized_b["authors"]
    assert normalized_a["content_hash"] == normalized_b["content_hash"]
...
def test_pubmed_publication_profile_stabilizes_identifier_and_partial_dates() -> None:
    ...
    assert normalized_b["pmid"] == "12345"
    assert normalized_a["content_hash"] == normalized_b["content_hash"]
...
def test_pubchem_compound_profile_stabilizes_numeric_and_smiles_equivalence() -> None:
    ...
    record_a = {
        ...
        "molecule_id": "CID123",
        "canonical_smiles": " C ",
        "molecular_weight": "12.3400000000",
        "iupac_name": " methane ",
    }
    record_b = {
        "entity_id": "pubchem:2",
