"""Ratchet coverage for AUD-002 composite_dependency_storage_ref extract (#10526)."""
...
from memory.graph.sync_pkg import composite_dependency_storage_ref as extracted
...
MOD = (
    ...
    / "graph"
    / "sync_pkg"
    / "composite_dependency_storage_ref.py"
)
_CORE_LOC_BEFORE = 10822
_NAME = "_composite_dependency_storage_ref"
_OWNED = re.compile(
...
def test_composite_dependency_storage_ref_owns_symbols_and_shrinks_core() -> None:
