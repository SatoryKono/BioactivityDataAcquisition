"""Ratchet coverage for AUD-002 sync_run_id extract (#10526)."""
...
from memory.graph.sync_pkg import sync_run_id as extracted

pytestmark = pytest.mark.unit

ROOT = Path(__file__).resolve().parents[3]
CORE = ROOT / "src" / "memory" / "graph" / "sync_pkg" / "_core.py"
MOD = ROOT / "src" / "memory" / "graph" / "sync_pkg" / "sync_run_id.py"
_CORE_LOC_BEFORE = 13315
_NAME = "_sync_run_id"
_OWNED = re.compile(
...
def test_sync_run_id_owns_symbols_and_shrinks_core() -> None:
