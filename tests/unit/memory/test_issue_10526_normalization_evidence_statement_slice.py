"""Ratchet coverage for AUD-002 normalization_evidence_statement extract (#10526)."""
...
from memory.graph.sync_pkg import normalization_evidence_statement as extracted
...
MOD = (
    ...
    / "graph"
    / "sync_pkg"
    / "normalization_evidence_statement.py"
)
_CORE_LOC_BEFORE = 8886
_NAME = "_NORMALIZATION_EVIDENCE_STATEMENT"
_OWNED = re.compile(
...
def test_normalization_evidence_statement_owns_symbols_and_shrinks_core() -> None:
