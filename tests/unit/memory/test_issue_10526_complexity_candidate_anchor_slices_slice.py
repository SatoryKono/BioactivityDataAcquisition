"""Ratchet coverage for AUD-002 complexity_candidate_anchor_slices extract (#10526)."""
...
from memory.graph.sync_pkg import complexity_candidate_anchor_slices as extracted
...
MOD = (
    ...
    / "graph"
    / "sync_pkg"
    / "complexity_candidate_anchor_slices.py"
)
_CORE_LOC_BEFORE = 4239
_NAME = "_complexity_candidate_anchor_slices"
_OWNED = re.compile(
...
def test_complexity_candidate_anchor_slices_owns_symbols_and_shrinks_core() -> None:
