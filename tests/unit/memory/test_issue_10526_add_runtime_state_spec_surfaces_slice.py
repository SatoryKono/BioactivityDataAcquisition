"""Ratchet coverage for AUD-002 add_runtime_state_spec_surfaces extract (#10526)."""
...
from memory.graph.sync_pkg import add_runtime_state_spec_surfaces as extracted
...
MOD = (
    ...
    / "graph"
    / "sync_pkg"
    / "add_runtime_state_spec_surfaces.py"
)
_CORE_LOC_BEFORE = 3586
_NAME = "_add_runtime_state_spec_surfaces"
_OWNED = re.compile(
...
def test_add_runtime_state_spec_surfaces_owns_symbols_and_shrinks_core() -> None:
