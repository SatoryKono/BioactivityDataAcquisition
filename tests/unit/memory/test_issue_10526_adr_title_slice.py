"""Ratchet coverage for AUD-002 adr_title extract (#10526)."""
...
from memory.graph.sync_pkg import adr_title as extracted

pytestmark = pytest.mark.unit

ROOT = Path(__file__).resolve().parents[3]
CORE = ROOT / "src" / "memory" / "graph" / "sync_pkg" / "_core.py"
MOD = ROOT / "src" / "memory" / "graph" / "sync_pkg" / "adr_title.py"
_CORE_LOC_BEFORE = 4975
_NAME = "_adr_title"
_OWNED = re.compile(
...
def test_adr_title_owns_symbols_and_shrinks_core() -> None:
