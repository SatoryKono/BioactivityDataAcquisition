"""Ratchet coverage for AUD-002 method_surface_promotion_target extract (#10526)."""
...
from memory.graph.sync_pkg import method_surface_promotion_target as extracted
...
MOD = (
    ...
    / "graph"
    / "sync_pkg"
    / "method_surface_promotion_target.py"
)
_CORE_LOC_BEFORE = 5252
_NAME = "_method_surface_promotion_target"
_OWNED = re.compile(
...
def test_method_surface_promotion_target_owns_symbols_and_shrinks_core() -> None:
