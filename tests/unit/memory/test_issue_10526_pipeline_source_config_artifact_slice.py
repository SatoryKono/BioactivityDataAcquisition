"""Ratchet coverage for AUD-002 pipeline_source_config_artifact extract (#10526)."""
...
from memory.graph.sync_pkg import pipeline_source_config_artifact as extracted
...
MOD = (
    ...
    / "graph"
    / "sync_pkg"
    / "pipeline_source_config_artifact.py"
)
_CORE_LOC_BEFORE = 8192
_NAME = "_pipeline_source_config_artifact"
_OWNED = re.compile(
...
def test_pipeline_source_config_artifact_owns_symbols_and_shrinks_core() -> None:
