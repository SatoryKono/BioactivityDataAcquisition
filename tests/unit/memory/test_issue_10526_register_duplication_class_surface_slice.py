"""Ratchet coverage for AUD-002 register_duplication_class_surface extract (#10526)."""
...
from memory.graph.sync_pkg import register_duplication_class_surface as extracted
...
MOD = (
    ...
    / "graph"
    / "sync_pkg"
    / "register_duplication_class_surface.py"
)
_CORE_LOC_BEFORE = 9155
_NAME = "_register_duplication_class_surface"
_OWNED = re.compile(
...
def test_register_duplication_class_surface_owns_symbols_and_shrinks_core() -> None:
