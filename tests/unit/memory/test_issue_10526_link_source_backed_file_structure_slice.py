"""Ratchet coverage for AUD-002 link_source_backed_file_structure extract (#10526)."""
...
from memory.graph.sync_pkg import link_source_backed_file_structure as extracted
...
MOD = (
    ...
    / "graph"
    / "sync_pkg"
    / "link_source_backed_file_structure.py"
)
_CORE_LOC_BEFORE = 4651
_NAME = "_link_source_backed_file_structure"
_OWNED = re.compile(
...
def test_link_source_backed_file_structure_owns_symbols_and_shrinks_core() -> None:
