"""Ratchet coverage for AUD-002 docs_reference_exact_candidates extract (#10526)."""
...
from memory.graph.sync_pkg import docs_reference_exact_candidates as extracted
...
MOD = (
    ...
    / "graph"
    / "sync_pkg"
    / "docs_reference_exact_candidates.py"
)
_CORE_LOC_BEFORE = 5792
_NAME = "_docs_reference_exact_candidates"
_OWNED = re.compile(
...
def test_docs_reference_exact_candidates_owns_symbols_and_shrinks_core() -> None:
