"""Ratchet coverage for AUD-002 entity_pipeline_contract_target extract (#10526)."""
...
from memory.graph.sync_pkg import entity_pipeline_contract_target as extracted
...
MOD = (
    ...
    / "graph"
    / "sync_pkg"
    / "entity_pipeline_contract_target.py"
)
_CORE_LOC_BEFORE = 3152
_NAME = "_entity_pipeline_contract_target"
_OWNED = re.compile(
...
def test_entity_pipeline_contract_target_owns_symbols_and_shrinks_core() -> None:
