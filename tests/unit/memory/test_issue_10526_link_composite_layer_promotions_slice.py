"""Ratchet coverage for AUD-002 link_composite_layer_promotions extract (#10526)."""
...
from memory.graph.sync_pkg import link_composite_layer_promotions as extracted
...
MOD = (
    ...
    / "graph"
    / "sync_pkg"
    / "link_composite_layer_promotions.py"
)
_CORE_LOC_BEFORE = 10302
_NAME = "_link_composite_layer_promotions"
_OWNED = re.compile(
...
def test_link_composite_layer_promotions_owns_symbols_and_shrinks_core() -> None:
