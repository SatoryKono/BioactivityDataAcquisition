"""Ratchet coverage for AUD-002 contract_dependency_module_specs extract (#10526)."""
...
from memory.graph.sync_pkg import contract_dependency_module_specs as extracted
...
MOD = (
    ...
    / "graph"
    / "sync_pkg"
    / "contract_dependency_module_specs.py"
)
_CORE_LOC_BEFORE = 6522
_NAME = "_contract_dependency_module_specs"
_OWNED = re.compile(
...
def test_contract_dependency_module_specs_owns_symbols_and_shrinks_core() -> None:
