"""Ratchet coverage for AUD-002 extract_code_duplication_surfaces extract (#10526)."""
...
from memory.graph.sync_pkg import extract_code_duplication_surfaces as extracted
...
MOD = (
    ...
    / "graph"
    / "sync_pkg"
    / "extract_code_duplication_surfaces.py"
)
_CORE_LOC_BEFORE = 3910
_NAME = "_extract_code_duplication_surfaces"
_OWNED = re.compile(
...
def test_extract_code_duplication_surfaces_owns_symbols_and_shrinks_core() -> None:
