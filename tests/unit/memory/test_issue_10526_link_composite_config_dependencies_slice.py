"""Ratchet coverage for AUD-002 link_composite_config_dependencies extract (#10526)."""
...
from memory.graph.sync_pkg import link_composite_config_dependencies as extracted
...
MOD = (
    ...
    / "graph"
    / "sync_pkg"
    / "link_composite_config_dependencies.py"
)
_CORE_LOC_BEFORE = 6059
_NAME = "_link_composite_config_dependencies"
_OWNED = re.compile(
...
def test_link_composite_config_dependencies_owns_symbols_and_shrinks_core() -> None:
