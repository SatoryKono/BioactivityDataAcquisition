"""Ratchet coverage for AUD-002 markdown_headings extract (#10526)."""
...
from memory.graph.sync_pkg import markdown_headings as extracted

pytestmark = pytest.mark.unit

ROOT = Path(__file__).resolve().parents[3]
CORE = ROOT / "src" / "memory" / "graph" / "sync_pkg" / "_core.py"
MOD = ROOT / "src" / "memory" / "graph" / "sync_pkg" / "markdown_headings.py"
_CORE_LOC_BEFORE = 5767
_NAME = "_markdown_headings"
_OWNED = re.compile(
...
def test_markdown_headings_owns_symbols_and_shrinks_core() -> None:
