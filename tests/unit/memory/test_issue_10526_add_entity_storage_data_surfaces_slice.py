"""Ratchet coverage for AUD-002 add_entity_storage_data_surfaces extract (#10526)."""
...
from memory.graph.sync_pkg import add_entity_storage_data_surfaces as extracted
...
MOD = (
    ...
    / "graph"
    / "sync_pkg"
    / "add_entity_storage_data_surfaces.py"
)
_CORE_LOC_BEFORE = 3681
_NAME = "_add_entity_storage_data_surfaces"
_OWNED = re.compile(
...
def test_add_entity_storage_data_surfaces_owns_symbols_and_shrinks_core() -> None:
