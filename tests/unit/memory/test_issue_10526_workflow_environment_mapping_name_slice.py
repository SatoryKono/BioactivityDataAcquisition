"""Ratchet coverage for AUD-002 workflow_environment_mapping_name extract (#10526)."""
...
from memory.graph.sync_pkg import workflow_environment_mapping_name as extracted
...
MOD = (
    ...
    / "graph"
    / "sync_pkg"
    / "workflow_environment_mapping_name.py"
)
_CORE_LOC_BEFORE = 6369
_NAME = "_workflow_environment_mapping_name"
_OWNED = re.compile(
...
def test_workflow_environment_mapping_name_owns_symbols_and_shrinks_core() -> None:
