"""Ratchet coverage for AUD-002 alert_annotations extract (#10526)."""
...
from memory.graph.sync_pkg import alert_annotations as extracted

pytestmark = pytest.mark.unit

ROOT = Path(__file__).resolve().parents[3]
CORE = ROOT / "src" / "memory" / "graph" / "sync_pkg" / "_core.py"
MOD = ROOT / "src" / "memory" / "graph" / "sync_pkg" / "alert_annotations.py"
_CORE_LOC_BEFORE = 4071
_NAME = "_alert_annotations"
_OWNED = re.compile(
...
def test_alert_annotations_owns_symbols_and_shrinks_core() -> None:
