"""Ratchet coverage for AUD-002 add_curated_cluster_readme extract (#10526)."""
...
from memory.graph.sync_pkg import add_curated_cluster_readme as extracted

pytestmark = pytest.mark.unit

ROOT = Path(__file__).resolve().parents[3]
CORE = ROOT / "src" / "memory" / "graph" / "sync_pkg" / "_core.py"
MOD = ROOT / "src" / "memory" / "graph" / "sync_pkg" / "add_curated_cluster_readme.py"
_CORE_LOC_BEFORE = 8779
_NAME = "_add_curated_cluster_readme"
_OWNED = re.compile(
...
def test_add_curated_cluster_readme_owns_symbols_and_shrinks_core() -> None:
