"""Ratchet coverage for AUD-002 t extract (#10526)."""
...
from memory.graph.sync_pkg import t as extracted

pytestmark = pytest.mark.unit

ROOT = Path(__file__).resolve().parents[3]
CORE = ROOT / "src" / "memory" / "graph" / "sync_pkg" / "_core.py"
MOD = ROOT / "src" / "memory" / "graph" / "sync_pkg" / "t.py"
_CORE_LOC_BEFORE = 2811
_NAME = "T"
_OWNED = re.compile(
...
def test_t_owns_symbols_and_shrinks_core() -> None:
