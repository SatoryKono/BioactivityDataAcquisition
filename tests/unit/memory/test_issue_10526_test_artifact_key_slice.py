"""Ratchet coverage for AUD-002 test_artifact_key extract (#10526)."""
...
from memory.graph.sync_pkg import test_artifact_key as extracted

pytestmark = pytest.mark.unit

ROOT = Path(__file__).resolve().parents[3]
CORE = ROOT / "src" / "memory" / "graph" / "sync_pkg" / "_core.py"
MOD = ROOT / "src" / "memory" / "graph" / "sync_pkg" / "test_artifact_key.py"
_CORE_LOC_BEFORE = 4030
_NAME = "_test_artifact_key"
_OWNED = re.compile(
...
def test_test_artifact_key_owns_symbols_and_shrinks_core() -> None:
