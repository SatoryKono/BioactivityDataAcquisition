"""Ratchet coverage for AUD-002 add_single_adr_constraint_edges extract (#10526)."""
...
from memory.graph.sync_pkg import add_single_adr_constraint_edges as extracted
...
MOD = (
    ...
    / "graph"
    / "sync_pkg"
    / "add_single_adr_constraint_edges.py"
)
_CORE_LOC_BEFORE = 4860
_NAME = "_add_single_adr_constraint_edges"
_OWNED = re.compile(
...
def test_add_single_adr_constraint_edges_owns_symbols_and_shrinks_core() -> None:
