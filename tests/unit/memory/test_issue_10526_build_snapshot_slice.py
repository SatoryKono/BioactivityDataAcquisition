"""Ratchet coverage for AUD-002 build_snapshot extract (#10526)."""
...
from memory.graph.sync_pkg import build_snapshot as extracted

pytestmark = pytest.mark.unit

ROOT = Path(__file__).resolve().parents[3]
CORE = ROOT / "src" / "memory" / "graph" / "sync_pkg" / "_core.py"
MOD = ROOT / "src" / "memory" / "graph" / "sync_pkg" / "build_snapshot.py"
_CORE_LOC_BEFORE = 2848
_NAME = "build_snapshot"
_OWNED = re.compile(
