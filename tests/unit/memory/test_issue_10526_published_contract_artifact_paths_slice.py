"""Ratchet coverage for AUD-002 published_contract_artifact_paths extract (#10526)."""
...
from memory.graph.sync_pkg import published_contract_artifact_paths as extracted
...
MOD = (
    ...
    / "graph"
    / "sync_pkg"
    / "published_contract_artifact_paths.py"
)
_CORE_LOC_BEFORE = 6639
_NAME = "_published_contract_artifact_paths"
_OWNED = re.compile(
...
def test_published_contract_artifact_paths_owns_symbols_and_shrinks_core() -> None:
