"""Ratchet coverage for AUD-002 int_node_property extract (#10526)."""
...
from memory.graph.sync_pkg import int_node_property as extracted

pytestmark = pytest.mark.unit

ROOT = Path(__file__).resolve().parents[3]
CORE = ROOT / "src" / "memory" / "graph" / "sync_pkg" / "_core.py"
MOD = ROOT / "src" / "memory" / "graph" / "sync_pkg" / "int_node_property.py"
_CORE_LOC_BEFORE = 12443
_NAME = "_int_node_property"
_OWNED = re.compile(
...
def test_int_node_property_owns_symbols_and_shrinks_core() -> None:
