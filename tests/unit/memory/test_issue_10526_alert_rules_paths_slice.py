"""Ratchet coverage for AUD-002 alert_rules_paths extract (#10526)."""
...
from memory.graph.sync_pkg import alert_rules_paths as extracted

pytestmark = pytest.mark.unit

ROOT = Path(__file__).resolve().parents[3]
CORE = ROOT / "src" / "memory" / "graph" / "sync_pkg" / "_core.py"
MOD = ROOT / "src" / "memory" / "graph" / "sync_pkg" / "alert_rules_paths.py"
_CORE_LOC_BEFORE = 3267
_NAME = "_alert_rules_paths"
_OWNED = re.compile(
...
def test_alert_rules_paths_owns_symbols_and_shrinks_core() -> None:
