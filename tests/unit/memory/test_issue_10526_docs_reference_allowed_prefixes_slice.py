"""Ratchet coverage for AUD-002 docs_reference_allowed_prefixes extract (#10526)."""
...
from memory.graph.sync_pkg import docs_reference_allowed_prefixes as extracted
...
MOD = (
    ...
    / "graph"
    / "sync_pkg"
    / "docs_reference_allowed_prefixes.py"
)
_CORE_LOC_BEFORE = 7388
_NAME = "_DOCS_REFERENCE_ALLOWED_PREFIXES"
_OWNED = re.compile(
...
def test_docs_reference_allowed_prefixes_owns_symbols_and_shrinks_core() -> None:
