...
class TestCheckpointCommands:
    ...
    @patch("bioetl.interfaces.cli.bootstrap_checkpoint_manager")
    def test_checkpoint_list_command(self, mock_bootstrap_checkpoint_manager, runner):
        ...
        mock_bootstrap_checkpoint_manager.return_value = mock_checkpoint_manager
...
class TestQuarantineCommands:
    ...
    @patch("bioetl.interfaces.cli.bootstrap_quarantine_manager")
    def test_quarantine_inspect_command(self, mock_bootstrap_quarantine_manager, runner):
        ...
        mock_bootstrap_quarantine_manager.return_value = mock_quarantine_manager
    ...
    def test_quarantine_inspect_empty_command(
        self, mock_bootstrap_quarantine_manager, runner
    ):
