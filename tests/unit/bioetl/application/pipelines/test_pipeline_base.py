...
def test_pipeline_run_success(
    ...
    # Verify write called
    mock_output_service.write_result.assert_called_once()
...
def test_pipeline_dry_run(
    ...
    mock_output_service.write_result.assert_not_called()
...
def test_hashing_logic(
    ...
    pipeline = ConcretePipeline(
        mock_config, mock_logger, mock_validation_service, mock_output_service
    )
