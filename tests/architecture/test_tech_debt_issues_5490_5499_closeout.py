...
def test_issue_5492_public_export_budgets_stay_reduced() -> None:
    ...
    assert budgets["src/bioetl/composition/entrypoints.py"] == 14
    assert budgets["src/bioetl/composition/health_api.py"] == 7
    assert budgets["src/bioetl/composition/maintenance_api.py"] == 4
