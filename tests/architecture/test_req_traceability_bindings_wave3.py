...
WAVE3_CONCRETE_SURFACES: dict[str, tuple[str, ...]] = {
    # 1. Архитектура и Слои — REQ-ARCH-011 hierarchy, REQ-ARCH-012 immutability, REQ-ARCH-013 error handler
    ...
    # 5. Операции и Control Plane — REQ-AUDIT-001/002 audit port
    "REQ-AUDIT-001": (
