...
Ensures that all 62 port protocols in domain/ports/ are decorated with
...
class TestAllPortsRuntimeCheckable:
    ...
    def test_port_count_is_62(self) -> None:
        """Sanity check: we expect exactly 62 port protocols."""
        assert len(ALL_PORT_NAMES) == 62, (
            f"Expected 62 ports, found {len(ALL_PORT_NAMES)}. "
