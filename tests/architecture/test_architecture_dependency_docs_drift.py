...
def _load_dep_map_module() -> ModuleType:
    script = Path("scripts/engineering/qa/generate_architecture_dependency_map.py").resolve()
...
def test_docs_workflow_checks_dependency_map_drift() -> None:
    ...
    assert "scripts/engineering/qa/generate_architecture_dependency_map.py --check" in workflow
...
def test_docs_workflow_autogen_dependency_map_on_pr() -> None:
    ...
    assert "scripts/engineering/qa/generate_architecture_dependency_map.py --update" in workflow
...
def test_pre_commit_checks_dependency_map_drift() -> None:
    ...
    assert "scripts/engineering/qa/generate_architecture_dependency_map.py --check" in pre_commit
...
def test_dependency_map_generated_markdown_uses_canonical_generator_path() -> None:
    ...
    assert "scripts/engineering/qa/generate_architecture_dependency_map.py" in markdown, (
