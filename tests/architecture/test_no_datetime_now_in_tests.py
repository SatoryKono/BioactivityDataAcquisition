...
ALLOWED_PATHS: set[str] = {
    ...
    "unit/application/services/test_metadata_coordinator.py",
    ...
    "unit/application/services/test_run_manifest_inspection_service.py",
    "unit/composition/factories/pipeline/test_checkpoint_metadata_helpers.py",
    "unit/domain/aggregates/test_pipeline_run.py",
    ...
    "unit/infrastructure/control_plane/test_file_run_ledger_store.py",
    ...
    "unit/infrastructure/observability/test_anomaly.py",
