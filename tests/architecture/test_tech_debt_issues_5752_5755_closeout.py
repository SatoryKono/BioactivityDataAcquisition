...
def test_issue_5752_narrative_reports_match_live_governance_artifacts() -> None:
    ...
    assert test_governance["report"]["total_test_functions"] == 22579
    assert test_governance["report"]["total_test_files"] == 2021
    ...
    assert "`22,579` test functions across `2,021` pytest" in debt_report
