...
_SURFACES = (
    ...
    ROOT
    / "tests/unit/repo_backed/scripts/ai/agent_tools/test_install_contracts.py",  # REQ-DEP-001
    ...
    ROOT
    / "tests/architecture/test_gitignore_secret_and_agents_policy.py",  # REQ-ENV-003
    ROOT
    / "tests/architecture/test_regression_metrics.py",  # REQ-GOV-001, REQ-PYTHON-001
    ROOT / "tests/architecture/test_config_golden_master.py",  # REQ-GOV-002
    ROOT
    / "tests/integration/idempotency/test_reproducibility_idempotency_gate.py",  # REQ-GOV-003
    ...
    ROOT
    / "tests/architecture/test_non_chembl_json_field_typing_policy.py",  # REQ-PYTHON-002/003
    ...
    ROOT
    / "tests/architecture/test_code_formatting.py",  # REQ-STACK-004, REQ-PYTHON-001
