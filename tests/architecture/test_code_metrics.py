...
class TestFileSizeLimits:
    ...
    EXEMPTIONS = {
        ...
        "data_normalization_service.py": 370,  # 365 LOC - DefaultDataNormalizationService with partial date/value normalization
...
class TestClassSize:
    ...
    EXEMPTIONS = {
        ...
        "DefaultDataNormalizationService": 340,  # 332 lines - Data normalization service with partial date/value normalization
...
class TestGodObjectDetection:
    ...
    EXEMPTIONS = {
        ...
        "DefaultDataNormalizationService": "Cohesive service - all methods relate to data normalization (dates, values, partial matching)",
