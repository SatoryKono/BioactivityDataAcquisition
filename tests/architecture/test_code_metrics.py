...
class TestFileSizeLimits:
    ...
    EXEMPTIONS = {
        ...
        "pipeline_config.py": 910,  # 905 LOC - Pipeline configuration loading and validation + TransformConfig + FilterConfig (ADR-028) + GoldColumnFilterConfig (extended operators)
