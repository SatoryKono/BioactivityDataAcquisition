...
class TestFileSizeLimits:
    ...
    EXEMPTIONS = {
        ...
        "value_validator.py": 360,  # 351 LOC - Value validation with multiple checks
...
class TestClassSize:
    ...
    EXEMPTIONS = {
        ...
        "ActivityAggregator": 320,  # 311 lines - Activity aggregation service
        "ValueValidator": 320,  # 311 lines - Value validation service
...
class TestGodObjectDetection:
    ...
    EXEMPTIONS = {
        ...
        "ValueValidator": "Cohesive service - all methods relate to value validation rules",
