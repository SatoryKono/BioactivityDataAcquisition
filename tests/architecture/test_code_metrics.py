...
class TestFileSizeLimits:
    ...
    EXEMPTIONS = {
        ...
        "gold.py": 990,  # 989 LOC - Gold layer Pandera schemas (+ IDMapping + cross-reference ID fields + CrossRef pmid/pmc_id/lookup_method fields + publication schemas + DATE_REGEX validation + ChEMBL Document lookup tracking)
