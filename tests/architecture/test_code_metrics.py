...
class TestFileSizeLimits:
    ...
    EXEMPTIONS = {
        ...
        # Infrastructure layer exemptions
        "silver_writer.py": 1155,  # 1147 LOC - schema drift + merge logic + MetadataCoordinator fallback + SilverWriteResult return + transform lineage
        "gold_writer.py": 940,  # 933 LOC - SCD Type 2 + MetadataCoordinator fallback + silver_refs lineage + transform lineage
...
class TestClassSize:
    ...
    EXEMPTIONS = {
        ...
        "SilverWriter": 1155,  # 1147 lines - schema drift detection + bronze_refs + MetadataCoordinator fallback
        "GoldWriter": 940,  # 933 lines - SCD Type 2 + metadata sidecar + MetadataCoordinator fallback
