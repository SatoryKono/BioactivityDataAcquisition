...
class TestErrorClassifier:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (ApiError("fail"), ErrorType.NETWORK_ERROR),  # Fallback hierarchy -> RecoverableError -> NETWORK_ERROR
    ...
    @given(st.text())
    def test_classify_unknown_exception(self, classifier: ErrorClassifier, msg: str) -> None:
