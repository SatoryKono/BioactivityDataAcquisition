...
from bioetl.domain.exceptions import LockLostError, LockAcquisitionError
...
class TestLockManager:
    ...
    async def test_context_manager_success(
        ...
        assert lock_manager._heartbeat_task.done() or lock_manager._heartbeat_task.cancelled()
