...
# VCR cassette directory for OpenAlex E2E tests
CASSETTE_DIR = Path(__file__).parent.parent / "fixtures" / "vcr" / "openalex"
...
def vcr_config() -> dict[str, Any]:
    """Configure VCR for OpenAlex Publication E2E tests."""
    return {
