...
def test_req_load_001_002_load_strategy(config_path):
    ...
    assert "load_strategy" in source, f"'load_strategy' missing in source of {config_path}"
    assert source["load_strategy"] in ["incremental", "full"], f"Invalid 'load_strategy' in {config_path}"
