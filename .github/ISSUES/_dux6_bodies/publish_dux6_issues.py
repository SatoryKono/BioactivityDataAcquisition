#!/usr/bin/env python3
"""Publish DUX6 epic + children via GitHub CLI and write a publish record.

Usage (from repo root, after valid GH auth):

    python .github/ISSUES/_dux6_bodies/publish_dux6_issues.py --dry-run
    python .github/ISSUES/_dux6_bodies/publish_dux6_issues.py
"""
...
PACK = (
    ...
    / ".github"
    / "ISSUES"
    / "DUX6-2026-07-29-DASHBOARD-READABILITY-REAUDIT-RESIDUAL-ISSUE-PACK.md"
)
