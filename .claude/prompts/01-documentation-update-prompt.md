...
- RULES.md v5.23 — источник истины
...
- Версия ниже v5.23 без актуального контента
...
*Last Updated: YYYY-MM-DD | RULES.md v5.23*
...
**Документы для обновления версии на v5.23:**

| Документ | Действие |
|----------|----------|
| `docs/00-map.md` | Обновить "Synced with RULES.md v5.23" |
...
```markdown
*Synced with RULES.md v5.23 | Last updated: 2025-12-29*
```
...
**Версионирование:**
- [ ] Все документы обновлены до v5.23
...
- [ ] `make lint` — проходит
- [ ] `00-map.md` обновлён
- [ ] Коммит с сообщением: `docs: consolidate documentation and update to v5.23`
