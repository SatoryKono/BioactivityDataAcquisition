...
2. Place file: `docs/02-architecture/mmd-diagrams/{name}.mmd` or `docs/02-architecture/diagrams/mermaid/{category}/{name}.mermaid`
...
5. >20 nodes: add `%%{init: {"flowchart": {"defaultRenderer": "elk"}}}%%`
6. Use canonical ADR-040 palette only (no ad-hoc hex)
7. Apply Layout Best Practices (LBP-001..010)
