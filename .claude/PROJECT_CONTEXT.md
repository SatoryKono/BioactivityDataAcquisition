...
*Синхронизировано с RULES.md v5.23 (2026-03-04)*

> **Это сокращённая версия.** Полная документация:
> - `docs/00-project/RULES.md` — **Единственный источник истины** для архитектурных правил
> - `docs/00-project/ai/agents/CLAUDE.md` — Протокол верификации и архитектурные пояснения
> - `docs/00-project/ai/agents/AGENT.md` — Персона, workflow и инструкции для агента
...
> **Полная документация**: См. `docs/00-project/RULES.md` §1 и `docs/00-project/ai/agents/CLAUDE.md` §2
...
> См. `docs/00-project/ai/agents/CLAUDE.md` §0 и §2.3 для списка частых ложных выводов.
