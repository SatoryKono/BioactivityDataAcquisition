...
## name: py-architecture-debt-bot description: Execute the full BioETL architecture-debt reduction workflow: generate tasks from the exemptions registry, build an execution plan, coordinate targeted debt reduction, and close with verification across py-test-bot, py-config-bot, py-doc-bot, and py-audit-bot. allowed-tools: Bash, Read, Write, Edit, Grep, Glob context: fork agent: general-purpose
...
1. Open and follow `../../agents/py-architecture-debt-bot.md`.
1. Use deterministic helpers before editing code or delegating subagents.
