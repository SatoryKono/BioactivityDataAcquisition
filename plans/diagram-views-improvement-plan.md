...
- Текущее состояние: `lint issues = 0`; quality warnings = 32 (`DIAG-T022=9`, `DIAG-T023=23`).
- В этом цикле автоматизировано: нормализация семантики связей (`LINK-001` закрыт), базовые `classDef` и стабилизация `linkStyle`-группировок.
...
| 2 | `01-full-system-component-dataflow.mermaid` | `flowchart` | — | поддерживать явный путь данных Bronze→Silver→Gold и маркировать ветки ошибок | обновлено в этом цикле |
| 3 | `01-full-system-component-domain.mermaid` | `flowchart` | — | поддерживать доменную фокусировку: исключать инфраструктурные детали и служебные узлы | обновлено в этом цикле |
...
| 7 | `01-high-level-dataflow.mermaid` | `flowchart` | — | поддерживать явный путь данных Bronze→Silver→Gold и маркировать ветки ошибок | обновлено в этом цикле |
...
| 10 | `01-high-level-infra.mermaid` | `flowchart` | — | поддерживать инфраструктурный фокус: показывать адаптеры/хранилища и точки интеграции | обновлено в этом цикле |
...
| 17 | `04-domain-layer-class-diagram-dataflow.mermaid` | `flowchart` | — | поддерживать явный путь данных Bronze→Silver→Gold и маркировать ветки ошибок | обновлено в этом цикле |
...
| 20 | `04-domain-layer-class-diagram-infra.mermaid` | `flowchart` | — | поддерживать инфраструктурный фокус: показывать адаптеры/хранилища и точки интеграции | обновлено в этом цикле |
...
| 22 | `05-layers-interaction-dataflow.mermaid` | `flowchart` | — | поддерживать явный путь данных Bronze→Silver→Gold и маркировать ветки ошибок | обновлено в этом цикле |
...
| 26 | `05-layers-interaction-overview.mermaid` | `flowchart` | — | держать L1-вид в пределах 5-9 блоков и проверять пересечения при добавлении узлов | обновлено в этом цикле |
| 27 | `05-pipeline-lifecycle-states-dataflow.mermaid` | `flowchart` | — | поддерживать явный путь данных Bronze→Silver→Gold и маркировать ветки ошибок | обновлено в этом цикле |
...
| 32 | `06-application-layer-class-diagram-dataflow.mermaid` | `flowchart` | — | поддерживать явный путь данных Bronze→Silver→Gold и маркировать ветки ошибок | обновлено в этом цикле |
...
| 42 | `08-complete-etl-workflow-dataflow.mermaid` | `flowchart` | — | поддерживать явный путь данных Bronze→Silver→Gold и маркировать ветки ошибок | обновлено в этом цикле |
...
| 46 | `08-complete-etl-workflow-overview.mermaid` | `flowchart` | — | держать L1-вид в пределах 5-9 блоков и проверять пересечения при добавлении узлов | обновлено в этом цикле |
| 47 | `08-domain-ddd-dataflow.mermaid` | `flowchart` | — | поддерживать явный путь данных Bronze→Silver→Gold и маркировать ветки ошибок | обновлено в этом цикле |
...
| 49 | `08-domain-ddd-full.mermaid` | `flowchart` | DIAG-T022, DIAG-T023 | сократить длинные подписи (>90), детали вынести в note/tooltip/docs; уменьшить число `<br/>` в одной подписи до 4 или меньше | без правок в этом цикле |
...
| 52 | `10-infrastructure-layer-class-diagram-dataflow.mermaid` | `flowchart` | — | поддерживать явный путь данных Bronze→Silver→Gold и маркировать ветки ошибок | обновлено в этом цикле |
...
| 57 | `12-local-deployment-architecture-dataflow.mermaid` | `flowchart` | — | поддерживать явный путь данных Bronze→Silver→Gold и маркировать ветки ошибок | обновлено в этом цикле |
...
| 82 | `28-composition-root-di-graph-dataflow.mermaid` | `flowchart` | — | поддерживать явный путь данных Bronze→Silver→Gold и маркировать ветки ошибок | обновлено в этом цикле |
| 83 | `28-composition-root-di-graph-domain.mermaid` | `flowchart` | — | поддерживать доменную фокусировку: исключать инфраструктурные детали и служебные узлы | обновлено в этом цикле |
...
| 85 | `28-composition-root-di-graph-infra.mermaid` | `flowchart` | — | поддерживать инфраструктурный фокус: показывать адаптеры/хранилища и точки интеграции | обновлено в этом цикле |
...
| 87 | `29-composite-pipeline-workflow-dataflow.mermaid` | `flowchart` | — | поддерживать явный путь данных Bronze→Silver→Gold и маркировать ветки ошибок | обновлено в этом цикле |
| 88 | `29-composite-pipeline-workflow-domain.mermaid` | `flowchart` | — | поддерживать доменную фокусировку: исключать инфраструктурные детали и служебные узлы | обновлено в этом цикле |
...
| 90 | `29-composite-pipeline-workflow-infra.mermaid` | `flowchart` | — | поддерживать инфраструктурный фокус: показывать адаптеры/хранилища и точки интеграции | обновлено в этом цикле |
...
| 93 | `30-port-adapter-mapping-domain.mermaid` | `flowchart` | — | поддерживать доменную фокусировку: исключать инфраструктурные детали и служебные узлы | обновлено в этом цикле |
...
| 95 | `30-port-adapter-mapping-infra.mermaid` | `flowchart` | — | поддерживать инфраструктурный фокус: показывать адаптеры/хранилища и точки интеграции | обновлено в этом цикле |
...
| 97 | `31-pipeline-run-lifecycle-dataflow.mermaid` | `flowchart` | — | поддерживать явный путь данных Bronze→Silver→Gold и маркировать ветки ошибок | обновлено в этом цикле |
...
| 104 | `32-single-record-journey-full.mermaid` | `flowchart` | DIAG-T022 | сократить длинные подписи (>90), детали вынести в note/tooltip/docs | без правок в этом цикле |
...
| 112 | `34-batch-processing-flow-dataflow.mermaid` | `flowchart` | — | поддерживать явный путь данных Bronze→Silver→Gold и маркировать ветки ошибок | обновлено в этом цикле |
...
| 116 | `34-batch-processing-flow-overview.mermaid` | `flowchart` | — | держать L1-вид в пределах 5-9 блоков и проверять пересечения при добавлении узлов | обновлено в этом цикле |
| 117 | `35-bootstrap-sequence-dataflow.mermaid` | `flowchart` | — | поддерживать явный путь данных Bronze→Silver→Gold и маркировать ветки ошибок | обновлено в этом цикле |
| 118 | `35-bootstrap-sequence-domain.mermaid` | `flowchart` | — | поддерживать доменную фокусировку: исключать инфраструктурные детали и служебные узлы | обновлено в этом цикле |
...
| 120 | `35-bootstrap-sequence-infra.mermaid` | `flowchart` | — | поддерживать инфраструктурный фокус: показывать адаптеры/хранилища и точки интеграции | обновлено в этом цикле |
| 121 | `35-bootstrap-sequence-overview.mermaid` | `flowchart` | — | держать L1-вид в пределах 5-9 блоков и проверять пересечения при добавлении узлов | обновлено в этом цикле |
| 122 | `36-architecture-principles-mindmap-dataflow.mermaid` | `flowchart` | — | поддерживать явный путь данных Bronze→Silver→Gold и маркировать ветки ошибок | обновлено в этом цикле |
| 123 | `36-architecture-principles-mindmap-domain.mermaid` | `flowchart` | — | поддерживать доменную фокусировку: исключать инфраструктурные детали и служебные узлы | обновлено в этом цикле |
...
| 127 | `39-medallion-invariants-dataflow.mermaid` | `flowchart` | — | поддерживать явный путь данных Bronze→Silver→Gold и маркировать ветки ошибок | обновлено в этом цикле |
| 128 | `39-medallion-invariants-domain.mermaid` | `flowchart` | — | поддерживать доменную фокусировку: исключать инфраструктурные детали и служебные узлы | обновлено в этом цикле |
| 129 | `39-medallion-invariants-full.mermaid` | `flowchart` | DIAG-T022 | сократить длинные подписи (>90), детали вынести в note/tooltip/docs | без правок в этом цикле |
| 130 | `39-medallion-invariants-infra.mermaid` | `flowchart` | — | поддерживать инфраструктурный фокус: показывать адаптеры/хранилища и точки интеграции | обновлено в этом цикле |
| 131 | `39-medallion-invariants-overview.mermaid` | `flowchart` | — | держать L1-вид в пределах 5-9 блоков и проверять пересечения при добавлении узлов | обновлено в этом цикле |
| 132 | `41-error-classification-tree-dataflow.mermaid` | `flowchart` | — | поддерживать явный путь данных Bronze→Silver→Gold и маркировать ветки ошибок | обновлено в этом цикле |
| 133 | `41-error-classification-tree-domain.mermaid` | `flowchart` | — | поддерживать доменную фокусировку: исключать инфраструктурные детали и служебные узлы | обновлено в этом цикле |
...
| 135 | `41-error-classification-tree-infra.mermaid` | `flowchart` | — | поддерживать инфраструктурный фокус: показывать адаптеры/хранилища и точки интеграции | обновлено в этом цикле |
...
| 137 | `44-cross-provider-enrichment-dataflow.mermaid` | `flowchart` | — | поддерживать явный путь данных Bronze→Silver→Gold и маркировать ветки ошибок | обновлено в этом цикле |
| 138 | `44-cross-provider-enrichment-domain.mermaid` | `flowchart` | — | поддерживать доменную фокусировку: исключать инфраструктурные детали и служебные узлы | обновлено в этом цикле |
| 139 | `44-cross-provider-enrichment-full.mermaid` | `flowchart` | DIAG-T023, DIAG-T022 | сократить длинные подписи (>90), детали вынести в note/tooltip/docs; уменьшить число `<br/>` в одной подписи до 4 или меньше | без правок в этом цикле |
| 140 | `44-cross-provider-enrichment-infra.mermaid` | `flowchart` | — | поддерживать инфраструктурный фокус: показывать адаптеры/хранилища и точки интеграции | обновлено в этом цикле |
| 141 | `44-cross-provider-enrichment-overview.mermaid` | `flowchart` | — | держать L1-вид в пределах 5-9 блоков и проверять пересечения при добавлении узлов | обновлено в этом цикле |
...
| 152 | `50-exception-hierarchy-dataflow.mermaid` | `flowchart` | — | поддерживать явный путь данных Bronze→Silver→Gold и маркировать ветки ошибок | обновлено в этом цикле |
...
| 155 | `50-exception-hierarchy-infra.mermaid` | `flowchart` | — | поддерживать инфраструктурный фокус: показывать адаптеры/хранилища и точки интеграции | обновлено в этом цикле |
