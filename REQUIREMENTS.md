...
#### REQ-SALT-001
- **Уровень**: MUST
- **Описание**: Dual-Salt Period: 7 дней transition
- **Проверка**: Тест — оба хэша проверяются в transition период

#### REQ-SALT-002
- **Уровень**: MUST
- **Описание**: Алерт если >1% записей не мигрировано после 14 дней
- **Проверка**: Проверить наличие алерта
...
#### REQ-DEP-001
- **Уровень**: MUST
- **Описание**: Точные версии в requirements.txt / pyproject.toml (pinning)
