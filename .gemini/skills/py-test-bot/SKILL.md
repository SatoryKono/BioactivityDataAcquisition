...
2. Open and follow `../../agents/py-test-bot.md`.
...
5. After testing, run `python -m memory.tooling.workflow post-task ...` and promote only durable failure classifications or testing lessons.
