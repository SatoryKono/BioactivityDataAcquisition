...
Generic imported profiles and `sp-*` helpers still inherit BioETL guardrails
from `AGENTS.md`, `MEMORY_USAGE.md`, and the Local-Only runtime constraints
even when they are not fully BioETL-specific.
