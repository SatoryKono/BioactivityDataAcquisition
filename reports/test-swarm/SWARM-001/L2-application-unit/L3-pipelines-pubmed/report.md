...
|:-:|---------|----------|------------|-----|----------|
| 1 | test_L3-pipelines-pubmed_1 | Data | Schema drift | Fixed mock | `test_mock.py:42` |
| 2 | test_L3-pipelines-pubmed_2 | Data | Schema drift | Fixed mock | `test_mock.py:42` |
| 3 | test_L3-pipelines-pubmed_3 | Data | Schema drift | Fixed mock | `test_mock.py:42` |
