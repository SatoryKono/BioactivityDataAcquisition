...
|:-:|---------|----------|------------|-----|----------|
| 1 | test_L3-adapters-chembl_1 | State | Bug | Fix | `file:1` |

## Regression Tests Added (for fixed bugs)
| # | Test | Covers Bug | File |
|:-:|------|-----------|------|
| 1 | test_reg_L3-adapters-chembl | Bug | test_a.py |

## New Tests Created
| # | File | Tests Added | Covers Module | Coverage Delta |
|:-:|------|:-----------:|---------------|:--------------:|
| 1 | test_new_L3-adapters-chembl.py | 10 | mod.py | +8.0% |

## Optimized Tests
| # | Test ID | Before | After | Optimization |
|:-:|---------|:------:|:-----:|-------------|
| 1 | test_opt_L3-adapters-chembl | 1s | 0.1s | Opt |

## Flaky Tests Detected
| # | Test ID | Flakiness Rate | Triage Status | Suspected Cause |
|:-:|---------|:--------------:|:-------------:|-----------------|
| 1 | test_flaky_L3-adapters-chembl | 20% | fixed | State |
