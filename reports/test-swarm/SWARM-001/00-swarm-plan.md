...
| Coverage (overall) | 88% |
| Coverage (domain) | 92% |
| Architecture tests | 2250/2268 pass |
| mypy errors | 36 |
...
| 2 | L2-app-unit | tests/unit/application/ | unit | ~133 | 70 | P1 |
...
| 5 | L2-crosscutting | tests/architecture/ + tests/e2e/ + tests/contract/ + tests/benchmarks/ | architecture + e2e + contract + bench | ~100 | 95 | P2 |
