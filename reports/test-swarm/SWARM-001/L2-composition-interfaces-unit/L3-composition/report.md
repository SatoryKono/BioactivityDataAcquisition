...
|:-:|---------|----------|------------|-----|----------|
| 1 | test_L3-composition_1 | Data | Schema drift | Fixed mock | `test_mock.py:42` |
| 2 | test_L3-composition_2 | Data | Schema drift | Fixed mock | `test_mock.py:42` |
| 3 | test_L3-composition_3 | Data | Schema drift | Fixed mock | `test_mock.py:42` |
