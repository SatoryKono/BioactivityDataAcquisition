...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | --- | --- |
| `application_core` | 196 | 24099 | 0 | 0.384 | 0 | 5 | `bioetl.application.core.target_data_source_mixins` | `files_ge_250_loc=0, max_internal_fan_in=7` | `-` | `-` |
...
| `application_services_control_plane` | 124 | 14669 | 0 | 0.374 | 0 | 1 | `bioetl.application.services.control_plane.workflow.manifest_models` | `files_ge_250_loc=0, max_internal_fan_in=2` | `-` | `-` |
