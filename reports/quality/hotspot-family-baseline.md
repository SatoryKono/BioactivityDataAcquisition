...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| `application_core` | 172 | 21587 | 13 | 0.377 | 8 | 14 | `bioetl.application.core.batch_runtime_failure_policy` | `files_ge_250_loc=13, max_internal_fan_in=14` | `at_budget:files_ge_250_loc=13/13, at_budget:max_internal_fan_in=14/14` |
| `composition_bootstrap_runtime` | 44 | 5737 | 5 | 0.310 | 5 | 5 | `bioetl.composition.bootstrap.runtime.composite_support_service_bundles` | `files_ge_250_loc=5, max_internal_fan_in=5` | `at_budget:files_ge_250_loc=5/5, at_budget:max_internal_fan_in=5/5` |
