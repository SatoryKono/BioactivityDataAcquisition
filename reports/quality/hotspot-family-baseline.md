...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | --- | --- |
| `application_core` | 192 | 23102 | 0 | 0.365 | 0 | 6 | `bioetl.application.core.pipeline_span_lifecycle` | `files_ge_250_loc=0, max_internal_fan_in=10` | `-` | `-` |
...
| `application_services_control_plane` | 139 | 16069 | 0 | 0.419 | 0 | 2 | `bioetl.application.services.control_plane.workflow.manifest_models` | `files_ge_250_loc=0, max_internal_fan_in=2` | `-` | `at_budget:max_internal_fan_in=2/2` |
