...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | --- | --- |
| `application_core` | 192 | 23335 | 0 | 0.370 | 0 | 6 | `bioetl.application.core.pipeline_span_lifecycle` | `files_ge_250_loc=0, max_internal_fan_in=10` | `-` | `-` |
...
| `application_services_control_plane` | 140 | 16279 | 0 | 0.424 | 0 | 2 | `bioetl.application.services.control_plane.workflow.manifest_models` | `files_ge_250_loc=0, max_internal_fan_in=2` | `-` | `at_budget:max_internal_fan_in=2/2` |
| `composition_runtime_builders` | 56 | 7184 | 0 | 0.353 | 0 | 3 | `bioetl.composition.runtime_builders.run_manifest_support` | `files_ge_250_loc=0, max_internal_fan_in=5` | `-` | `-` |
