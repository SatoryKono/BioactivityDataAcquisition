...
| `application_services_control_plane` | 139 | 16089 | 0 | 0.420 | 0 | 2 | `bioetl.application.services.control_plane.workflow.manifest_models` | `files_ge_250_loc=0, max_internal_fan_in=2` | `-` | `at_budget:max_internal_fan_in=2/2` |
