...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| `application_core` | 172 | 21256 | 12 | 0.375 | 8 | 14 | `bioetl.application.core.batch_runtime_failure_policy` | `files_ge_250_loc=12, max_internal_fan_in=14` | `at_budget:files_ge_250_loc=12/12, at_budget:max_internal_fan_in=14/14` |
