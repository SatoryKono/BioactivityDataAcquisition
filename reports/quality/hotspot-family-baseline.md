...
| `composition_factories_pipeline` | 35 | 4650 | 2 | 0.417 | 0 | 3 | `bioetl.composition.factories.pipeline.control_plane_artifacts` | `files_ge_250_loc=3, max_internal_fan_in=3` | `-` | `at_budget:max_internal_fan_in=3/3` |
