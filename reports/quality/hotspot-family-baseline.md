...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| `application_core` | 172 | 21489 | 13 | 0.377 | 8 | 14 | `bioetl.application.core.batch_runtime_failure_policy` | `files_ge_250_loc=13, max_internal_fan_in=14` | `at_budget:files_ge_250_loc=13/13, at_budget:max_internal_fan_in=14/14` |
