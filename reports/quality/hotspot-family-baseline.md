...
| `composition_bootstrap_runtime` | 51 | 6192 | 0 | 0.330 | 0 | 2 | `bioetl.composition.bootstrap.runtime.tracing_bootstrap` | `files_ge_250_loc=0, max_internal_fan_in=3` | `-` | `-` |
...
| `composition_runtime_builders` | 57 | 7220 | 0 | 0.375 | 0 | 3 | `bioetl.composition.runtime_builders.inputs_runtime_helpers` | `files_ge_250_loc=0, max_internal_fan_in=3` | `-` | `at_budget:max_internal_fan_in=3/3` |
