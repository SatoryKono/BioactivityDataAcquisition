...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | --- | --- |
| `application_core` | 180 | 22306 | 4 | 0.356 | 0 | 10 | `bioetl.application.core.batch_runtime_failure_policy` | `files_ge_250_loc=7, max_internal_fan_in=10` | `-` | `at_budget:max_internal_fan_in=10/10` |
