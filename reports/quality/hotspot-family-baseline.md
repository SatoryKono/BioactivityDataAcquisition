...
| `composition_bootstrap_runtime` | 49 | 5982 | 0 | 0.302 | 0 | 3 | `bioetl.composition.bootstrap.runtime.observability` | `files_ge_250_loc=0, max_internal_fan_in=3` | `-` | `at_budget:max_internal_fan_in=3/3` |
