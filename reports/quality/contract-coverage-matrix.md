...
| --- | --- | --- | ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | --- | ---: | ---: | --- | --- |
| `chembl_activity` | `gold` | `chembl.activity` | True | True | `covered` | `covered` | True | 72 | 7 | 0 | `activity_id, entity_id` | 23 | 2 | - | - |
...
| `chembl_protein_class` | `gold` | `chembl.protein_class` | True | True | `covered` | `covered` | True | 15 | 6 | 0 | `entity_id, protein_class_id` | 14 | 2 | - | - |
| `chembl_publication` | `gold` | `chembl.publication` | True | True | `covered` | `covered` | True | 30 | 7 | 0 | `entity_id, publication_id` | 63 | 2 | - | - |
...
| `composite_activity` | `gold` | `composite.activity` | True | True | `covered` | `covered` | True | 21 | 6 | 0 | `entity_id` | 23 | 2 | - | - |
...
| `composite_publication` | `gold` | `composite.publication` | True | True | `covered` | `covered` | True | 15 | 7 | 0 | `entity_id` | 63 | 2 | - | - |
| `composite_target` | `gold` | `composite.target` | True | True | `covered` | `covered` | True | 41 | 6 | 0 | `entity_id` | 17 | 2 | - | - |
| `crossref_publication` | `gold` | `crossref.publication` | True | True | `covered` | `covered` | True | 51 | 9 | 0 | `doi, entity_id` | 63 | 2 | - | - |
| `openalex_publication` | `gold` | `openalex.publication` | True | True | `covered` | `covered` | True | 53 | 10 | 0 | `entity_id, openalex_id` | 63 | 2 | - | - |
