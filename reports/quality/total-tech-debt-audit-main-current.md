...
Audited commit SHA: `fe936a7a44cce15b9ced91b2b8cf931845775661`

Evidence surface SHA-256: `797aa08f2f13e4302b0360eb244b06b82a257d2444cadce20a15045da07e007c`
...
<!-- technical-debt-audit-summary-v1
{
  ...
  "audited_commit_sha": "fe936a7a44cce15b9ced91b2b8cf931845775661",
  "evidence_surface_sha256": "797aa08f2f13e4302b0360eb244b06b82a257d2444cadce20a15045da07e007c",
  "metrics": {
    "architecture_integral_score": 9.16,
...
Refresh reason: Re-pin to origin/main `fe936a7a44` for #9337; refreshed remote-main baseline (#9399); honest unmeasured=1 residual (#9400); no budget growth.

## Executive summary

1. Debt-governance gates: **44 pass / 1 fail** (`44/45` debt-governance gates).
1. Release status: **debt-governance gates failing** (`module_coverage_unmeasured_modules`).
1. Architecture quality integral score: **9.16** (`good_targeted_improvements`). Integral score `9.16`.
1. Module inventory (from `module-coverage-inventory.json` only):
   ...
   - uncovered: **0**
   - unmeasured: **1**
   - check: fully + partial + no_exec + uncovered + unmeasured = 2451 == source_module_count
