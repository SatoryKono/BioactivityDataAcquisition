...
| `module_coverage_source_tree_hash_current` | `fail` | `source_tree_sha256` | `1738f36f7ed3e74728ed6940e5e40b9cdfa2da0be755d043e18fe40466a33bec` | `9e72cc41f7594005ddea2861906e415dcd4a81ecfcf6b98bbd4058d6b0c916d0` | `reports/quality/module-coverage-inventory.json` |
...
| `generated_artifact_drift` | `fail` | `stale_artifact_count` | `{'count': 1, 'artifacts': ['module_coverage_inventory']}` | `0` | `reports/quality/*.json` |
