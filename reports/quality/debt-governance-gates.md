...
| `supporting_scripts_untriaged_zero_reference_count` | `fail` | `untriaged_zero_reference_supporting_script_count` | `7` | `0` | `configs/quality/scripts_inventory_manifest.json` |
...
| `remote_main_architecture_debt_baseline` | `pass` | `baseline_artifact_fingerprint` | `0866c4135e74d806007b3e0fc0f056ca531ef0765ee36358961ed98d1225e8e1` | `clean remote-main artifact blobs` | `reports/quality/architecture-debt-remote-main-baseline.json` |
