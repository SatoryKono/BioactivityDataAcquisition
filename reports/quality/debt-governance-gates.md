...
| `module_coverage_source_tree_hash_current` | `pass` | `source_tree_sha256` | `69687c5da3dd5127a3921e416fdbe615dad11ef6206a481abacbecab6f4d0a1e` | `69687c5da3dd5127a3921e416fdbe615dad11ef6206a481abacbecab6f4d0a1e` | `reports/quality/module-coverage-inventory.json` |
| `module_coverage_scorecard_coherence` | `pass` | `module_coverage_scorecard_alignment` | `{'source_module_count': 2463, 'unmeasured_module_count': 74, 'uncovered_module_count': 0, 'source_tree_sha256': '69687c5da3dd5127a3921e416fdbe615dad11ef6206a481abacbecab6f4d0a1e'}` | `{'source_module_count': 2463, 'unmeasured_module_count': 74, 'uncovered_module_count': 0, 'source_tree_sha256': '69687c5da3dd5127a3921e416fdbe615dad11ef6206a481abacbecab6f4d0a1e'}` | `reports/quality/module-coverage-inventory.json + reports/quality/architecture-quality-scorecard.json` |
| `module_coverage_unmeasured_modules` | `fail` | `unmeasured_module_count` | `74` | `0` | `configs/quality/module_coverage_gates.yaml#aggregate_residual_ratchets` |
...
| `remote_main_architecture_debt_baseline` | `pass` | `baseline_artifact_fingerprint` | `80135b169a5ab1a7f280efff6427860ca3ea2a48cbde01ad7564e1f68bc3c548` | `clean remote-main artifact blobs` | `reports/quality/architecture-debt-remote-main-baseline.json` |
