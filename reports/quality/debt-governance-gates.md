...
| `module_coverage_source_tree_hash_current` | `pass` | `source_tree_sha256` | `8e0fb59bcb32f0f67d6e699c7ce1010f932601d997c5bcb40a22388371b9a7ca` | `8e0fb59bcb32f0f67d6e699c7ce1010f932601d997c5bcb40a22388371b9a7ca` | `reports/quality/module-coverage-inventory.json` |
| `module_coverage_unmeasured_modules` | `fail` | `unmeasured_module_count` | `37` | `0` | `configs/quality/module_coverage_gates.yaml#aggregate_residual_ratchets` |
| `module_coverage_uncovered_modules` | `fail` | `uncovered_module_count` | `1611` | `0` | `configs/quality/module_coverage_gates.yaml#aggregate_residual_ratchets` |
...
| `remote_main_architecture_debt_baseline` | `pass` | `remote_main_sha` | `ac4b113ad36795d8201143e8126d4ebcc86cc3cc` | `clean remote-main tree evidence` | `reports/quality/architecture-debt-remote-main-baseline.json` |
