...
| `supporting_scripts_untriaged_zero_reference_count` | `fail` | `untriaged_zero_reference_supporting_script_count` | `3` | `0` | `configs/quality/scripts_inventory_manifest.json` |
