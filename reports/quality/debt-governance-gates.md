...
| `module_coverage_source_tree_hash_current` | `pass` | `source_tree_sha256` | `8078c944b362a0840ca2c1b0817b47f55b1670a0ed765b49b40437febf8028c4` | `8078c944b362a0840ca2c1b0817b47f55b1670a0ed765b49b40437febf8028c4` | `reports/quality/module-coverage-inventory.json` |
| `module_coverage_unmeasured_modules` | `pass` | `unmeasured_module_count` | `36` | `36` | `configs/quality/module_coverage_gates.yaml#aggregate_residual_ratchets` |
| `module_coverage_uncovered_modules` | `pass` | `uncovered_module_count` | `1614` | `1614` | `configs/quality/module_coverage_gates.yaml#aggregate_residual_ratchets` |
...
| `remote_main_architecture_debt_baseline` | `pass` | `remote_main_sha` | `8a55069508869bbe368f1a3a880f6f979387574f` | `clean remote-main tree evidence` | `reports/quality/architecture-debt-remote-main-baseline.json` |
