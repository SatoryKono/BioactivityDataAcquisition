...
| `module_coverage_source_tree_hash_current` | `pass` | `source_tree_sha256` | `c1f8610a7ccafadeb56e5ae983ee655e96b7280c442683c41162e6fb210cf983` | `c1f8610a7ccafadeb56e5ae983ee655e96b7280c442683c41162e6fb210cf983` | `reports/quality/module-coverage-inventory.json` |
| `module_coverage_scorecard_coherence` | `pass` | `module_coverage_scorecard_alignment` | `{'source_module_count': 2465, 'unmeasured_module_count': 0, 'uncovered_module_count': 0, 'source_tree_sha256': 'c1f8610a7ccafadeb56e5ae983ee655e96b7280c442683c41162e6fb210cf983'}` | `{'source_module_count': 2465, 'unmeasured_module_count': 0, 'uncovered_module_count': 0, 'source_tree_sha256': 'c1f8610a7ccafadeb56e5ae983ee655e96b7280c442683c41162e6fb210cf983'}` | `reports/quality/module-coverage-inventory.json + reports/quality/architecture-quality-scorecard.json` |
...
| `observability_release_review_freshness` | `pass` | `generated_at_age_days` | `2` | `21` | `reports/observability/runtime_cardinality_review.json` |
...
| `remote_main_architecture_debt_baseline` | `pass` | `baseline_artifact_fingerprint` | `a9aa6b3b822f1e23802b4e24b1c09745136e432a43624362e33217f772912d98` | `clean remote-main artifact blobs` | `reports/quality/architecture-debt-remote-main-baseline.json` |
| `generated_artifact_drift` | `fail` | `stale_artifact_count` | `{'count': 3, 'artifacts': ['adr_enforcement_matrix', 'config_surface_backlog', 'remote_main_baseline']}` | `0` | `reports/quality/*.json` |
