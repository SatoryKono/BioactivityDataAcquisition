...
- architecture_quality_scorecard_integral_score: `7.06`
...
| `module_coverage_source_tree_hash_current` | `pass` | `source_tree_sha256` | `e8d68d992f993154a43467232f551849ac43616ccb7a24b5a9da33f3f0682241` | `e8d68d992f993154a43467232f551849ac43616ccb7a24b5a9da33f3f0682241` | `reports/quality/module-coverage-inventory.json` |
| `module_coverage_scorecard_coherence` | `pass` | `module_coverage_scorecard_alignment` | `{'source_module_count': 2244, 'unmeasured_module_count': 0, 'uncovered_module_count': 21, 'source_tree_sha256': 'e8d68d992f993154a43467232f551849ac43616ccb7a24b5a9da33f3f0682241'}` | `{'source_module_count': 2244, 'unmeasured_module_count': 0, 'uncovered_module_count': 21, 'source_tree_sha256': 'e8d68d992f993154a43467232f551849ac43616ccb7a24b5a9da33f3f0682241'}` | `reports/quality/module-coverage-inventory.json + reports/quality/architecture-quality-scorecard.json` |
...
| `module_coverage_uncovered_modules` | `fail` | `uncovered_module_count` | `21` | `0` | `configs/quality/module_coverage_gates.yaml#aggregate_residual_ratchets` |
...
| `supporting_scripts_zero_reference_count` | `pass` | `zero_reference_supporting_script_count` | `32` | `32` | `configs/quality/scripts_inventory_manifest.json` |
...
| `remote_main_architecture_debt_baseline` | `pass` | `baseline_artifact_fingerprint` | `e816c04f273f4986a6fd8a818a14a8df8f52328095c2671e97aa073555b686c4` | `clean remote-main artifact blobs` | `reports/quality/architecture-debt-remote-main-baseline.json` |
