...
- architecture_quality_scorecard_integral_score: `9.26`
...
| `module_coverage_source_tree_hash_current` | `fail` | `source_tree_sha256` | `f26dbf3727b4dc007dcdc1b4bb3366af90aad8d7609af3aedaa6d0b43214b9ff` | `8da3018ddd65d2076a27350470aa77ae9df6ae4adfa64eb286601abc6d52069b` | `reports/quality/module-coverage-inventory.json` |
| `module_coverage_scorecard_coherence` | `pass` | `module_coverage_scorecard_alignment` | `{'source_module_count': 2315, 'unmeasured_module_count': 0, 'uncovered_module_count': 0, 'source_tree_sha256': '8da3018ddd65d2076a27350470aa77ae9df6ae4adfa64eb286601abc6d52069b'}` | `{'source_module_count': 2315, 'unmeasured_module_count': 0, 'uncovered_module_count': 0, 'source_tree_sha256': '8da3018ddd65d2076a27350470aa77ae9df6ae4adfa64eb286601abc6d52069b'}` | `reports/quality/module-coverage-inventory.json + reports/quality/architecture-quality-scorecard.json` |
...
| `hotspot_family_baseline_budget_warnings` | `fail` | `budget_warnings` | `2` | `0` | `reports/quality/hotspot-family-baseline.json` |
...
| `supporting_scripts_zero_reference_count` | `pass` | `zero_reference_supporting_script_count` | `5` | `15` | `configs/quality/scripts_inventory_manifest.json` |
...
| `observability_release_review_freshness` | `pass` | `generated_at_age_days` | `10` | `21` | `reports/observability/runtime_cardinality_review.json` |
...
| `generated_artifact_drift` | `fail` | `stale_artifact_count` | `3` | `0` | `reports/quality/*.json` |
