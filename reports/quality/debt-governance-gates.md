...
| `remote_main_architecture_debt_baseline` | `pass` | `remote_main_sha` | `1fb528da02fb15a59d7ac5e35a8e244b6e8a822d` | `clean remote-main tree evidence` | `reports/quality/architecture-debt-remote-main-baseline.json` |
