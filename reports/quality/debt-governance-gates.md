...
| `module_coverage_source_tree_hash_current` | `pass` | `source_tree_sha256` | `437e5deb2c1e40a8e764cf5e0f2bb93e82fc8beaf7c4e796bfc324a3b1dd9756` | `437e5deb2c1e40a8e764cf5e0f2bb93e82fc8beaf7c4e796bfc324a3b1dd9756` | `reports/quality/module-coverage-inventory.json` |
| `module_coverage_unmeasured_modules` | `pass` | `unmeasured_module_count` | `0` | `36` | `configs/quality/module_coverage_gates.yaml#aggregate_residual_ratchets` |
| `module_coverage_uncovered_modules` | `pass` | `uncovered_module_count` | `0` | `1614` | `configs/quality/module_coverage_gates.yaml#aggregate_residual_ratchets` |
