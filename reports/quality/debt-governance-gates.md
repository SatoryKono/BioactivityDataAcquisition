...
| --- | --- | --- | ---: | ---: | --- |
| `debt_scorecard_budget_violations` | `fail` | `violation_count` | `4` | `0` | `configs/quality/debt_scorecard.yaml` |
| `retained_public_entrypoint_burden` | `pass` | `current_count` | `0` | `0` | `configs/quality/debt_scorecard.yaml#compatibility_debt_metrics` |
| `debt_budget_growth_policy` | `fail` | `budget_growth_allowed` | `False` | `False` | `configs/quality/debt_scorecard.yaml` |
...
| `module_coverage_source_tree_hash_current` | `fail` | `source_tree_sha256` | `e6fe1edf30dd402bf82551417730d4583e1c597838ce0c8579a7a525702d67f1` | `ef4d9b216db516f7994715318b50926ef6a4e151be7cb9274727ec9a55d8e384` | `reports/quality/module-coverage-inventory.json` |
| `module_coverage_scorecard_coherence` | `pass` | `module_coverage_scorecard_alignment` | `{'source_module_count': 2237, 'unmeasured_module_count': 0, 'uncovered_module_count': 0, 'source_tree_sha256': 'ef4d9b216db516f7994715318b50926ef6a4e151be7cb9274727ec9a55d8e384'}` | `{'source_module_count': 2237, 'unmeasured_module_count': 0, 'uncovered_module_count': 0, 'source_tree_sha256': 'ef4d9b216db516f7994715318b50926ef6a4e151be7cb9274727ec9a55d8e384'}` | `reports/quality/module-coverage-inventory.json + reports/quality/architecture-quality-scorecard.json` |
...
| `remote_main_architecture_debt_baseline` | `pass` | `baseline_artifact_fingerprint` | `1e168ff05afb1076e17cb6cf7a8d6d2e4488950b4dd1b2417f43e5959ecf7d07` | `clean remote-main artifact blobs` | `reports/quality/architecture-debt-remote-main-baseline.json` |
