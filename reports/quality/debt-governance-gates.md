...
- architecture_quality_scorecard_integral_score: `7.28`
...
| `module_coverage_source_tree_hash_current` | `pass` | `source_tree_sha256` | `954d3e22139afbd00d836d4203b929b9547f59c008c3a8368e39e72ad14119c2` | `954d3e22139afbd00d836d4203b929b9547f59c008c3a8368e39e72ad14119c2` | `reports/quality/module-coverage-inventory.json` |
| `module_coverage_scorecard_coherence` | `pass` | `module_coverage_scorecard_alignment` | `{'source_module_count': 2465, 'unmeasured_module_count': 76, 'uncovered_module_count': 0, 'source_tree_sha256': '954d3e22139afbd00d836d4203b929b9547f59c008c3a8368e39e72ad14119c2'}` | `{'source_module_count': 2465, 'unmeasured_module_count': 76, 'uncovered_module_count': 0, 'source_tree_sha256': '954d3e22139afbd00d836d4203b929b9547f59c008c3a8368e39e72ad14119c2'}` | `reports/quality/module-coverage-inventory.json + reports/quality/architecture-quality-scorecard.json` |
| `module_coverage_unmeasured_modules` | `fail` | `unmeasured_module_count` | `76` | `0` | `configs/quality/module_coverage_gates.yaml#aggregate_residual_ratchets` |
...
| `supporting_scripts_zero_reference_count` | `pass` | `zero_reference_supporting_script_count` | `0` | `15` | `configs/quality/scripts_inventory_manifest.json` |
...
| `remote_main_architecture_debt_baseline` | `pass` | `baseline_artifact_fingerprint` | `2d7a69883cd8953de229bc9b98fa9cf9e2392008f557a56c4fbeeca6ee9efda0` | `clean remote-main artifact blobs` | `reports/quality/architecture-debt-remote-main-baseline.json` |
