...
| --- | ---: |
| `src/bioetl/infrastructure/adapters` | 42 |
...
- … truncated 30 additional clusters for brevity
...
| --- | ---: | --- | ---: | --- |
| `src/bioetl/infrastructure/adapters` | 42 | `export_facade_or_package_barrel` | 1.00 | no |
