...
| --- | ---: |
| `src/bioetl/interfaces/cli` | 1 |
| `src/bioetl/infrastructure/adapters` | 58 |
| `src/bioetl/application/pipelines` | 16 |
...
| --- | --- |
| `src/bioetl/interfaces/cli/commands/domains/shared/__init__.py:1` | `bioetl.interfaces.cli.commands.domains.health.server_integration`[132:137], `bioetl.interfaces.cli.commands.vacuum`[58:63] |
...
- … truncated 46 additional clusters for brevity
...
| Actionability category | Duplicate clusters |
| --- | ---: |
| `pipeline_transformer_contract_pattern` | 16 |
...
| --- | ---: | --- | ---: | --- |
| `src/bioetl/interfaces/cli` | 1 | `cli_command_contract_shell` | 1.00 | yes |
| `src/bioetl/infrastructure/adapters` | 58 | `export_facade_or_package_barrel` | 0.81 | no |
| `src/bioetl/application/pipelines` | 16 | `pipeline_transformer_contract_pattern` | 0.00 | no |
