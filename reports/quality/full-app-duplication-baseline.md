...
| --- | ---: |
| `src/bioetl/infrastructure/adapters` | 44 |
| `src/bioetl/application/pipelines` | 5 |
| `src/bioetl/composition/bootstrap` | 0 |
| `src/bioetl/interfaces/cli` | 0 |

## src/bioetl/infrastructure/adapters

- duplicate clusters: 44

| Actionability category | Duplicate clusters |
| --- | ---: |
| `export_facade_or_package_barrel` | 43 |
| `adapter_resilience_or_contract_template` | 1 |
...
| `src/bioetl/infrastructure/adapters/uniprot/__init__.py:1` | `bioetl.infrastructure.adapters.decorators.circuit_breaker`[170:178], `bioetl.infrastructure.adapters.decorators.retry`[150:159] |
...
| `src/bioetl/infrastructure/adapters/uniprot/__init__.py:1` | `bioetl.infrastructure.adapters.filterable_mixin`[173:182], `bioetl.infrastructure.adapters.uniprot.client`[194:201] |
...
| `src/bioetl/infrastructure/adapters/uniprot/__init__.py:1` | `bioetl.infrastructure.adapters.decorators._fetch_request_builder`[22:29], `bioetl.infrastructure.adapters.decorators.circuit_breaker`[171:178] |

- … truncated 32 additional clusters for brevity
...
| Actionability category | Duplicate clusters |
| --- | ---: |
| `pipeline_transformer_contract_pattern` | 5 |
...
| `bioetl.application.pipelines.common.publication_transformer_context` <-> `bioetl.application.pipelines.uniprot.idmapping_transformer` | 1 |
| `bioetl.application.pipelines.pubmed._block_definitions_analytics` <-> `bioetl.application.pipelines.pubmed.transformer` | 1 |
| `bioetl.application.pipelines.semanticscholar.__init__` <-> `bioetl.application.pipelines.semanticscholar.extractors` | 1 |

| Cluster path | Compared modules |
| --- | --- |
| `src/bioetl/application/pipelines/uniprot/extractors/__init__.py:1` | `bioetl.application.pipelines.common.publication_transformer_context`[176:187], `bioetl.application.pipelines.uniprot.idmapping_transformer`[96:127] |
...
| --- | ---: | --- | ---: | --- |
| `src/bioetl/infrastructure/adapters` | 44 | `export_facade_or_package_barrel` | 0.98 | no |
| `src/bioetl/application/pipelines` | 5 | `pipeline_transformer_contract_pattern` | 0.00 | no |
