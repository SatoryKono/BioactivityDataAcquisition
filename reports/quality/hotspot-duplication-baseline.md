...
- mode: fail-fast
- targets: 5
- total_duplicate_clusters: 10
- max_duplicate_clusters: 0
- previous_snapshot_date: 2026-07-04
- total_duplicate_cluster_delta_vs_previous: +10
...
| --- | ---: |
| `export_facade_or_package_barrel` | 2 |
...
| Cluster path | Compared modules |
| --- | --- |
| `src\bioetl\composition\bootstrap\runtime\_runner_assembly_support.py:1` | `bioetl.composition.bootstrap.runtime.observability_bundle`[212:219], `bioetl.composition.bootstrap.runtime.pipeline_bootstrap_phases`[91:98] |
...
| Cluster path | Compared modules |
| --- | --- |
| `src\bioetl\composition\runtime_builders\_snapshot_mapping_support.py:1` | `bioetl.composition.runtime_builders._run_manifest_data_roots`[46:65], `bioetl.composition.runtime_builders._run_manifest_refs`[20:37] |
| `src\bioetl\composition\runtime_builders\_snapshot_mapping_support.py:1` | `bioetl.composition.runtime_builders._run_manifest_control_plane_paths`[21:39], `bioetl.composition.runtime_builders._run_manifest_data_roots`[86:104] |
| `src\bioetl\composition\runtime_builders\_snapshot_mapping_support.py:1` | `bioetl.composition.runtime_builders._run_manifest_control_plane_paths`[37:51], `bioetl.composition.runtime_builders._run_manifest_data_roots`[112:131] |
...
- previous snapshot: `2026-07-04`
- total duplicate cluster delta: +10

| Target | Current | Previous | Delta |
| --- | ---: | ---: | ---: |
| `src/bioetl/application/core` | 2 | 0 | +2 |
| `src/bioetl/composition/bootstrap/runtime` | 1 | 0 | +1 |
| `src/bioetl/composition/factories/pipeline` | 1 | 0 | +1 |
| `src/bioetl/application/services/control_plane` | 1 | 0 | +1 |
| `src/bioetl/composition/runtime_builders` | 5 | 0 | +5 |
...
| `src/bioetl/application/core` | 2 | `export_facade_or_package_barrel` | 1.00 | yes |
