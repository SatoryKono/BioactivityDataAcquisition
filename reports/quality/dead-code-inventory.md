...
- repo_wide_classified_zero_import_candidate_count: 4
- repo_wide_untriaged_zero_import_candidate_count: 0
- repo_wide_owner_test_anchored_candidate_count: 4
...
| `bioetl.composition.contracts.runtime` | `retain_canonical_owner_module` | `src/bioetl/composition/contracts/runtime.py` |
...
| `repo_wide_zero_import` | `src/bioetl/composition/contracts/runtime.py` | `canonical_owner_contract` | `tests/architecture/test_tech_debt_issues_6032_6034_6037_closeout.py` |
