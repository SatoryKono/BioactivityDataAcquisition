...
| `bioetl.domain.ports.source_config` | `retain_canonical_owner_module` | `src/bioetl/domain/ports/source_config.py` |
...
| `repo_wide_zero_import` | `src/bioetl/domain/ports/source_config.py` | `canonical_owner_contract` | `tests/architecture/test_domain_public_api.py`, `tests/architecture/test_domain_ports_no_filesystem_or_engine_types.py`, `tests/architecture/test_port_contracts.py` |
