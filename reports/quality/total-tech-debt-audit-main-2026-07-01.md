...
|| Test governance | 21,706 test functions, 1,906 test files, 2 duplicate test names, 0 markerless test functions, 0 compatibility test files. | `reports/quality/test-governance-current.json` |
