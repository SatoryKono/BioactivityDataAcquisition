...
| `src/bioetl/domain/composite/config.py` | 0 | 42 |
...
| `src/bioetl/domain/composite/config.py` | `bioetl.domain.composite` | `stable_public_api_with_reviewed_first_party_usage` | `external-facing` | no | yes | 0 | 42 |
