...
| --- | ---: | ---: | --- | --- | --- |
| `src/bioetl/composition/entrypoints.py` | 10 | 0 | register, registered_ports, resolve (drift: load_pipeline_config, register, registered_ports, resolve, start_metrics_server) | none | none |
