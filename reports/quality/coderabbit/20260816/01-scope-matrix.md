...
| `S17-docs-00-project-02` | E | 74 | `true` | docs/00-project |
| `S17-docs-decisions` | E | 60 | `true` | docs/02-architecture/decisions |
| `S18-dashboard-docs` | E | 86 | `true` | dashboard/grafana documentation |
...
| `S12-tests-architecture-02` | F | 200 | `true` | tests/architecture |
| `S13-tests-unit-domain-01` | F | 300 | `true` | tests/unit/domain |
| `S13-tests-unit-domain-02` | F | 43 | `true` | tests/unit/domain |
| `S14-tests-unit-application-01` | F | 300 | `true` | tests/unit/application |
| `S14-tests-unit-application-02` | F | 96 | `true` | tests/unit/application |
| `S14b-tests-unit-infrastructure-01` | F | 300 | `true` | tests/unit/infrastructure |
| `S14b-tests-unit-infrastructure-02` | F | 83 | `true` | tests/unit/infrastructure |
| `S15-tests-integration` | F | 228 | `true` | tests/integration |
| `S15b-tests-unit-scripts` | F | 134 | `true` | tests/unit/scripts |
| `S15c-tests-residual-01` | F | 300 | `true` | tests |
| `S15c-tests-residual-02` | F | 300 | `true` | tests |
| `S15c-tests-residual-03` | F | 300 | `true` | tests |
| `S15c-tests-residual-04` | F | 176 | `true` | tests |
| `S-R-.github-ISSUES-01` | R | 300 | `true` | residual catch-all: .github/ISSUES |
| `S-R-.github-ISSUES-02` | R | 34 | `true` | residual catch-all: .github/ISSUES |
...
| `S-R-catchall-02` | R | 95 | `true` | residual catch-all: .github/ISSUE_TEMPLATE, .github/PULL_REQUEST_HYGIENE.md, .github/SECURITY.md, .github/copilot-instructions.md, .github/dependabot.yml, .github/instructions, .github/labeler.yml, .github/pull_request_template.md, .github/root-allowlist.txt, .github/vcr-noext-allowlist.txt, .jules/bolt.md, .junie/agents, .junie/guidelines.md, .junie/plans, .junie/skills, .zed/README.md, .zed/USER_SETTINGS_NO_AGENT_MCP.overlay.json, .zed/keymap.json, .zed/mcp.json, .zed/settings.json, .zed/snippets, .zed/tasks.json, data/README.md, data/input, docs/01-requirements |
| `S-R-catchall-03` | R | 60 | `true` | residual catch-all: docs/03-data-model, docs/03-guides |
| `S-R-catchall-04` | R | 296 | `true` | residual catch-all: docs/05-engineering, docs/05-operations, docs/99-archive, docs/DOCKER_QUICKSTART.md, docs/DOCKER_SETUP.md, docs/INDEX.md, docs/devin-optimization-analysis.md, docs/doc.json, docs/docs-folder-analysis.md, docs/filters, docs/plans, docs/reports, docs/reports-migration-analysis.md, docs/security, reports/.bioetl-report-root, reports/README.md, reports/ai, reports/architecture |
| `S-R-catchall-05` | R | 118 | `true` | residual catch-all: reports/audit, reports/audit-runs, reports/coverage, reports/docs-evidence, reports/grafana, reports/logs, reports/observability, reports/plans |
...
| `S-R-reports-quality-03` | R | 30 | `true` | residual catch-all: reports/quality |
| `S-R-scripts-ai` | R | 179 | `true` | scripts/ai |
| `S-R-scripts-diagrams` | R | 49 | `true` | scripts/diagrams |
| `S-R-scripts-docs` | R | 50 | `true` | scripts/docs |
| `S-R-scripts-engineering` | R | 233 | `true` | scripts/engineering |
| `S-R-scripts-memory` | R | 6 | `true` | scripts/memory |
| `S-R-scripts-ops` | R | 142 | `true` | scripts/ops |
...
| `S-R-src-memory-02` | R | 104 | `true` | residual catch-all: src/memory |
