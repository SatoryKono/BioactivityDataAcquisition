...
streams are closed on `origin/main` as of 2026-08-18.
...
| `config-s16b-fail-closed` | #8942 | 10 | P2 | bounded FK reconcile, `[^\\s]` regex, stray publication_year filters | closed |
| `app-core-8890-split` | #8952 | 44 | P1 | S02 lock/heartbeat, batch write, filter fetch | closed |
| `control-plane-8890-split` | #8953 | 44 | P1 | S03 replay/manifest/profile | closed |
| `app-services-8890-split` | #8954 | 56 | P1 | S04 checkpoint/DQ/ops | closed |
| `adapters-8890-split` | #8955 | 6 | P2 | OpenAlex/PubMed fallback, PubChem query | closed |
| `http-8890-split` | #8956 | 30 | P2 | health routing / report-root | closed |
| `cli-8890-split` | #8957 | 15 | P2 | leftover CLI fail-closed | closed |
| `domain-8890-split` | #8958 | 7 | P2 | hashing / workflow freeze | closed |
