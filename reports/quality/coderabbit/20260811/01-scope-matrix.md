...
| `S01-domain-composite` | A | 29 | `true` | src/bioetl/domain/composite |
...
| `S02-app-core` | A | 196 | `true` | src/bioetl/application/core |
| `S03-app-control-plane` | A | 140 | `true` | src/bioetl/application/services/control_plane |
| `S04-app-services-other` | A | 150 | `true` | src/bioetl/application/services |
...
| `S07-infra-storage` | B | 145 | `true` | src/bioetl/infrastructure/storage |
...
| `S17-docs-00-project-02` | E | 27 | `true` | docs/00-project |
| `S17-docs-decisions` | E | 60 | `true` | docs/02-architecture/decisions |
| `S18-dashboard-docs` | E | 83 | `true` | dashboard/grafana documentation |
...
| `S12-tests-architecture-02` | F | 198 | `true` | tests/architecture |
| `S13-tests-unit-domain-01` | F | 300 | `true` | tests/unit/domain |
| `S13-tests-unit-domain-02` | F | 38 | `true` | tests/unit/domain |
| `S14-tests-unit-application-01` | F | 300 | `true` | tests/unit/application |
| `S14-tests-unit-application-02` | F | 92 | `true` | tests/unit/application |
| `S14b-tests-unit-infrastructure-01` | F | 300 | `true` | tests/unit/infrastructure |
| `S14b-tests-unit-infrastructure-02` | F | 79 | `true` | tests/unit/infrastructure |
| `S15-tests-integration` | F | 223 | `true` | tests/integration |
| `S15b-tests-unit-scripts` | F | 130 | `true` | tests/unit/scripts |
...
| `S-R-catchall-04` | R | 297 | `true` | residual catch-all: docs/05-engineering, docs/05-operations, docs/99-archive, docs/DOCKER_QUICKSTART.md, docs/DOCKER_SETUP.md, docs/INDEX.md, docs/devin-optimization-analysis.md, docs/doc.json, docs/docs-folder-analysis.md, docs/filters, docs/plans, docs/reports, docs/reports-migration-analysis.md, docs/security, reports/.bioetl-report-root, reports/ai, reports/architecture, reports/coverage, reports/docs-evidence |
...
| `S-R-docs-02-architecture-05` | R | 93 | `true` | residual catch-all: docs/02-architecture |
| `S-R-docs-04-reference-01` | R | 300 | `true` | residual catch-all: docs/04-reference |
| `S-R-docs-04-reference-02` | R | 41 | `true` | residual catch-all: docs/04-reference |
| `S-R-reports-quality-01` | R | 300 | `true` | residual catch-all: reports/quality |
| `S-R-reports-quality-02` | R | 42 | `true` | residual catch-all: reports/quality |
| `S-R-scripts-ai` | R | 177 | `true` | scripts/ai |
| `S-R-scripts-diagrams` | R | 49 | `true` | scripts/diagrams |
| `S-R-scripts-docs` | R | 46 | `true` | scripts/docs |
| `S-R-scripts-engineering` | R | 225 | `true` | scripts/engineering |
| `S-R-scripts-memory` | R | 6 | `true` | scripts/memory |
| `S-R-scripts-ops` | R | 136 | `true` | scripts/ops |
| `S-R-scripts-residual` | R | 27 | `true` | scripts |
| `S-R-scripts-schema` | R | 25 | `true` | scripts/schema |
| `S-R-src-memory-01` | R | 300 | `true` | residual catch-all: src/memory |
| `S-R-src-memory-02` | R | 164 | `true` | residual catch-all: src/memory |
