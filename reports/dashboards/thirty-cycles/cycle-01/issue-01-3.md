# Cycle 1 Issue 3: Проверить DASH-TIME-001 — убедиться что нет запрещённых date
- Dashboard: bioetl-overview-v2.json
- Theme: Обзор — обогащение описаний SELECTED RUN
- Proposal: Проверить DASH-TIME-001 — убедиться что нет запрещённых datetime юнитов
- Priority: P1
- Plan:
...
- Status: CLOSED
- ClosedAt: 2026-09-26T14:35:31.013138+00:00
