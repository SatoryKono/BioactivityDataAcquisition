# Cycle 3 Issue 1: Сузить колонки Evidence таблицы, добавить сортировку по seve
- Dashboard: bioetl-provider-health-v2.json
- Theme: Provider Health — evidence таблица
- Proposal: Сузить колонки Evidence таблицы, добавить сортировку по severity
- Priority: P0
- Plan:
...
- Status: CLOSED
- ClosedAt: 2026-09-26T14:36:27.338270+00:00
