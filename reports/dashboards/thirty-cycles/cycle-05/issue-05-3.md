# Cycle 5 Issue 3: Добавить column widths для run_id, pipeline, status
- Dashboard: bioetl-run-explorer-v1.json
- Theme: Run Explorer — таблица 10 строк
- Proposal: Добавить column widths для run_id, pipeline, status
- Priority: P1
- Plan:
...
- Status: CLOSED
- ClosedAt: 2026-09-26T14:37:08.866470+00:00
