...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/test_base_pipeline.py:50`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_data_quality_service.py:36`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_data_quality_service.py:48`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_data_quality_service.py:58`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_data_quality_service.py:64`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_data_quality_service.py:80`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_data_quality_service.py:97`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_data_quality_service.py:729`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_data_quality_service.py:797`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_data_quality_service.py:811`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_data_quality_service.py:829`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_data_quality_service.py:848`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_data_quality_service.py:854`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_pipeline_runner_service.py:533`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_pipeline_runner_service.py:540`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_pipeline_runner_service.py:547`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_checkpoint_compatibility_service_v2.py:624`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_checkpoint_compatibility_service_v2.py:650`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_checkpoint_compatibility_service_v2.py:674`
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_effective_config_service.py:290`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  pipeline_config: dict[str, Any] = {
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_effective_config_service.py:365`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  pipeline_config: dict[str, Any] = {
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_effective_config_service.py:401`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_effective_config_service.py:556`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/services/test_effective_config_service.py:588`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  base_config: dict[str, Any] = {
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_fsm_pipeline_scenarios.py:66`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_fsm_pipeline_scenarios.py:69`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_fsm_pipeline_scenarios.py:72`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_fsm_pipeline_scenarios.py:75`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_fsm_pipeline_scenarios.py:108`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  owner_id: Any,
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_fsm_pipeline_scenarios.py:126`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  owner_id: Any,
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_fsm_pipeline_scenarios.py:140`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  owner_id: Any,
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_fsm_pipeline_scenarios.py:334`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  enrichers: Any,
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_fsm_pipeline_scenarios.py:363`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  enrichers: Any,
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_fsm_pipeline_scenarios.py:367`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_fsm_pipeline_scenarios.py:368`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_fsm_pipeline_scenarios.py:458`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_fsm_pipeline_scenarios.py:102`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_fsm_pipeline_scenarios.py:336`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_fsm_pipeline_scenarios.py:264`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_fsm_pipeline_scenarios.py:61`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_runner_required_flag.py:441`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_runner_required_flag.py:454`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_runner_required_flag.py:520`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_runner_required_flag.py:528`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_runner.py:670`
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_fsm_helper.py:55`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_runner_enrichment_fsm.py:820`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_runner_enrichment_fsm.py:863`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:318`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:334`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:353`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:369`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:388`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:616`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:622`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:628`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:638`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:654`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:673`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:694`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:715`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1039`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1046`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1051`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1056`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1066`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1071`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1078`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1088`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1093`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1100`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1110`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1117`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1124`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1133`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1140`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1170`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1178`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1197`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1214`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1229`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1244`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1258`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1273`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1288`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1303`
- **Description**: Public function 'test_composite_key' lacks return type annotation.
- **Code**:
  ```python
  def test_composite_key(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1319`
- **Description**: Public function 'test_empty_dataframe' lacks return type annotation.
- **Code**:
  ```python
  def test_empty_dataframe(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1329`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1344`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1459`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:1487`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/test_merger.py:495`
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_merge_stage_mixin.py:96`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_merge_stage_mixin.py:99`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_merge_stage_mixin.py:102`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_stage_mixin.py:126`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_stage_mixin.py:118`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  async def _save_checkpoint_safe(self, state: Any, operation: str) -> bool:
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_stage_mixin.py:75`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_stage_mixin.py:36`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_stage_enrichment_mixin.py:113`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  ) -> Any:
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_stage_enrichment_mixin.py:123`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  ) -> Any:
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_stage_enrichment_mixin.py:95`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  def _call_get_enrichers_to_run(self, state: Any) -> list[Any]:
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_stage_enrichment_mixin.py:90`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_stage_enrichment_mixin.py:98`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  def _call_check_required_enrichers(self, results: Any) -> None:
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_stage_enrichment_mixin.py:102`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_stage_enrichment_mixin.py:107`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  state: Any,
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_stage_enrichment_mixin.py:119`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  state: Any,
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_stage_enrichment_mixin.py:70`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  config: Any | None = None,
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_stage_support_mixin.py:94`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_stage_support_mixin.py:97`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_stage_support_mixin.py:89`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  state: Any,
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_stage_support_mixin.py:100`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/composite/runner_pkg/test_runner_stage_support_mixin.py:60`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_span_helpers.py:38`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_span_helpers.py:50`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_span_helpers.py:61`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_span_helpers.py:71`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_span_helpers.py:83`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_span_helpers.py:92`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_span_helpers.py:101`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:117`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:139`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:166`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:198`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:231`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:274`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:299`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:510`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:1052`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:1087`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:371`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:393`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:433`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:469`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:487`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:553`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:579`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:608`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:632`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:660`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:690`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:742`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:772`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:797`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:821`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:855`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:916`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:934`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:967`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/observability/test_observer.py:1004`
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_otel_spans.py:274`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_otel_spans.py:519`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_otel_spans.py:615`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_otel_spans.py:631`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_record_processor.py:170`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_record_processor.py:180`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_record_processor.py:191`
- **Description**: Public function 'mock_gold_validator' lacks return type annotation.
- **Code**:
  ```python
  def mock_gold_validator(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_record_processor.py:236`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_record_processor.py:173`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_record_processor.py:183`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_record_processor.py:270`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_record_processor.py:274`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_record_processor.py:683`
- **Description**: Public function 'mock_tracer' lacks return type annotation.
- **Code**:
  ```python
  def mock_tracer(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_record_processor.py:699`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_record_processor.py:364`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_record_processor.py:371`
- **Description**: Public function 'filter_gold' lacks return type annotation.
- **Code**:
  ```python
  def filter_gold(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_record_processor.py:428`
- **Description**: Public function 'build_silver_record' lacks return type annotation.
- **Code**:
  ```python
  def build_silver_record(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_checkpoint_recovery_service.py:491`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_checkpoint_recovery_service.py:496`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_checkpoint_recovery_service.py:501`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_checkpoint_recovery_service.py:506`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_checkpoint_recovery_service.py:511`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_streaming_batch.py:90`
- **Description**: Public function 'transform_gold' lacks return type annotation.
- **Code**:
  ```python
  def transform_gold(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_streaming_batch.py:468`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_streaming_batch.py:538`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_streaming_batch.py:558`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_streaming_batch.py:580`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_streaming_batch.py:583`
...
- **Description**: Public function 'test_is_under_pressure_high_usage' lacks return type annotation.
- **Code**:
  ```python
  def test_is_under_pressure_high_usage(...):
  ```
- **Fix**: Add -> Type:
- **Verification**: `mypy --strict`
...
- **Description**: Public function 'test_is_under_pressure_low_usage' lacks return type annotation.
- **Code**:
  ```python
  def test_is_under_pressure_low_usage(...):
  ```
- **Fix**: Add -> Type:
- **Verification**: `mypy --strict`
...
- **Description**: Public function 'test_is_under_pressure_boundary' lacks return type annotation.
- **Code**:
  ```python
  def test_is_under_pressure_boundary(...):
  ```
- **Fix**: Add -> Type:
- **Verification**: `mypy --strict`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_health_aggregator.py:60`
- **Description**: Public function 'mock_data_source' lacks return type annotation.
- **Code**:
  ```python
  def mock_data_source(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_health_aggregator.py:75`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_health_aggregator.py:86`
- **Description**: Public function 'mock_services' lacks return type annotation.
- **Code**:
  ```python
  def mock_services(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_health_aggregator.py:102`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_health_aggregator.py:111`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_health_aggregator.py:125`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_health_aggregator.py:142`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_health_aggregator.py:152`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_health_aggregator.py:163`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_health_aggregator.py:173`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_health_aggregator.py:183`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_health_aggregator.py:193`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_health_aggregator.py:203`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_health_aggregator.py:209`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_health_aggregator.py:223`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_health_aggregator.py:403`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_health_aggregator.py:414`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_health_aggregator.py:425`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_health_aggregator.py:438`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_health_aggregator.py:452`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_processing_service.py:50`
- **Description**: Public function 'mock_context' lacks return type annotation.
- **Code**:
  ```python
  def mock_context(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_processing_service.py:60`
- **Description**: Public function 'mock_services' lacks return type annotation.
- **Code**:
  ```python
  def mock_services(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_processing_service.py:74`
- **Description**: Public function 'mock_config' lacks return type annotation.
- **Code**:
  ```python
  def mock_config(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_processing_service.py:81`
- **Description**: Public function 'mock_logger' lacks return type annotation.
- **Code**:
  ```python
  def mock_logger(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_processing_service.py:86`
- **Description**: Public function 'mock_batch_metrics' lacks return type annotation.
- **Code**:
  ```python
  def mock_batch_metrics(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_processing_service.py:94`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_processing_service.py:106`
- **Description**: Public function 'mock_writer' lacks return type annotation.
- **Code**:
  ```python
  def mock_writer(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_processing_service.py:116`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_processing_service.py:127`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_processing_service.py:181`
- **Description**: Public function 'test_is_frozen' lacks return type annotation.
- **Code**:
  ```python
  def test_is_frozen(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_processing_service.py:195`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_processing_service.py:744`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_processing_service.py:774`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_processing_service.py:805`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_processing_service.py:838`
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_runner_execution_flow.py:212`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_runner_execution_flow.py:286`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_runner_execution_flow.py:305`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  cast(Any, host),
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_runner_execution_flow.py:341`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  await runner_execution_flow.run_execution_cycle(cast(Any, host))
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_executor_memory.py:494`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_transformer.py:93`
- **Description**: Public function 'filter_gold' lacks return type annotation.
- **Code**:
  ```python
  def filter_gold(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_transformer.py:103`
- **Description**: Public function 'transform_gold' lacks return type annotation.
- **Code**:
  ```python
  def transform_gold(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_transformer.py:334`
- **Description**: Public function 'build_silver_record' lacks return type annotation.
- **Code**:
  ```python
  def build_silver_record(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_transformer.py:344`
- **Description**: Public function 'filter_gold' lacks return type annotation.
- **Code**:
  ```python
  def filter_gold(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_transformer.py:407`
- **Description**: Public function 'build_silver_record' lacks return type annotation.
- **Code**:
  ```python
  def build_silver_record(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_batch_transformer.py:415`
- **Description**: Public function 'filter_gold' lacks return type annotation.
- **Code**:
  ```python
  def filter_gold(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_runner.py:264`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_runner.py:270`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_runner.py:357`
- **Description**: Public function 'test_initialization' lacks return type annotation.
- **Code**:
  ```python
  def test_initialization(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_runner.py:402`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_runner.py:443`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_runner.py:1007`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_run_id_propagation.py:157`
- **Description**: Public function 'gold_filter' lacks return type annotation.
- **Code**:
  ```python
  def gold_filter(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_run_id_propagation.py:221`
- **Description**: Public function 'gold_filter' lacks return type annotation.
- **Code**:
  ```python
  def gold_filter(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_run_id_propagation.py:292`
- **Description**: Public function 'gold_filter' lacks return type annotation.
- **Code**:
  ```python
  def gold_filter(...):
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_protocols.py:92`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_protocols.py:372`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  ) -> dict[str, Any]:
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_protocols.py:59`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  ) -> dict[str, Any] | None:
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_protocols.py:113`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  ) -> dict[str, Any]:
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_protocols.py:58`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_protocols.py:345`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_protocols.py:371`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_protocols.py:41`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_protocols.py:45`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_protocols.py:81`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_protocols.py:112`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  self, context: PipelineContext, record: dict[str, Any]
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_postrun_service.py:187`
- **Description**: Public function 'test_initialization' lacks return type annotation.
- **Code**:
  ```python
  def test_initialization(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_postrun_service.py:482`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_postrun_service.py:568`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_postrun_service.py:588`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_postrun_service.py:618`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_filtered_data_source.py:166`
- **Description**: Public function 'test_initialization' lacks return type annotation.
- **Code**:
  ```python
  def test_initialization(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_filtered_data_source.py:177`
- **Description**: Public function 'test_provider_name_from_wrapped' lacks return type annotation.
- **Code**:
  ```python
  def test_provider_name_from_wrapped(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_filtered_data_source.py:566`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_filtered_data_source.py:580`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_filtered_data_source.py:863`
- **Description**: Public function 'test_get_source_metadata_delegates' lacks return type annotation.
- **Code**:
  ```python
  def test_get_source_metadata_delegates(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_filtered_data_source.py:878`
- **Description**: Public function 'test_get_source_metadata_returns_none_when_not_supported' lacks return type annotation.
- **Code**:
  ```python
  def test_get_source_metadata_returns_none_when_not_supported(...):
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_filtered_data_source.py:1050`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_filtered_data_source.py:1060`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_filtered_data_source.py:1074`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_checkpoint_manager.py:45`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/unit/application/core/test_checkpoint_manager.py:61`
...
### ARCH-008: Single Source of Imports
- **File**: `tests/unit/application/core/test_otel_spans.py:29`
- **Description**: Ports must be imported from bioetl.domain.ports facade.

### ARCH-008: Single Source of Imports
- **File**: `tests/unit/application/core/test_record_processor.py:21`
- **Description**: Ports must be imported from bioetl.domain.ports facade.

### ARCH-008: Single Source of Imports
- **File**: `tests/unit/application/core/test_record_processor_metrics.py:17`
- **Description**: Ports must be imported from bioetl.domain.ports facade.

### ARCH-008: Single Source of Imports
- **File**: `tests/unit/application/core/test_health_aggregator.py:18`
- **Description**: Ports must be imported from bioetl.domain.ports facade.
...
### ARCH-008: Single Source of Imports
- **File**: `tests/unit/application/core/test_runner.py:29`
- **Description**: Ports must be imported from bioetl.domain.ports facade.

### ARCH-008: Single Source of Imports
- **File**: `tests/unit/application/core/test_run_id_propagation.py:24`
- **Description**: Ports must be imported from bioetl.domain.ports facade.
