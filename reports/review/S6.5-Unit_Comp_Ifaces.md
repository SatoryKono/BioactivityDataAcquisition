...
|----------|--------|------|------|-----|-----|-------|
| Types | 752 | 0 | 752 | 0 | 0 | 0.0 |
| Architecture | 22 | 0 | 0 | 22 | 0 | 0.0 |
...
- **Severity**: CRITICAL
- **File**: `tests/unit/interfaces/cli/commands/test_run_manifest_commands.py:43`
...
- **Rule**: AP-001 (DI Violation - Hard-coded Constructor)
- **Severity**: CRITICAL
- **File**: `tests/unit/interfaces/cli/commands/test_run_manifest_commands.py:64`
