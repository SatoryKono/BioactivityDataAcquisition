...
- **Rule**: AP-001 (DI Violation - Hard-coded Constructor)
- **Severity**: CRITICAL
- **File**: `tests/unit/composition/bootstrap/runtime/test_composite_control_plane_builder.py:40`
- **Description**: Hard-coded dependency instantiation: SimpleNamespace()
- **Code**:
  ```python
...
- **Rule**: AP-001 (DI Violation - Hard-coded Constructor)
- **Severity**: CRITICAL
- **File**: `tests/unit/composition/bootstrap/runtime/test_composite_control_plane_builder.py:43`
- **Description**: Hard-coded dependency instantiation: SimpleNamespace()
- **Code**:
  ```python
  self.merge = SimpleNamespace(output_silver_path='data/output/silver/composite/publication', output_gold_path='data/output/gold/composite/publication')
  ```
- **Fix**: Inject dependency via constructor.
- **Verification**: `Check DI configuration.`
...
- **Rule**: AP-001 (DI Violation - Hard-coded Constructor)
- **Severity**: CRITICAL
- **File**: `tests/unit/interfaces/cli/commands/test_run_manifest_commands.py:31`
...
- **Rule**: AP-001 (DI Violation - Hard-coded Constructor)
- **Severity**: CRITICAL
- **File**: `tests/unit/interfaces/cli/commands/test_run_manifest_commands.py:50`
...
- **Code**:
  ```python
  self._fragment = LineageGraphFragment(fragment_id='silver:fragment-1', nodes=(self._dataset_node, self._upstream_node), created_at=datetime.now(UTC))
  ```
- **Fix**: Inject dependency via constructor.
- **Verification**: `Check DI configuration.`
