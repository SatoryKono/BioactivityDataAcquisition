...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/architecture/test_tracing_enforcement.py:305`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/architecture/test_tracing_enforcement.py:336`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/architecture/test_tracing_enforcement.py:359`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/architecture/test_tracing_enforcement.py:407`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/architecture/test_tracing_enforcement.py:432`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/architecture/test_tracing_enforcement.py:445`
...
- **Rule**: TYPE-001 (Public Function Annotations)
- **Severity**: HIGH
- **File**: `tests/architecture/test_tracing_enforcement.py:461`
...
- **Rule**: TYPE-002 (Any Usage)
- **Severity**: HIGH
- **File**: `tests/architecture/test_deterministic_sort_policy_coverage.py:55`
- **Description**: Usage of Any without comment justification.
- **Code**:
  ```python
  def _load_yaml(path: Path) -> dict[str, Any]:
...
### ARCH-008: Single Source of Imports
- **File**: `tests/architecture/test_tracing_enforcement.py:361`
- **Description**: Ports must be imported from bioetl.domain.ports facade.
