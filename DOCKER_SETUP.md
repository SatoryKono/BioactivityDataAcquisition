...
| **Neo4j Browser** | http://localhost:7474 | neo4j / [REDACTED] |
| **Neo4j Bolt** | bolt://localhost:7687 | neo4j / [REDACTED] |
...
```bash
docker compose -f docker-compose.standalone.yml exec neo4j cypher-shell -u neo4j -p [REDACTED]
```
