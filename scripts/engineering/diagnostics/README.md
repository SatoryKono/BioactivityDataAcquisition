...
|---------|------|---------|
| `cleanup` | Disk space issues or stale caches; cleans `.pyc`, `__pycache__`, build artifacts, temp files. Use `--apply` to execute (dry-run by default), `--purge-logs` for full cleanup | Manual, periodic maintenance |
