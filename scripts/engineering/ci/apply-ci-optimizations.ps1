...
Usage examples:
  .\apply-ci-optimizations.ps1               # dry run, produce report and suggested changes written locally
  .\apply-ci-optimizations.ps1 -Apply        # apply changes and commit on a new branch locally
  .\apply-ci-optimizations.ps1 -Apply -Push  # apply, commit and push branch to origin (requires credentials)
