...
Canonical owner for `python -m scripts.engineering.qa check-exemptions`.
Implementation previously lived in the archived agents script
`docs/99-archive/agents-scripts-2026-09/architecture-techdebt-automation.py`.
