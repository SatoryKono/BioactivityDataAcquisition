...
echo "  2. Run Configurations: pytest-fast, pytest-architecture, pytest-architecture-slow-governance, pytest-debug, pytest-coverage, mypy-full, ruff-check, quality-gate, BioETL smoke (offline fixture)"
