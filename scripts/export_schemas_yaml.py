...
Usage:
    python scripts/export_schemas_yaml.py [--output-dir OUTPUT_DIR] [--entity ENTITY]

Examples:
    # Export all schemas to configs/schemas/
    python scripts/export_schemas_yaml.py

    # Export specific entity schema
    python scripts/export_schemas_yaml.py --entity activity

    # Export to custom directory
    python scripts/export_schemas_yaml.py --output-dir /tmp/schemas
"""
