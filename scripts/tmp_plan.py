...
content = pathlib.Path("E:/tmp/chapter4.txt").read_text(encoding="utf-8")[:100]
# Instead craft plan from sections already known
plan = """# План обновления системы промптов — Kernel v3 (materialized 28.08.2026)
...
"""
pathlib.Path(
    "docs/00-project/ai/prompts/library/audit/project/materialized-v3/MIGRATION-PLAN.md"
