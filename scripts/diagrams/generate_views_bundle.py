#!/usr/bin/env python3
"""Generate bundles/views.bundle.md bundle from views/ mermaid files."""
...
OUTPUT_MD = bundle_markdown_path("views")
...
def main() -> int:
    ...
    for mf in mermaid_files:
        ...
        lines.append(f"- Исходная диаграмма: `{source_ref('views', mf.name)}`\n")
