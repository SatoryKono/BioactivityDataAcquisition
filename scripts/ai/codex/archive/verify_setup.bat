@echo off
REM Canonical Codex setup verification launcher
...
echo   .\scripts\ai\codex\verify_setup.ps1
echo.
...
wsl -d %WSL_DISTRO% -- bash "!REPO_WSL!/scripts/ai/codex/diagnose_wsl.sh" 2>&1
