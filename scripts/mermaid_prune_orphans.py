...
Usage:
    python scripts/mermaid_prune_orphans.py --dry-run     # report only
    python scripts/mermaid_prune_orphans.py --apply        # modify files
    python scripts/mermaid_prune_orphans.py --apply --filter "03-*"
"""
