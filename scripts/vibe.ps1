...
#
# Examples:
#   .\vibe.ps1                      # Start interactive mode
#   .\vibe.ps1 "explain this code"  # Send prompt
#   .\vibe.ps1 --help               # Show vibe help
...
function Write-MistralWarn { Write-Host "[mistral]" -ForegroundColor $Colors.Warning -NoNewline; Write-Host " $args" }
