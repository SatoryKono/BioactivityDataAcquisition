...
#   ./scripts/dev/dev_setup.sh --quick  # Только установка зависимостей (без тестов)
#   ./scripts/dev/dev_setup.sh --help   # Справка
#
# BioETL v6.0.0 | Синхронизировано с RULES.md v5.23 (2026-02-24)
# ==============================================================================
...
Примеры:
    ...
    ./scripts/dev/dev_setup.sh --quick      # Быстрая установка для опытных разработчиков
