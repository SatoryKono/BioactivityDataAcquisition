...
def test_maintenance_operations_simple():
    ...
    maintenance_ops.maybe_export_csv("test_table", mock_table, "/tmp/test", mode="append")
    ...
    maintenance_ops_no_exporter.maybe_export_csv("test_table", mock_table, "/tmp/test", mode="append")
