# Codex WSL Diagnostic Tool Launcher (PowerShell)
# Usage: . .\scripts\ops\diagnose-codex-wsl.ps1
...
# Run diagnostic in WSL
$diagnosticScript = "$repoWSL/scripts/ops/diagnose-codex-wsl.sh"
