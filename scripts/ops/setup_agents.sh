...
#   bash scripts/setup_agents.sh --dry-run
...
log_info() { echo -e "${BLUE}[setup-agents]${NC} $1"; }
log_ok() { echo -e "${GREEN}[setup-agents]${NC} $1"; }
log_warn() { echo -e "${YELLOW}[setup-agents]${NC} $1"; }
