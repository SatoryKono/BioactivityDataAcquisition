...
Usage:
    ...
    python scripts/inject_svg_styles.py --check

    # Fix all SVGs in-place
    python scripts/inject_svg_styles.py --fix

    # Dry-run: show what would change
    python scripts/inject_svg_styles.py --dry-run

    # Process specific files
    python scripts/inject_svg_styles.py --fix -f docs/.../svg/10-resilience-patterns.svg

    # Process specific directory
    python scripts/inject_svg_styles.py --fix --dir docs/.../architecture/svg
"""
