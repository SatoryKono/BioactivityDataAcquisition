...
- **ChemblActivityPipeline**: пайплайн активности (см. `../reference/pipelines/chembl/activity/00-activity-chembl-overview.md`)
- **PipelineBase**: базовый класс пайплайнов (см. `../reference/core/pipeline-base.md`)
