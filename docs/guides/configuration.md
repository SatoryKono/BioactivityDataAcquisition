...
- **FileConfigResolver**: резолвер конфигурации (см. `../reference/infrastructure/config/00-config-resolver.md`)
- **EnvSecretProvider**: провайдер секретов (см. `../reference/infrastructure/config/01-secret-provider.md`)
