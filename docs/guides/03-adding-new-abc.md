...
Проверьте существующие контракты в `docs/domain/abc/00-index.md`. Если новый функционал дополняет существующий ABC, расширьте его вместо создания дубликата. Поддерживайте трёхслойный паттерн и обновляйте документацию синхронно с кодом.
