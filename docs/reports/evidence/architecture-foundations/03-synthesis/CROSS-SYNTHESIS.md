...
- The collected evidence supports a coherent three-level view of the architecture: a stable **layer model**, an explicit **pattern model**, and a green **enforcement model**. ([SYN-layers-and-boundaries.md](/mnt/e/g-drive/05_AI/github/BioactivityDataAcquisition2/docs/reports/evidence/architecture-foundations/03-synthesis/SYN-layers-and-boundaries.md), [SYN-architecture-patterns.md](/mnt/e/g-drive/05_AI/github/BioactivityDataAcquisition2/docs/reports/evidence/architecture-foundations/03-synthesis/SYN-architecture-patterns.md), [SYN-enforcement-guardrails.md](/mnt/e/g-drive/05_AI/github/BioactivityDataAcquisition2/docs/reports/evidence/architecture-foundations/03-synthesis/SYN-enforcement-guardrails.md))
