...
`source_tree_sha256=d874974c239d95701b7af0703f29159ca49ad6a22bf08541799bdfb70958cf5c`).
...
- Current layer file counts are: `domain=574`, `application=664`, `infrastructure=584`, `composition=275`, `interfaces=138`.
