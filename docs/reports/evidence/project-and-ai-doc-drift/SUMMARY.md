...
2. `EV-project-and-ai-doc-drift-config-bot-memory-now-points-to-live-config-loader-seams`
3. `EV-project-and-ai-doc-drift-local-py-code-bot-skill-now-explicitly-compatibility-only`
4. `EV-project-and-ai-doc-drift-practical-index-now-labels-py-code-bot-as-historical-compatibility`
5. `EV-project-and-ai-doc-drift-local-catalog-now-labels-py-code-bot-as-compatibility-profile`
6. `EV-project-and-ai-doc-drift-orchestration-now-explicitly-marks-changelog-as-non-normative`
