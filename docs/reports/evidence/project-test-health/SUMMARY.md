...
Reverified on 2026-08-12 during the PR #8649 architecture-gate closeout:
canonical source paths remain present, the tracked test-module inventory and
architecture suite were rerun, and interpretation stays backlog signal only
pending the next full pytest telemetry artifact.
