...
2. `EV-reference-guide-doc-drift-application-composite-now-separates-root-and-nested-symbols`
3. `EV-reference-guide-doc-drift-composition-factories-now-separates-root-and-nested-symbols`
4. `EV-reference-guide-doc-drift-runtime-builders-now-state-root-export-boundary-explicitly`
5. `EV-reference-guide-doc-drift-pipeline-configuration-now-uses-category-based-inventory`
