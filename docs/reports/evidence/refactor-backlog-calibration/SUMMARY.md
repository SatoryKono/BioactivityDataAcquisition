...
- Формальная cross-pack интерпретация теперь находится в 03-synthesis/CROSS-SYNTHESIS.md.
- Принятая planning-позиция теперь находится в 04-decisions/DECISIONS.yaml.
- Активные planning-риски теперь находятся в 05-risks/RISKS.yaml.
...
2. **RF-04 — Focused composition decomposition**
   Primary targets:
...
3. **RF-06 — Downgrade to docs/governance watchpoint**
