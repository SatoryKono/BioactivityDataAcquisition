...
The VCS lifecycle is intentionally allowlist-based: `README.md`, this
`index.md`, generated cleanup inventory artifacts, and reviewed bounded
evidence manifests are trackable. Raw local evidence packs, generated
intermediate reports, and investigation byproducts stay ignored until an
explicit retention review promotes or archives an exact path.

## Cleanup Baseline

The current documentation cleanup baseline is
[`generated/documentation-cleanup-inventory.md`](generated/documentation-cleanup-inventory.md)
with machine-readable details in `generated/documentation-cleanup-inventory.json`.

Use that baseline to separate canonical, active, working, archive, duplicate,
deprecated, and route-owned surfaces before moving or pruning documentation.
Cleanup decisions remain reversible: archive before deletion, preserve ADRs as
architecture history, and do not remove paths with active inbound references.
...
- [`generated/documentation-cleanup-inventory.md`](generated/documentation-cleanup-inventory.md)
  — generated per-file cleanup matrix for canonical, active, generated,
  working, archive, duplicate, deprecated, and unknown documentation surfaces
- `generated/documentation-cleanup-inventory.json` — machine-readable sibling
