...
| `docs/00-project/ai/prompts/**`                                                                                                                                            | `internal-published` + `internal-generated` + `repo-only` | Curated prompt indexes MAY be shown under `Internal / Extended`; collected/raw prompt copies and excluded overview pages MAY remain repo-only/non-nav                        | [docs/00-project/ai/prompts/documentation-prompts-2-README.md](../ai/prompts/documentation-prompts-2-README.md) |
