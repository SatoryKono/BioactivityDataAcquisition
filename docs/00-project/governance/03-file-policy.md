...
| Human-facing root docs | `README.md`, `CHANGELOG.md`, `CONTRIBUTING.md`, `LICENSE`, `AGENTS.md`, and reviewed vendor guidance such as `best_practices.md`. Root `GEMINI.md` is not a project file. | canonical root text policy in `audit_root_cleanliness.py` | non-canonical notes move to `docs/**` or `docs/99-archive/**` |
