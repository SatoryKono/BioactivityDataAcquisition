...
**v6.1.5** (governance baseline per [RULES.md](RULES.md)) — See [CHANGELOG](https://github.com/SatoryKono/BioactivityDataAcquisition/blob/main/CHANGELOG.md) for release history.
