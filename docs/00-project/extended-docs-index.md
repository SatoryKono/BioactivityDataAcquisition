...
- [Cross-platform test setup (archived)](../99-archive/fixes/cross_platform_test_setup.md)
- [Test dependency fixes (archived)](../99-archive/fixes/test_dependency_fixes.md)
- [Runtime metadata factory plan (archived)](../99-archive/refactoring_plans/runtime_metadata_factory_refactoring_plan.md)
