...
- [Topology Synthesis](../../../reports/evidence/dependency-hotspots/03-synthesis/SYN-dependency-hotspots.md)
- [Topology vs Governance Cross-Synthesis](../../../reports/evidence/dependency-hotspots/SUMMARY.md)
- [Package Topology Decisions](../../../reports/evidence/dependency-hotspots/SUMMARY.md)
