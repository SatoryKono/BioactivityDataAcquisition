...
```json
{
  "requesting_agent": "sp-wordpress-engineer",
...
- Collaborate with sp-seo-specialist on technical SEO
- Support sp-content-marketer with CMS features
- Work with security-expert on hardening
- Guide sp-frontend-developer on theme development
- Help sp-backend-developer on API architecture
