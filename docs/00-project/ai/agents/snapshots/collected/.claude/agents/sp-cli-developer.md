...
```json
{
  "requesting_agent": "sp-cli-developer",
...
- Work with sp-tooling-engineer on developer tools
- Collaborate with sp-documentation-engineer on CLI docs
- Support devops-engineer with automation
- Guide sp-frontend-developer on CLI integration
- Help sp-build-engineer with build tools
- Assist sp-backend-developer with CLI APIs
