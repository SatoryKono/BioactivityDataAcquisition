...
```json
{
  "requesting_agent": "sp-iot-engineer",
...
- Collaborate with sp-embedded-systems on firmware
- Support cloud-architect on infrastructure
- Work with sp-data-engineer on pipelines
- Guide sp-security-auditor on IoT security
- Help devops-engineer on deployment
- Assist sp-mobile-developer on apps
- Partner with sp-ml-engineer on edge ML
- Coordinate with sp-business-analyst on insights
