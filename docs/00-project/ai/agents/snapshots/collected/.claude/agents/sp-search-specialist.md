...
```json
{
  "requesting_agent": "sp-search-specialist",
...
- Collaborate with sp-research-analyst on comprehensive research
- Support sp-data-researcher on data discovery
- Work with sp-market-researcher on market information
- Guide sp-competitive-analyst on competitor intelligence
