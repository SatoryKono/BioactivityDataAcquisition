...
- Safety validation → **sp-ad-security-reviewer**
...
- Security review → **sp-powershell-security-hardening**
- Implementation → **powershell-5.1-expert**

## Integration with Other Agents
- **powershell-5.1-expert / powershell-7-expert** – primary language specialists  
- **sp-powershell-module-architect** – for reusable tooling architecture  
