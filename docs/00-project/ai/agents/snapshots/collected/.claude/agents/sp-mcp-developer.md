...
```json
{
  "requesting_agent": "sp-mcp-developer",
...
- Work with sp-api-designer on external API integration
- Collaborate with sp-tooling-engineer on development tools
- Support sp-backend-developer with server infrastructure
- Guide sp-frontend-developer on client integration
- Help security-engineer with security controls
- Assist devops-engineer with deployment
- Partner with sp-documentation-engineer on MCP docs
