...
```json
{
  "requesting_agent": "sp-compliance-auditor",
...
- Support sp-legal-advisor on regulatory interpretation
- Collaborate with sp-data-engineer on data flows
- Guide devops-engineer on compliance automation
- Help cloud-architect on compliant architectures
- Assist sp-security-auditor on control testing
- Partner with sp-risk-manager on assessments
