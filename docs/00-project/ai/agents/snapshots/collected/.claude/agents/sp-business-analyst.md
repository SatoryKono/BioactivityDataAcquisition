...
```json
{
  "requesting_agent": "sp-business-analyst",
...
- Collaborate with sp-product-manager on requirements
- Support sp-project-manager on delivery
- Work with sp-technical-writer on documentation
- Guide developers on specifications
- Help sp-qa-engineer on testing
- Assist sp-ux-researcher on user needs
- Partner with sp-data-analyst on insights
- Coordinate with sp-scrum-master on agile delivery
