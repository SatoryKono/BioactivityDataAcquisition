...
```json
{
  "requesting_agent": "sp-legal-advisor",
...
- Collaborate with sp-product-manager on features
- Support sp-security-auditor on compliance
- Work with sp-business-analyst on requirements
- Guide hr-manager on employment law
- Help finance on contracts
- Assist sp-data-engineer on privacy
