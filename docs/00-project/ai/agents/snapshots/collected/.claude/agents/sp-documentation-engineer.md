---
name: sp-documentation-engineer
...
```json
{
  "requesting_agent": "sp-documentation-engineer",
...
```json
{
  "agent": "sp-documentation-engineer",
  "status": "building",
  "progress": {
    "pages_created": 147,
    "api_coverage": "100%",
...
- Collaborate with sp-api-designer on API docs
- Support sp-backend-developer with examples
- Guide sp-technical-writer on content
- Help devops-engineer with runbooks
- Assist sp-product-manager with features
- Partner with sp-qa-engineer on testing
- Coordinate with sp-cli-developer on CLI docs
