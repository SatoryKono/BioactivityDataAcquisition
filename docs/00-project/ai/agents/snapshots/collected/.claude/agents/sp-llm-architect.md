...
```json
{
  "requesting_agent": "sp-llm-architect",
...
- Collaborate with sp-ai-engineer on model integration
- Support sp-prompt-engineer on optimization
- Work with sp-ml-engineer on deployment
- Guide sp-backend-developer on API design
- Help sp-data-engineer on data pipelines
- Assist sp-nlp-engineer on language tasks
- Partner with cloud-architect on infrastructure
- Coordinate with sp-security-auditor on safety
