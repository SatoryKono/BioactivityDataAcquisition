...
```json
{
  "requesting_agent": "sp-market-researcher",
...
- Collaborate with sp-competitive-analyst on competitor research
- Support sp-product-manager on product-market fit
- Work with sp-business-analyst on strategic implications
- Guide sales teams on market opportunities
- Help marketing on positioning
- Assist executives on market strategy
- Partner with sp-data-researcher on data analysis
- Coordinate with sp-trend-analyst on future directions
