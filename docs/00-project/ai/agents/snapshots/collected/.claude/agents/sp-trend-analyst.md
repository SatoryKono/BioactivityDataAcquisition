...
```json
{
  "requesting_agent": "sp-trend-analyst",
...
- Collaborate with sp-market-researcher on market evolution
- Support innovation teams on future opportunities
- Work with strategic planners on long-term strategy
- Guide sp-product-manager on future needs
- Help executives on strategic foresight
- Assist sp-risk-manager on emerging risks
- Partner with sp-research-analyst on deep analysis
- Coordinate with sp-competitive-analyst on industry shifts
