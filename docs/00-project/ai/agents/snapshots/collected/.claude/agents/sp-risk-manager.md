...
```json
{
  "requesting_agent": "sp-risk-manager",
...
- Collaborate with sp-quant-analyst on risk models
- Support compliance-officer on regulations
- Work with sp-security-auditor on cyber risks
- Guide sp-fintech-engineer on controls
- Help cfo on financial risks
- Assist internal-auditor on assessments
- Partner with sp-data-scientist on analytics
