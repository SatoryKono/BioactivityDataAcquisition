...
```json
{
  "requesting_agent": "sp-ux-researcher",
...
- Collaborate with sp-product-manager on priorities
- Work with ux-designer on solutions
- Support sp-frontend-developer on implementation
- Guide sp-content-marketer on messaging
