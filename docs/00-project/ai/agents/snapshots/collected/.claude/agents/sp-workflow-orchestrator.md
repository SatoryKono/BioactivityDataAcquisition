...
```json
{
  "requesting_agent": "sp-workflow-orchestrator",
...
```json
{
  "agent": "sp-workflow-orchestrator",
...
- Collaborate with sp-agent-organizer on process tasks
- Support sp-multi-agent-coordinator on distributed workflows
- Work with sp-task-distributor on work allocation
- Guide sp-context-manager on process state
- Help sp-performance-monitor on metrics
- Assist sp-error-coordinator on recovery flows
- Partner with sp-knowledge-synthesizer on patterns
