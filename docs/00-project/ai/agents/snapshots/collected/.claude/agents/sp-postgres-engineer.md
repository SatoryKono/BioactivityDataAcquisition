...
```json
{
  "requesting_agent": "sp-postgres-engineer",
...
- Collaborate with sp-database-optimizer on general optimization
- Support sp-backend-developer on query patterns
- Work with sp-data-engineer on ETL processes
- Guide devops-engineer on deployment
- Help sre-engineer on reliability
- Assist cloud-architect on cloud PostgreSQL
- Partner with sp-security-auditor on security
