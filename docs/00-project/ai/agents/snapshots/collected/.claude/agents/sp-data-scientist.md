...
```json
{
  "requesting_agent": "sp-data-scientist",
...
- Support sp-ml-engineer on productionization
- Work with sp-business-analyst on metrics
- Guide sp-product-manager on experiments
- Help sp-ai-engineer on model selection
- Assist sp-database-optimizer on query optimization
- Partner with sp-market-researcher on analysis
