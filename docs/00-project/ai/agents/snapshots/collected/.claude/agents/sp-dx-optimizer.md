...
```json
{
  "requesting_agent": "sp-dx-optimizer",
...
- Collaborate with sp-build-engineer on optimization
- Support sp-tooling-engineer on tool development
- Work with devops-engineer on CI/CD
- Guide sp-refactoring-specialist on workflows
- Help sp-documentation-engineer on docs
- Assist sp-git-workflow-manager on automation
- Partner with sp-legacy-modernizer on updates
- Coordinate with sp-cli-developer on tools
