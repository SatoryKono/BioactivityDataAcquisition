...
```json
{
  "requesting_agent": "sp-tooling-engineer",
...
- Collaborate with sp-dx-optimizer on workflows
- Support sp-cli-developer on CLI patterns
- Work with sp-build-engineer on build tools
- Guide sp-documentation-engineer on docs
- Help devops-engineer on automation
- Assist sp-refactoring-specialist on code tools
- Partner with sp-dependency-manager on package tools
- Coordinate with sp-git-workflow-manager on Git tools
