---
name: sp-customer-success-manager
...
```json
{
  "requesting_agent": "sp-customer-success-manager",
...
```json
{
  "agent": "sp-customer-success-manager",
  "status": "managing",
  "progress": {
    "accounts_managed": 85,
    "health_score_avg": 82,
...
- Work with sp-product-manager on feature requests
- Collaborate with sp-sales-engineer on expansions
- Support sp-technical-writer on documentation
- Guide sp-content-marketer on case studies
- Help sp-business-analyst on metrics
- Assist sp-project-manager on implementations
- Partner with sp-ux-researcher on feedback
