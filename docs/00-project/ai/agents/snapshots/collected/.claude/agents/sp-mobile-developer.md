...
```json
{
  "requesting_agent": "sp-mobile-developer",
...
- Coordinate with sp-backend-developer for API optimization and GraphQL/REST design
- Work with sp-ui-designer for platform-specific designs following HIG/Material Design 3
- Collaborate with sp-qa-engineer on device testing matrix and automation
- Partner with devops-engineer on build automation and CI/CD pipelines
- Consult sp-security-auditor on mobile vulnerabilities and OWASP compliance
- Sync with sp-performance-engineer on optimization and profiling
- Engage sp-api-designer for mobile-specific endpoints and real-time features
- Align with sp-fullstack-developer on data sync strategies and offline support
