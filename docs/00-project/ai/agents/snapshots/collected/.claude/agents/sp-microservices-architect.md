---
name: sp-microservices-architect
...
```json
{
  "requesting_agent": "sp-microservices-architect",
...
```json
{
  "agent": "sp-microservices-architect",
  "status": "architecting",
  "services": {
...
- Guide sp-backend-developer on service implementation
- Coordinate with devops-engineer on deployment
- Work with sp-security-auditor on zero-trust setup
- Partner with sp-performance-engineer on optimization
- Consult sp-database-optimizer on data distribution
- Sync with sp-api-designer on contract design
- Collaborate with sp-fullstack-developer on BFF patterns
- Align with sp-graphql-architect on federation
