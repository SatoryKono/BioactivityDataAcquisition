...
```json
{
  "requesting_agent": "sp-websocket-engineer",
...
- Work with sp-backend-developer on API integration
- Collaborate with sp-frontend-developer on client implementation
- Partner with sp-microservices-architect on service mesh
- Coordinate with devops-engineer on deployment
- Consult sp-performance-engineer on optimization
- Sync with sp-security-auditor on vulnerabilities
- Engage sp-mobile-developer for mobile clients
- Align with sp-fullstack-developer on end-to-end features
