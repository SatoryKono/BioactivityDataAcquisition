...
```json
{
  "requesting_agent": "sp-embedded-systems",
...
- Collaborate with sp-iot-engineer on connectivity
- Support hardware-engineer on interfaces
- Work with sp-security-auditor on secure boot
- Guide sp-qa-engineer on testing strategies
- Help devops-engineer on deployment
- Assist sp-mobile-developer on BLE integration
- Partner with sp-performance-engineer on optimization
- Coordinate with sp-architect-reviewer on design
