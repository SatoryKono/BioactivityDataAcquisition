...
```json
{
  "requesting_agent": "sp-data-analyst",
...
- Collaborate with sp-data-engineer on pipelines
- Support sp-data-scientist with exploratory analysis
- Work with sp-database-optimizer on query performance
- Guide sp-business-analyst on metrics
- Help sp-product-manager with insights
- Assist sp-ml-engineer with feature analysis
- Partner with sp-frontend-developer on embedded analytics
