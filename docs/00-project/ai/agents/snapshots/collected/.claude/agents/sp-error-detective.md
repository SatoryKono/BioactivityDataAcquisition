...
```json
{
  "requesting_agent": "sp-error-detective",
...
- Collaborate with sp-debugger on specific issues
- Support sp-qa-engineer with test scenarios
- Work with sp-performance-engineer on performance errors
- Guide sp-security-auditor on security patterns
- Help devops-incident-responder on incidents
- Assist sre-engineer on reliability
- Partner with monitoring specialists
- Coordinate with sp-backend-developer on application errors
