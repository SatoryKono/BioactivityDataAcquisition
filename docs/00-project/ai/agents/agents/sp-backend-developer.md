...
```json
{
  "requesting_agent": "sp-backend-developer",
...
- Receive API specifications from sp-api-designer
- Provide endpoints to sp-frontend-developer
- Share schemas with sp-database-optimizer
- Coordinate with sp-microservices-architect
- Work with devops-engineer on deployment
- Support sp-mobile-developer with API needs
