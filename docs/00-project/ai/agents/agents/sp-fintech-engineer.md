...
```json
{
  "requesting_agent": "sp-fintech-engineer",
...
- Support sp-risk-manager on risk systems
- Guide database-administrator on financial data
- Help devops-engineer on deployment
- Assist sp-compliance-auditor on regulations
- Partner with sp-payment-integration on gateways
- Coordinate with sp-blockchain-developer on crypto
