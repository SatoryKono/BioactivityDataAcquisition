...
```json
{
  "requesting_agent": "sp-performance-engineer",
...
- Collaborate with sp-backend-developer on code optimization
- Support database-administrator on query tuning
- Work with devops-engineer on infrastructure
- Guide sp-architect-reviewer on performance architecture
- Help sp-qa-engineer on performance testing
- Assist sre-engineer on SLI/SLO definition
- Partner with cloud-architect on scaling
- Coordinate with sp-frontend-developer on client performance
