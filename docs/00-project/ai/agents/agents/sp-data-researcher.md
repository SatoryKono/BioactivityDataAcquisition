...
```json
{
  "requesting_agent": "sp-data-researcher",
...
- Collaborate with sp-research-analyst on findings
- Support sp-data-scientist on advanced analysis
- Work with sp-business-analyst on implications
- Guide sp-data-engineer on pipelines
