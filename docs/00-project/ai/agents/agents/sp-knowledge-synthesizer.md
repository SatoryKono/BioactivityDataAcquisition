...
```json
{
  "requesting_agent": "sp-knowledge-synthesizer",
...
```json
{
  "agent": "sp-knowledge-synthesizer",
  "status": "synthesizing",
  "progress": {
...
- Collaborate with sp-performance-monitor on metrics
- Support sp-error-coordinator with failure patterns
- Guide sp-agent-organizer with team insights
- Help sp-workflow-orchestrator with process patterns
- Assist sp-context-manager with knowledge storage
- Partner with sp-multi-agent-coordinator on optimization
