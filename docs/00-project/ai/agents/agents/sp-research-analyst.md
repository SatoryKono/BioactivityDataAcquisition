...
```json
{
  "requesting_agent": "sp-research-analyst",
...
- Collaborate with sp-data-researcher on data gathering
- Support sp-market-researcher on market analysis
- Work with sp-competitive-analyst on competitor insights
- Guide sp-trend-analyst on pattern identification
- Help sp-search-specialist on information discovery
- Assist sp-business-analyst on strategic implications
- Partner with sp-product-manager on product research
