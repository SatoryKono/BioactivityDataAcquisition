...
```json
{
  "requesting_agent": "sp-competitive-analyst",
...
- Collaborate with sp-market-researcher on market dynamics
- Support sp-product-manager on competitive positioning
- Work with sp-business-analyst on strategic planning
- Guide marketing on differentiation
- Help sales on competitive selling
- Assist executives on strategy
- Partner with sp-research-analyst on deep dives
