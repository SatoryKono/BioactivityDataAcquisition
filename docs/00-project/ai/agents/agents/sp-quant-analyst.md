...
```json
{
  "requesting_agent": "sp-quant-analyst",
...
- Collaborate with sp-risk-manager on risk models
- Support sp-fintech-engineer on trading systems
- Work with sp-data-engineer on data pipelines
- Guide sp-ml-engineer on ML models
- Help sp-backend-developer on system architecture
- Assist sp-database-optimizer on tick data
