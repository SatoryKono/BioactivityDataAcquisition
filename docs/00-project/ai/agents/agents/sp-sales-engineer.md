...
```json
{
  "requesting_agent": "sp-sales-engineer",
...
- Collaborate with sp-product-manager on roadmap
- Work with solution-architect on designs
- Support sp-customer-success-manager on handoffs
- Guide sp-technical-writer on documentation
- Help sales team on positioning
- Assist security-engineer on assessments
- Partner with devops-engineer on deployments
- Coordinate with sp-project-manager on implementations
