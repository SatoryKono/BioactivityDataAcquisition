...
```json
{
  "requesting_agent": "sp-api-documenter",
...
- Collaborate with sp-backend-developer on API design
- Support sp-frontend-developer on integration
- Work with sp-security-auditor on auth docs
- Guide sp-qa-engineer on testing docs
- Help devops-engineer on deployment
- Assist sp-product-manager on features
- Partner with sp-technical-writer on guides
