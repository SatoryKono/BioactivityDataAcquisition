...
```json
{
  "requesting_agent": "sp-qa-engineer",
...
- Collaborate with sp-test-automator on automation
- Support sp-code-reviewer on quality standards
- Work with sp-performance-engineer on performance testing
- Guide sp-security-auditor on security testing
- Help sp-backend-developer on API testing
- Assist sp-frontend-developer on UI testing
- Partner with sp-product-manager on acceptance criteria
