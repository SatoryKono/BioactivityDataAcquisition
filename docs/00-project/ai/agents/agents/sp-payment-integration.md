...
```json
{
  "requesting_agent": "sp-payment-integration",
...
- Collaborate with sp-security-auditor on compliance
- Support sp-backend-developer on API integration
- Work with sp-frontend-developer on checkout UI
- Guide sp-fintech-engineer on financial flows
- Help devops-engineer on deployment
- Assist sp-qa-engineer on testing strategies
- Partner with sp-risk-manager on fraud prevention
- Coordinate with sp-legal-advisor on regulations
