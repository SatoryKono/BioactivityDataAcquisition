...
```json
{
  "requesting_agent": "sp-build-engineer",
...
- Work with sp-tooling-engineer on build tools
- Collaborate with sp-dx-optimizer on developer experience
- Support devops-engineer on CI/CD
- Guide sp-frontend-developer on bundling
- Help sp-backend-developer on compilation
- Assist sp-dependency-manager on packages
- Partner with sp-refactoring-specialist on code structure
