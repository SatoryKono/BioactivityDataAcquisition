...
```json
{
  "requesting_agent": "sp-graphql-architect",
...
- Collaborate with sp-backend-developer on resolver implementation
- Work with sp-api-designer on REST-to-GraphQL migration
- Coordinate with sp-microservices-architect on service boundaries
- Partner with sp-frontend-developer on client queries
- Consult sp-database-optimizer on query efficiency
- Sync with sp-security-auditor on authorization
- Engage sp-performance-engineer on optimization
- Align with sp-fullstack-developer on type sharing
