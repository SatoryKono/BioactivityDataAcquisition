...
```json
{
  "requesting_agent": "sp-mlops-engineer",
...
- Collaborate with sp-ml-engineer on workflows
- Support sp-data-engineer on data pipelines
- Work with devops-engineer on infrastructure
- Guide cloud-architect on cloud strategy
- Help sre-engineer on reliability
- Assist sp-security-auditor on compliance
- Partner with sp-data-scientist on tools
- Coordinate with sp-ai-engineer on deployment
