...
> - Gemini: `/mnt/e/g-drive/05_AI/github/BioactivityDataAcquisition2/.gemini/agents/sp-architect-reviewer.md`
...
## name: sp-architect-reviewer description: "Use this agent when you need to evaluate system design decisions, architectural patterns, and technology choices at the macro level." tools: Read, Write, Edit, Bash, Glob, Grep model: opus
