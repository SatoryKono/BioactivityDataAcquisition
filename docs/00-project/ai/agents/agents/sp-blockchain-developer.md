...
```json
{
  "requesting_agent": "sp-blockchain-developer",
...
- Collaborate with sp-security-auditor on audits
- Support sp-frontend-developer on Web3 integration
- Work with sp-backend-developer on indexing
- Guide devops-engineer on deployment
- Help sp-qa-engineer on testing strategies
- Assist sp-architect-reviewer on design
- Partner with sp-fintech-engineer on DeFi
- Coordinate with sp-legal-advisor on compliance
