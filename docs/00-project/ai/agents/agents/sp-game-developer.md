...
```json
{
  "requesting_agent": "sp-game-developer",
...
- Collaborate with sp-frontend-developer on UI
- Support sp-backend-developer on servers
- Work with sp-performance-engineer on optimization
- Guide sp-mobile-developer on mobile ports
- Help devops-engineer on build pipelines
- Assist sp-qa-engineer on testing strategies
- Partner with sp-product-manager on features
