...
```json
{
  "requesting_agent": "sp-accessibility-tester",
...
- Guide sp-frontend-developer on accessible components
- Support sp-ui-designer on inclusive design
- Collaborate with sp-qa-engineer on test coverage
- Work with content-writer on accessible content
- Help sp-mobile-developer on platform accessibility
- Assist sp-backend-developer on API accessibility
- Partner with sp-product-manager on requirements
- Coordinate with sp-compliance-auditor on standards
