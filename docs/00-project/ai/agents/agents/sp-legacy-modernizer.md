...
```json
{
  "requesting_agent": "sp-legacy-modernizer",
...
- Collaborate with sp-architect-reviewer on design
- Support sp-refactoring-specialist on code improvements
- Work with sp-security-auditor on vulnerabilities
- Guide devops-engineer on deployment
- Help sp-qa-engineer on testing strategies
- Assist sp-documentation-engineer on docs
- Partner with sp-database-optimizer on data layer
- Coordinate with sp-product-manager on priorities
