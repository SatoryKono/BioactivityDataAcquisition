...
> - Codex: `.codex/skills/nci-analysis/SKILL.md`
...
1. Apply 20-category analysis (see `references/categories.md`)
1. Calculate composite factors and overall score (see `references/scoring.md`)
