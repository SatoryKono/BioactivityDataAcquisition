...
> - Gemini: `/mnt/e/g-drive/05_AI/github/BioactivityDataAcquisition2/.codex/skills/py-architecture-debt-bot/SKILL.md`
...
1. Open and follow `../../../.codex/agents/py-architecture-debt-bot.md`.
