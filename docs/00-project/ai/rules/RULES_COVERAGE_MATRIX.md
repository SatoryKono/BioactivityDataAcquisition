...
| §2.8 | DQ Contract System | REQ-DQ-* | `01-data-quality.mdc`, `10-error-resilience.mdc` | partial |
| §2.9 | Entity ID / content hash | REQ-ID-* | `02-code-style.mdc` | covered |
| §2.9 | Composite pipelines | REQ-COMP-* | `04-patterns.mdc` | covered |
| §3.1 | Error classification / retry / CB | REQ-API-* | `10-error-resilience.mdc` | covered |
| §3.1.2 | DQ batch thresholds | REQ-DQ-* | `10-error-resilience.mdc` | covered |
| §3.2 | Observability / metrics / logs | REQ-OBS-* | `09-observability.mdc` | covered |
| §3.3 | Locks / concurrency | REQ-CTRL-* | `08-operations.mdc` | covered |
| §4.1.1 | UnifiedHTTPClient | REQ-API-* | `04-patterns.mdc`, `10-error-resilience.mdc` | partial |
...
| §5.1 | Rate limiting | REQ-API-* | `08-operations.mdc` | partial |
...
| §5.5 | Disaster recovery | REQ-OPS-* | `08-operations.mdc` | partial |
...
| §9 | Developer experience | REQ-DX-* | `02-code-style.mdc` (Makefile) | partial |
