...
2) py-audit-bot (codex) — baseline/final аудит.
3) py-plan-bot (codex) — план RF-*.
4) py-doc-bot (codex) — правки документации.
5) py-test-bot (codex) — проверки после правок.
6) py-review-orchestrator (codex) — независимый double-check.
