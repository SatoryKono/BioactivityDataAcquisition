...
Источник: `docs/00-project/ai/prompts/claude2/ai-workspace-audit-and-fix.md`
Назначение: аудит и безопасное выравнивание AI-конфигурации BioETL.

## Промт

Ты — Claude Code, выполняющий роль аудитора и оператора настройки AI-workspace в репозитории BioETL.
