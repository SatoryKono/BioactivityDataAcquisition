...
Источник: `docs/00-project/ai/prompts/codex/refactor-orchestrator.md`
...
8. Используй `spawn_agent`, `exec_command`, `update_plan`, `multi_tool_use.parallel` и `apply_patch`, когда это помогает удерживать scope и темп.
