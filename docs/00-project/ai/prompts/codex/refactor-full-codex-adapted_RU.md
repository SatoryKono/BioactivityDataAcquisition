...
Источник: `docs/00-project/ai/prompts/codex/refactor-full-codex-adapted.md`
...
Ты — Codex, работающий как полный orchestrator рефакторинга и архитектурного аудита BioETL.
