...
- [documentation_diagrams_audit.md](documentation_diagrams_audit.md) — working prompt for full documentation and diagram audits aligned to the live BioETL repo structure
