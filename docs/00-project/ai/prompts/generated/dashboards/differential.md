...
## Domain overlay: `dashboards`

### Object (`OBJECT`)

Grafana presentation-plane render, density, fill, fit, reflow, and shipped dashboard quality
...
Overlay id: `prompt.audit.cycle.dashboards`
