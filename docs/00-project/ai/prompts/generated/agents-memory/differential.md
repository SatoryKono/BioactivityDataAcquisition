...
## Domain overlay: `agents-memory`

### Object (`OBJECT`)

AI runtime, agent scripts, instruction scope graph, and durable memory governance
...
- script idempotency, dry-run, fail-closed exit, quoting, and secret-on-stdout guard
...
Overlay id: `prompt.audit.cycle.agents-memory`
