...
## Domain overlay: `scripts-inventory`

### Object (`OBJECT`)

Scripts inventory, lifecycle registry, canonical roots, and no-growth active count
...
Overlay id: `prompt.audit.project.new2.scripts-inventory`
