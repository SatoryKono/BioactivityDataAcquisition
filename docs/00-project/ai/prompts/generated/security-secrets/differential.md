...
## Domain overlay: `security-secrets`

### Object (`OBJECT`)

Security controls, tracked secret leak prevention, env policy, and supply-chain scanning
...
Overlay id: `prompt.audit.project.new2.security-secrets`
