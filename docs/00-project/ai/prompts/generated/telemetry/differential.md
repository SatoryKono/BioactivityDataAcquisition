...
## Domain overlay: `telemetry`

### Object (`OBJECT`)

Observability instrumentation from scrape/export through recording rules to queryable series
...
Overlay id: `prompt.audit.cycle.telemetry`
