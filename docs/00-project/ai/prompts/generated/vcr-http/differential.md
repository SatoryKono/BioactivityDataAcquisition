...
## Domain overlay: `vcr-http`

### Object (`OBJECT`)

VCR cassettes, HTTP fixture sanitization, deterministic replay, and offline isolation
...
Overlay id: `prompt.audit.project.new2.vcr-http`
