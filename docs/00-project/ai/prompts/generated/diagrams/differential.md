...
## Domain overlay: `diagrams`

### Object (`OBJECT`)

Version-controlled text-as-code diagrams, renderer reproducibility, and code/ADR alignment
...
Overlay id: `prompt.audit.cycle.diagrams`
