...
## Domain overlay: `ops-runbooks`

### Object (`OBJECT`)

Operations runbooks covering DR, rollback, shutdown, triage, resume/repair, and Game Day
...
- local-only default preservation and hidden Docker/Redis/external orchestration detection
...
Overlay id: `prompt.audit.project.new2.ops-runbooks`
