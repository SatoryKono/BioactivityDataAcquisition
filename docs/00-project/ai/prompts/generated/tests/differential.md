...
## Domain overlay: `tests`

### Object (`OBJECT`)

Test system lanes, gates, markers, and regression-detection coverage
...
Overlay id: `prompt.audit.cycle.tests`
