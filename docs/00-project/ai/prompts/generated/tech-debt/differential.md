...
## Domain overlay: `tech-debt`

### Object (`OBJECT`)

Technical debt register, blast-radius ordering, paydown, and residual re-check
...
Overlay id: `prompt.audit.cycle.tech-debt`
