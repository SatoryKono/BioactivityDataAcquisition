...
## Domain overlay: `control-plane`

### Object (`OBJECT`)

Control plane, RunManifest, RunLedger, replay, resume, fencing, and operator inspection
...
Overlay id: `prompt.audit.project.new2.control-plane`
