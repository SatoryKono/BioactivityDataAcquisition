...
## Domain overlay: `qa-gates`

### Object (`OBJECT`)

QA gates, canonical generators, committed scorecards, and freshness with non-growth budgets
...
Overlay id: `prompt.audit.project.new2.qa-gates`
