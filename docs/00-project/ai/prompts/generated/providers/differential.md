...
## Domain overlay: `providers`

### Object (`OBJECT`)

Providers, entity catalog, adapter packages, and pipeline registration
...
Overlay id: `prompt.audit.project.new2.providers`
