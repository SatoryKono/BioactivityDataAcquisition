...
## Domain overlay: `github-actions`

### Object (`OBJECT`)

GitHub Actions trust model, permissions, pins, shell safety, caches, and required checks
...
- workflow catalog, required checks, concurrency, caches/artifacts, and shell fail-closed
...
Overlay id: `prompt.audit.project.new2.github-actions`
