...
## Domain overlay: `normalization`

### Object (`OBJECT`)

Normalization policies and identifier families DOI, ChEMBL, UniProt, PubChem CID, SMILES, InChI
...
Overlay id: `prompt.audit.project.new2.normalization`
