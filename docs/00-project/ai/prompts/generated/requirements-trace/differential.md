...
## Domain overlay: `requirements-trace`

### Object (`OBJECT`)

REQ traceability from catalog through crosswalk to implementation, tests, and evidence
...
Overlay id: `prompt.audit.project.new2.requirements-trace`
