...
tags: [architecture, audit, cycle, scorecard, hexagonal, plan, implement, operator]
summary: Cyclic architecture audit — 10-category scorecard, improvement plan, implement waves, re-verify
max_body_lines: 240
---
