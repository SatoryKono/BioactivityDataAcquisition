<!-- GENERATED full paste. Source id: prompt.audit.repo-tree. Do not edit by hand. -->
<!-- Regenerate: python -m scripts.ai.prompts render prompt.audit.repo-tree --param N=10 --param MODE=full --param LANGUAGE=ru -->

<!-- prompt-id: prompt.audit.repo-tree version: 1.2.0 -->
<!-- included fragments -->
## Read (do not restate)
