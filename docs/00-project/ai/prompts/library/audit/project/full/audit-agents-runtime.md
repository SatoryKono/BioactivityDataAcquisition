<!-- GENERATED full paste. Source id: prompt.audit.agents-runtime. Do not edit by hand. -->
<!-- Regenerate: python -m scripts.ai.prompts render prompt.audit.agents-runtime --param N=10 --param MODE=full --param LANGUAGE=ru -->

<!-- prompt-id: prompt.audit.agents-runtime version: 1.2.0 -->
<!-- included fragments -->
## Read (do not restate)
