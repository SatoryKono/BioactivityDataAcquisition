<!-- GENERATED full paste. Source id: prompt.audit.cycle.tech-debt. Do not edit by hand. -->
<!-- Regenerate: python -m scripts.ai.prompts render prompt.audit.cycle.tech-debt --param N=10 --param MODE=full --param LANGUAGE=ru -->

<!-- prompt-id: prompt.audit.cycle.tech-debt version: 1.0.0 -->
<!-- included fragments -->
## Read (do not restate)
