<!-- GENERATED full paste. Source id: prompt.audit.github-actions. Do not edit by hand. -->
<!-- Regenerate: python -m scripts.ai.prompts render prompt.audit.github-actions --param N=10 --param MODE=full --param LANGUAGE=ru -->

<!-- prompt-id: prompt.audit.github-actions version: 1.2.0 -->
<!-- included fragments -->
## Read (do not restate)
