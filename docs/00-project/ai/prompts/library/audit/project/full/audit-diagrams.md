<!-- GENERATED full paste. Source id: prompt.audit.diagrams. Do not edit by hand. -->
<!-- Regenerate: python -m scripts.ai.prompts render prompt.audit.diagrams --param N=10 --param MODE=full --param LANGUAGE=ru -->

<!-- prompt-id: prompt.audit.diagrams version: 1.2.0 -->
<!-- included fragments -->
## Read (do not restate)
