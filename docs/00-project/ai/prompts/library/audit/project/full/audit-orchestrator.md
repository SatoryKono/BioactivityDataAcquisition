<!-- GENERATED full paste. Source id: prompt.audit.orchestrator. Do not edit by hand. -->
<!-- Regenerate: python -m scripts.ai.prompts render prompt.audit.orchestrator --param N=10 --param MODE=full --param LANGUAGE=ru -->

<!-- prompt-id: prompt.audit.orchestrator version: 1.0.0 -->
<!-- included fragments -->
## Read (do not restate)
