<!-- GENERATED full paste. Source id: prompt.audit.cycle.telemetry. Do not edit by hand. -->
<!-- Regenerate: python -m scripts.ai.prompts render prompt.audit.cycle.telemetry --param N=10 --param MODE=full --param LANGUAGE=ru -->

<!-- prompt-id: prompt.audit.cycle.telemetry version: 1.0.0 -->
<!-- included fragments -->
## Read (do not restate)
