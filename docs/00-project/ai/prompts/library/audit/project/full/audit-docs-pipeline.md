<!-- GENERATED full paste. Source id: prompt.audit.docs-pipeline. Do not edit by hand. -->
<!-- Regenerate: python -m scripts.ai.prompts render prompt.audit.docs-pipeline --param N=10 --param MODE=full --param LANGUAGE=ru -->

<!-- prompt-id: prompt.audit.docs-pipeline version: 1.2.0 -->
<!-- included fragments -->
## Read (do not restate)
