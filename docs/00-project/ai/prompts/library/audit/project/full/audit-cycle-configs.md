<!-- GENERATED full paste. Source id: prompt.audit.cycle.configs. Do not edit by hand. -->
<!-- Regenerate: python -m scripts.ai.prompts render prompt.audit.cycle.configs --param N=10 --param MODE=full --param LANGUAGE=ru -->

<!-- prompt-id: prompt.audit.cycle.configs version: 1.0.0 -->
<!-- included fragments -->
## Read (do not restate)
