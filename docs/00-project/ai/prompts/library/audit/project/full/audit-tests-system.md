<!-- GENERATED full paste. Source id: prompt.audit.tests-system. Do not edit by hand. -->
<!-- Regenerate: python -m scripts.ai.prompts render prompt.audit.tests-system --param N=10 --param MODE=full --param LANGUAGE=ru -->

<!-- prompt-id: prompt.audit.tests-system version: 1.2.0 -->
<!-- included fragments -->
## Read (do not restate)
