...
panels, UIDs, metrics, or live values.
...
| 5 | `prompt.observability.grafana-audit.regression` | Baseline vs candidate | **no candidate change** |
| 6 | `prompt.observability.dashboard-panel-audit` | 5 named phases, `CYCLE_COUNT=1` | — |
| 7 | `prompt.observability.bi-dashboard-acceptance` | Visual / layout / data acceptance | — |
| 8 | `prompt.observability.dashboard-audit-cycle` | One cycle only (`N=1`, `ALLOW_*=false`) | write loops not authorized |
