...
description: >
  ...
  leave product files unchanged. Shadows the built-in plan type. No GitHub MCP and no gh.
prompt_mode: full
...
=== READ-ONLY MODE ===
You have NO file editing tools. Do not create, change, or delete files.
...
Follow `AGENTS.md`. Keep plans executable, dependency-aware, and explicit about validation. Do not increase tech-debt budgets. Leave `.env` unchanged.
