...
## 3. Anti-Pattern Detection Quick Reference
...
## 8. Dual Verification Protocol

**MANDATORY** before any architecture assertion:

1. Read **actual code** (don't assume)
2. Verify each finding **twice** (different commands/methods)
3. Provide **exact references** `file:line`
4. Cross-check against **Valid Exceptions** (§4)

---

## 9. Key Files for Audit
