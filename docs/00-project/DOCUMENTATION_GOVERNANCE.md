...
2. **Create PR**: Include documentation updates with code changes
3. **Review**: Documentation owner + peer review
4. **Approve**: Documentation lead sign-off
5. **Merge**: Automated publishing trigger

### Deprecation Process

1. **Mark as Legacy**: Add deprecation notice
2. **Redirect**: Implement redirect if applicable
3. **Archive**: Move to `docs/99-archive/` after 2 releases
4. **Remove**: Delete after 1 year in archive (with notice)
...
2. **Review Period**: 2-week comment period
3. **DWG Review**: Working group discussion
4. **Decision**: Approve/reject/modify
5. **Implementation**: PR with changes
6. **Announcement**: Communicate changes to stakeholders
...
2. `scripts/docs_parity_check.py` - Configuration parity
...
2. **PR Templates**: Documentation checklist for contributors
3. **Automated Reminders**: Bot comments for missing documentation
4. **Quality Reports**: Visibility into documentation health
5. **Governance Reviews**: Regular compliance audits
...
3. **Propose**: Create improvement plan
