...
| ------------ | --------------------------------- | ------------------------------ | ----------------------- | ------------------- | ----------------------------------------------------------------------------- |
| **ChEMBL**   | `httpx` via `UnifiedHTTPClient`   | 0.1 req/sec (burst 1)          | Exponential backoff     | Public              | `GET /chembl/api/data/status`                                                 |
...
| **OpenAlex** | `httpx` via `UnifiedHTTPClient`   | 10 req/sec (polite pool)       | 429 -> backoff          | API Key (`BIOETL_OPENALEX_API_KEY`; email is attribution only) | Generic Probe\*                                                               |
