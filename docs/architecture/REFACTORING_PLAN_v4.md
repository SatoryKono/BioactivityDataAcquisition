...
|------|------------|---------|
| `composition_root.py` | `_default_root` | `get_default_root()` |
...
```python
# src/bioetl/domain/provider_registry.py:76-78
...
# def get_default_root() -> CompositionRoot: ...
...
```python
# infrastructure/chembl/model_registry.py:119
_default_registry = None

# infrastructure/observability/server.py:23
