...
- `05-file-structure-refactor.md` — план приведения файлов к целевой слоистой архитектуре.

## Навигация
Для обзора проекта начните с `docs/overview/02-architecture-overview.md`. За справочниками по API и схемам переходите в `docs/reference/*`, за практическими шагами — в `docs/guides/*`, а за конкретными пайплайнами — в `docs/02-pipelines/chembl/*`.
