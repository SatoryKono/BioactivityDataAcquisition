...
Эти правила описывают, как работать в Cursor с кодом и документацией проекта, сохраняя детерминизм, трассируемость и соответствие контрактам данных.
...
- Пре-коммиты: ruff, black, isort, mypy, pytest, coverage.
- Минимальный порог `pytest --cov=src/bioetl` — 85%.
