...
## Зависимости
Опирается на базовые компоненты: UnifiedAPIClient, SchemaRegistry, ValidationService, UnifiedOutputWriter. Схемы и контракты описаны в `docs/infrastructure/core/*` и `docs/domain/schemas/00-schemas-overview.md`.
