...
| Runtime failures / lag / blocker drift | `bioetl-runtime` | trust-gated `Runtime Status`, `Metrics Evidence`, `Monitor Active Blocker Count`, `Runtime Blockers`; `INCOMPLETE` means repair scrape/rules first |
