...
5. Зафиксировать конечную конфигурацию в `docs/03-guides/development/pycharm-baseline.md` (или зеркально в актуальной локальной runtime-структуре, если путь отличается).
