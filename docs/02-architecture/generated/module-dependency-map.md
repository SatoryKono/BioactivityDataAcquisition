...
- Scanned modules: `1469`
- Internal import edges (raw): `5499`
...
| ---------------- | ---------------- | ------: | ------- |
| `application`    | `application`    |     857 | allowed |
| `application`    | `domain`         |     873 | allowed |
...
| `application.services`    | `domain.control_plane`         |       9 |
