...
- Internal import edges (raw): `7719`
...
flowchart LR
    ...
    application -->|1348 OK| application
...
| ---------------- | ---------------- | ------: | ------- |
| `application`    | `application`    |    1348 | allowed |
...
| `composition.runtime_builders` | `infrastructure.config`         |      23 |
