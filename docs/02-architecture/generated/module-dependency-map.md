...
- Internal import edges (raw): `6750`
...
| ---------------- | ---------------- | ------: | ------- |
| `application`    | `application`    |    1123 | allowed |
| `application`    | `domain`         |     995 | allowed |
