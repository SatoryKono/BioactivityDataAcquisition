...
- Internal import edges (raw): `7288`
...
| `composition`    | `composition`    |     596 | allowed |
...
| `infrastructure` | `infrastructure` |     954 | allowed |
