...
- Internal import edges (raw): `4452`
...
flowchart LR
    ...
    composition -->|312 OK| composition
    composition -->|234 OK| domain
...
| `composition` | `composition` | 312 | allowed |
| `composition` | `domain` | 234 | allowed |
...
| `composition.factories` | `domain.ports` | 41 |
