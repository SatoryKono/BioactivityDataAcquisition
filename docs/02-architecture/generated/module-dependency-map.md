...
- Scanned modules: `1073`
- Internal import edges (raw): `4026`
...
flowchart LR
    ...
    application -->|479 OK| application
    application -->|631 OK| domain
...
|---|---|---:|---|
| `application` | `application` | 479 | allowed |
| `application` | `domain` | 631 | allowed |
