...
- Internal import edges (raw): `7527`
...
flowchart LR
    ...
    interfaces -->|65 OK| domain
    interfaces -->|382 OK| interfaces
```
...
| `interfaces`     | `domain`         |      65 | allowed |
| `interfaces`     | `interfaces`     |     382 | allowed |
