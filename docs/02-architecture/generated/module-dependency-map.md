...
- Scanned modules: `1925`
- Internal import edges (raw): `7682`
...
| ---------------- | ---------------- | ------: | ------- |
| `application`    | `application`    |    1312 | allowed |
...
| `composition`    | `infrastructure` |     337 | allowed |
| `domain`         | `domain`         |    1293 | allowed |
