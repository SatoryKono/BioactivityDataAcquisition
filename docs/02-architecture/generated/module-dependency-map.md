...
- Scanned modules: `1318`
- Internal import edges (raw): `5046`
...
| `application` | `domain` | 741 | allowed |
...
| `application.services` | `domain.types` | 31 |
