...
- Scanned modules: `714`
- Internal import edges (raw): `2732`
...
flowchart LR
    ...
    infrastructure -->|383 OK| domain
    infrastructure -->|365 OK| infrastructure
...
| `infrastructure` | `domain` | 383 | allowed |
| `infrastructure` | `infrastructure` | 365 | allowed |
