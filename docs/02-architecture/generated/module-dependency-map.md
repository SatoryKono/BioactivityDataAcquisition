...
- Internal import edges (raw): `7794`
...
flowchart LR
    ...
    application -->|1357 OK| application
    application -->|1169 OK| domain
...
| ---------------- | ---------------- | ------: | --------- |
| `application`    | `application`    |    1357 | allowed   |
| `application`    | `domain`         |    1169 | allowed   |
...
| `application.services`         | `domain.types`                  |      70 |
