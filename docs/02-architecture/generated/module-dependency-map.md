...
- Scanned modules: `2407`
- Internal import edges (raw): `7503`
...
| `application`    | `domain`         |     971 | allowed |
...
| ------------------------------ | ------------------------------------------ | ------: |
| `application.services`         | `domain.control_plane`                     |     134 |
...
| `interfaces.http`              | `application.services`                     |      13 |
