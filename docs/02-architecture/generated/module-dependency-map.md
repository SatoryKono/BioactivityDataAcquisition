...
- Scanned modules: `1872`
- Internal import edges (raw): `7489`
...
flowchart LR
    ...
    interfaces -->|54 OK| domain
    interfaces -->|216 OK| interfaces
```
...
| `interfaces`     | `domain`         |      54 | allowed |
| `interfaces`     | `interfaces`     |     216 | allowed |
