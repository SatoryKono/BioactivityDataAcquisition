...
- Scanned modules: `1382`
- Internal import edges (raw): `5278`
...
flowchart LR
    ...
    application -->|726 OK| application
...
|---|---|---:|---|
| `application` | `application` | 726 | allowed |
...
| `interfaces` | `interfaces` | 305 | allowed |
