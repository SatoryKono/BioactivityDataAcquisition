...
- Scanned modules: `1884`
- Internal import edges (raw): `7554`
...
flowchart LR
    ...
    application -->|1262 OK| application
    application -->|1125 OK| domain
...
| ---------------- | ---------------- | ------: | ------- |
| `application`    | `application`    |    1262 | allowed |
| `application`    | `domain`         |    1125 | allowed |
