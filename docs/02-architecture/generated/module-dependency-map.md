...
- Scanned modules: `2260`
- Internal import edges (raw): `7048`
...
| ---------------- | ---------------- | ------: | ------- |
| `application`    | `application`    |    1350 | allowed |
| `application`    | `domain`         |     882 | allowed |
| `composition`    | `application`    |     150 | allowed |
| `composition`    | `composition`    |     684 | allowed |
