...
- Scanned modules: `840`
- Internal import edges (raw): `3188`
...
|---|---|---:|---|
| `application` | `application` | 340 | allowed |
| `application` | `domain` | 521 | allowed |
...
| `interfaces` | `interfaces` | 85 | allowed |
