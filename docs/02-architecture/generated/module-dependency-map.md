...
- Internal import edges (raw): `4009`
...
flowchart LR
    ...
    application -->|478 OK| application
    application -->|623 OK| domain
...
|---|---|---:|---|
| `application` | `application` | 478 | allowed |
| `application` | `domain` | 623 | allowed |
