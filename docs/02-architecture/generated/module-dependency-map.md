...
- Internal import edges (raw): `7645`
...
flowchart LR
    ...
    application -->|1299 OK| application
    application -->|1140 OK| domain
...
| ---------------- | ---------------- | ------: | ------- |
| `application`    | `application`    |    1299 | allowed |
| `application`    | `domain`         |    1140 | allowed |
