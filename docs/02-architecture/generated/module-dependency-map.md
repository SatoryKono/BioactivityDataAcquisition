...
- Scanned modules: `1434`
- Internal import edges (raw): `5454`
...
| `infrastructure` | `domain`         |     640 | allowed |
...
| `composition.factories`   | `domain.ports`                 |      52 |
...
| `composition.factories`   | `domain.types`                 |      30 |
