...
| `infrastructure` | `domain`         |     741 | allowed |
| `infrastructure` | `infrastructure` |     946 | allowed |
...
| `interfaces`     | `interfaces`     |     249 | allowed |
