...
- Scanned modules: `1383`
- Internal import edges (raw): `5256`
...
|---|---|---:|---|
| `application` | `application` | 731 | allowed |
| `application` | `domain` | 827 | allowed |
