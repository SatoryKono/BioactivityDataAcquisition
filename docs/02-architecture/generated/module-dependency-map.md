...
- Scanned modules: `1722`
- Internal import edges (raw): `6774`
...
flowchart LR
    ...
    application -->|1135 OK| application
    application -->|1002 OK| domain
...
| ---------------- | ---------------- | ------: | ------- |
| `application`    | `application`    |    1135 | allowed |
| `application`    | `domain`         |    1002 | allowed |
