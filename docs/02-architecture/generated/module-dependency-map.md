...
- Scanned modules: `1200`
- Internal import edges (raw): `4462`
...
flowchart LR
    ...
    composition -->|237 OK| domain
    composition -->|222 OK| infrastructure
...
| `composition` | `domain` | 237 | allowed |
| `composition` | `infrastructure` | 222 | allowed |
