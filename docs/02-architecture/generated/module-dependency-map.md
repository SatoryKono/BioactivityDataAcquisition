...
- Scanned modules: `1083`
- Internal import edges (raw): `4104`
...
flowchart LR
    ...
    application -->|506 OK| application
    application -->|646 OK| domain
...
|---|---|---:|---|
| `application` | `application` | 506 | allowed |
| `application` | `domain` | 646 | allowed |
