...
- Internal import edges (raw): `7711`
...
| `application.services`         | `domain.types`                             |      81 |
...
| `application.services`         | `domain.ports`                             |      48 |
