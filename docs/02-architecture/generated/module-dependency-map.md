...
- Scanned modules: `2267`
- Internal import edges (raw): `7110`
...
| ---------------- | ---------------- | ------: | ------- |
| `application`    | `application`    |    1365 | allowed |
| `application`    | `domain`         |     881 | allowed |
...
| `interfaces`     | `interfaces`     |     354 | allowed |
