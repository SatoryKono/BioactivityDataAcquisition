...
- Internal import edges (raw): `7775`
...
flowchart LR
    ...
    application -->|1359 OK| application
...
| ---------------- | ---------------- | ------: | ------- |
| `application`    | `application`    |    1359 | allowed |
...
| `interfaces`     | `interfaces`     |     271 | allowed |
