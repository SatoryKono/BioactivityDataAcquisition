...
- Scanned modules: `1271`
- Internal import edges (raw): `4879`
...
|---|---|---:|---|
| `application` | `application` | 613 | allowed |
| `application` | `domain` | 704 | allowed |
...
| `application.services` | `domain.ports` | 33 |
