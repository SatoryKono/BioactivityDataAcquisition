...
- Scanned modules: `1833`
- Internal import edges (raw): `7311`
...
| ---------------- | ---------------- | ------: | ------- |
| `application`    | `application`    |    1205 | allowed |
| `application`    | `domain`         |    1089 | allowed |
...
| `interfaces`     | `interfaces`     |     197 | allowed |
