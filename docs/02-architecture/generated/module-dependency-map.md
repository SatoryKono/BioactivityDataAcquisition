...
- Scanned modules: `1868`
- Internal import edges (raw): `7446`
...
flowchart LR
    ...
    interfaces -->|51 OK| domain
    interfaces -->|215 OK| interfaces
```
...
| `interfaces`     | `domain`         |      51 | allowed |
| `interfaces`     | `interfaces`     |     215 | allowed |
