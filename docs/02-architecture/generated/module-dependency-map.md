...
- Scanned modules: `697`
- Internal import edges (raw): `2562`
...
| `infrastructure.adapters` | `domain.ports` | 49 |
| `infrastructure.adapters` | `domain.types` | 45 |
...
| `composition.factories` | `domain.types` | 9 |
...
| `composition.factories` | `domain.context` | 5 |
