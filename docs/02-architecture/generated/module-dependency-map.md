...
- Scanned modules: `1867`
- Internal import edges (raw): `7443`
...
flowchart LR
    ...
    interfaces -->|50 OK| domain
    interfaces -->|213 OK| interfaces
```
...
| `interfaces`     | `domain`         |      50 | allowed |
| `interfaces`     | `interfaces`     |     213 | allowed |
