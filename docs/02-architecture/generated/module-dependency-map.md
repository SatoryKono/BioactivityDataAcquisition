...
- Scanned modules: `2242`
- Internal import edges (raw): `6990`
...
flowchart LR
    ...
    application -->|1338 OK| application
...
| ---------------- | ---------------- | ------: | ------- |
| `application`    | `application`    |    1338 | allowed |
...
| `interfaces`     | `interfaces`     |     350 | allowed |
