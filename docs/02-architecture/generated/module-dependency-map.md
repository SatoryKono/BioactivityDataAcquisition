...
- Scanned modules: `1215`
- Internal import edges (raw): `4551`
...
| `infrastructure` | `domain` | 553 | allowed |
...
| `infrastructure.adapters` | `domain.types` | 88 |
| `infrastructure.adapters` | `domain.ports` | 74 |
