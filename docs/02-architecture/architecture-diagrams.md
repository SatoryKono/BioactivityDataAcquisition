...
**Файл:** [`docs/02-architecture/diagrams/01_five_layer_architecture.mmd`](diagrams/mermaid/01_five_layer_architecture.mmd)
...
**Файл:** [`docs/02-architecture/diagrams/03_hexagonal_architecture.mmd`](diagrams/mermaid/03_hexagonal_architecture.mmd)
...
**Файл:** [`docs/02-architecture/diagrams/04_layer_dependency_matrix.mmd`](diagrams/mermaid/04_layer_dependency_matrix.mmd)
...
**Файл:** [`docs/02-architecture/diagrams/05_medallion_architecture.mmd`](diagrams/mermaid/05_medallion_architecture.mmd)
...
**Файл:** [`docs/02-architecture/diagrams/02_complete_pipeline_flow.mmd`](diagrams/mermaid/02_complete_pipeline_flow.mmd)
...
**Файл:** [`docs/02-architecture/diagrams/22_silver_merge_operation.mmd`](diagrams/mermaid/22_silver_merge_operation.mmd)
...
**Файл:** [`docs/02-architecture/diagrams/06_domain_model_overview.mmd`](diagrams/mermaid/06_domain_model_overview.mmd)
...
**Файл:** [`docs/02-architecture/diagrams/07_ports_architecture.mmd`](diagrams/mermaid/07_ports_architecture.mmd)
...
**Файл:** [`docs/02-architecture/diagrams/10_pipeline_core_components.mmd`](diagrams/mermaid/10_pipeline_core_components.mmd)
...
**Файл:** [`docs/02-architecture/diagrams/12_error_classification.mmd`](diagrams/mermaid/12_error_classification.mmd)
...
**Файл:** [`docs/02-architecture/diagrams/17_retry_mechanism.mmd`](diagrams/mermaid/17_retry_mechanism.mmd)
...
**Файл:** [`docs/02-architecture/diagrams/15_circuit_breaker_states.mmd`](diagrams/mermaid/15_circuit_breaker_states.mmd)
...
**Файл:** [`docs/02-architecture/diagrams/24_graceful_shutdown.mmd`](diagrams/mermaid/24_graceful_shutdown.mmd)
...
**Файл:** [`docs/02-architecture/diagrams/25_pipeline_config_structure.mmd`](diagrams/mermaid/25_pipeline_config_structure.mmd)
