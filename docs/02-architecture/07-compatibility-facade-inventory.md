...
| `src/bioetl/application/services/control_plane/run_manifest_diagnostics_artifact_support.py` | Compatibility shim for moved artifact-support wrappers. | `bioetl.application.services.control_plane.manifest.diagnostics.artifact_support` | `compat-shim` | `bioetl.application.services.control_plane` | `2026-05 compatibility surface cleanup` | `src`: only `bioetl.application.services.control_plane` and manifest callers may import this shim until deprecation review. | `2026-09-30` | Migrate all direct imports to `bioetl.application.services.control_plane.manifest.diagnostics.artifact_support` and keep this shim only for transition compatibility. | No first-party `src` imports of `run_manifest_diagnostics_artifact_support` remain except transitional calls. |
| `src/bioetl/application/services/control_plane/run_manifest_diagnostics_base.py` | Compatibility shim for moved base wrappers. | `bioetl.application.services.control_plane.manifest.diagnostics.base` | `compat-shim` | `bioetl.application.services.control_plane` | `2026-05 compatibility surface cleanup` | `src`: only `bioetl.application.services.control_plane` and manifest callers may import this shim until deprecation review. | `2026-09-30` | Migrate all direct imports to `bioetl.application.services.control_plane.manifest.diagnostics.base` and keep this shim only for transition compatibility. | No first-party `src` imports of `run_manifest_diagnostics_base` remain except transitional calls. |
| `src/bioetl/application/services/control_plane/run_manifest_diagnostics_base_helpers.py` | Compatibility shim for moved base helper wrappers. | `bioetl.application.services.control_plane.manifest.diagnostics.helpers` | `compat-shim` | `bioetl.application.services.control_plane` | `2026-05 compatibility surface cleanup` | `src`: only `bioetl.application.services.control_plane` and manifest callers may import this shim until deprecation review. | `2026-09-30` | Migrate all direct imports to `bioetl.application.services.control_plane.manifest.diagnostics.helpers` and keep this shim only for transition compatibility. | No first-party `src` imports of `run_manifest_diagnostics_base_helpers` remain except transitional calls. |
| `src/bioetl/application/services/control_plane/run_manifest_diagnostics_checkpoint_projection.py` | Compatibility shim for moved checkpoint-projection wrappers. | `bioetl.application.services.control_plane.manifest.diagnostics.checkpoint_projection` | `compat-shim` | `bioetl.application.services.control_plane` | `2026-05 compatibility surface cleanup` | `src`: only `bioetl.application.services.control_plane` and manifest callers may import this shim until deprecation review. | `2026-09-30` | Migrate all direct imports to `bioetl.application.services.control_plane.manifest.diagnostics.checkpoint_projection` and keep this shim only for transition compatibility. | No first-party `src` imports of `run_manifest_diagnostics_checkpoint_projection` remain except transitional calls. |
| `src/bioetl/application/services/control_plane/run_manifest_diagnostics_finalization.py` | Compatibility shim for moved finalization wrappers. | `bioetl.application.services.control_plane.manifest.diagnostics.finalization` | `compat-shim` | `bioetl.application.services.control_plane` | `2026-05 compatibility surface cleanup` | `src`: only `bioetl.application.services.control_plane` and manifest callers may import this shim until deprecation review. | `2026-09-30` | Migrate all direct imports to `bioetl.application.services.control_plane.manifest.diagnostics.finalization` and keep this shim only for transition compatibility. | No first-party `src` imports of `run_manifest_diagnostics_finalization` remain except transitional calls. |
| `src/bioetl/application/services/control_plane/run_manifest_diagnostics_replay.py` | Compatibility shim for moved replay wrappers. | `bioetl.application.services.control_plane.manifest.diagnostics.replay` | `compat-shim` | `bioetl.application.services.control_plane` | `2026-05 compatibility surface cleanup` | `src`: only `bioetl.application.services.control_plane` and manifest callers may import this shim until deprecation review. | `2026-09-30` | Migrate all direct imports to `bioetl.application.services.control_plane.manifest.diagnostics.replay` and keep this shim only for transition compatibility. | No first-party `src` imports of `run_manifest_diagnostics_replay` remain except transitional calls. |
| `src/bioetl/application/services/control_plane/run_manifest_diagnostics_replay_projection.py` | Compatibility shim for moved replay-projection wrappers. | `bioetl.application.services.control_plane.manifest.diagnostics.replay_projection` | `compat-shim` | `bioetl.application.services.control_plane` | `2026-05 compatibility surface cleanup` | `src`: only `bioetl.application.services.control_plane` and manifest callers may import this shim until deprecation review. | `2026-09-30` | Migrate all direct imports to `bioetl.application.services.control_plane.manifest.diagnostics.replay_projection` and keep this shim only for transition compatibility. | No first-party `src` imports of `run_manifest_diagnostics_replay_projection` remain except transitional calls. |
| `src/bioetl/application/services/control_plane/run_manifest_diagnostics_snapshot_support.py` | Compatibility shim for moved snapshot-support wrappers. | `bioetl.application.services.control_plane.manifest.diagnostics.snapshot_support` | `compat-shim` | `bioetl.application.services.control_plane` | `2026-05 compatibility surface cleanup` | `src`: only `bioetl.application.services.control_plane` and manifest callers may import this shim until deprecation review. | `2026-09-30` | Migrate all direct imports to `bioetl.application.services.control_plane.manifest.diagnostics.snapshot_support` and keep this shim only for transition compatibility. | No first-party `src` imports of `run_manifest_diagnostics_snapshot_support` remain except transitional calls. |
| `src/bioetl/application/services/control_plane/run_manifest_diagnostics_source_refs.py` | Compatibility shim for moved source-reference wrappers. | `bioetl.application.services.control_plane.manifest.diagnostics.source_refs` | `compat-shim` | `bioetl.application.services.control_plane` | `2026-05 compatibility surface cleanup` | `src`: only `bioetl.application.services.control_plane` and manifest callers may import this shim until deprecation review. | `2026-09-30` | Migrate all direct imports to `bioetl.application.services.control_plane.manifest.diagnostics.source_refs` and keep this shim only for transition compatibility. | No first-party `src` imports of `run_manifest_diagnostics_source_refs` remain except transitional calls. |
| `src/bioetl/application/services/control_plane/_run_manifest_diagnostics_checkpoint_projection.py` | Compatibility shim for moved checkpoint-projection wrappers. | `bioetl.application.services.control_plane.manifest.diagnostics.checkpoint_projection` | `compat-shim` | `bioetl.application.services.control_plane` | `2026-05 compatibility surface cleanup` | `src`: only `bioetl.application.services.control_plane` and manifest callers may import this shim until deprecation review. | `2026-09-30` | Migrate all direct imports to `bioetl.application.services.control_plane.manifest.diagnostics.checkpoint_projection` and keep this shim only for transition compatibility. | No first-party `src` imports of `_run_manifest_diagnostics_checkpoint_projection` remain except transitional calls. |
...
| `src/bioetl/infrastructure/config/__init__.py` | Permanent public infrastructure config package-root convenience facade that intentionally shields split config loader APIs behind a reviewed export budget. | `bioetl.infrastructure.config` | `public-entrypoint` | `bioetl.infrastructure.config` | `legacy-pre-2026-05` | `src`: use the package-root config facade only for reviewed convenience symbols and keep new imports bounded by the dedicated root-facade inventory. `tests`: public package-root imports may appear in runtime/config contract coverage, while deeper loader modules remain the owner path for focused implementation tests. | `2026-09-30` | Use `bioetl.infrastructure.config` only for the sanctioned convenience exports and prefer owner loader modules when no reviewed facade symbol is needed. | The package-root convenience facade remains the sanctioned public import seam, its reviewed export budget stays bounded, and symbol-level import growth remains governed by the dedicated root-facade inventory. |
