...
| `src/bioetl/application/services/control_plane/run_manifest_diagnostics_artifact_support.py` | Compatibility shim for moved artifact-support wrappers. | `bioetl.application.services.control_plane.manifest.diagnostics.artifact_support` | `compat-shim` | `bioetl.application.services.control_plane` | `2026-05 compatibility surface cleanup` | `src`: only `bioetl.application.services.control_plane` and manifest callers may import this shim until deprecation review. | `2026-09-30` | Migrate all direct imports to `bioetl.application.services.control_plane.manifest.diagnostics.artifact_support` and keep this shim only for transition compatibility. | No first-party `src` imports of `run_manifest_diagnostics_artifact_support` remain, except those added during this compatibility transition issue. |
| `src/bioetl/application/services/control_plane/run_manifest_diagnostics_base.py` | Compatibility shim for moved base wrappers. | `bioetl.application.services.control_plane.manifest.diagnostics.base` | `compat-shim` | `bioetl.application.services.control_plane` | `2026-05 compatibility surface cleanup` | `src`: only `bioetl.application.services.control_plane` and manifest callers may import this shim until deprecation review. | `2026-09-30` | Migrate all direct imports to `bioetl.application.services.control_plane.manifest.diagnostics.base` and keep this shim only for transition compatibility. | No first-party `src` imports of `run_manifest_diagnostics_base` remain, except those added during this compatibility transition issue. |
| `src/bioetl/application/services/control_plane/run_manifest_diagnostics_base_helpers.py` | Compatibility shim for moved base-helper wrappers. | `bioetl.application.services.control_plane.manifest.diagnostics.base_summary_helpers` | `compat-shim` | `bioetl.application.services.control_plane` | `2026-05 compatibility surface cleanup` | `src`: only `bioetl.application.services.control_plane` and manifest callers may import this shim until deprecation review. | `2026-09-30` | Migrate all direct imports to `bioetl.application.services.control_plane.manifest.diagnostics.base_summary_helpers` and keep this shim only for transition compatibility. | No first-party `src` imports of `run_manifest_diagnostics_base_helpers` remain, except those added during this compatibility transition issue. |
| `src/bioetl/application/services/control_plane/run_manifest_diagnostics_checkpoint_projection.py` | Compatibility shim for moved checkpoint-projection wrappers. | `bioetl.application.services.control_plane.manifest.diagnostics.checkpoint_projection` | `compat-shim` | `bioetl.application.services.control_plane` | `2026-05 compatibility surface cleanup` | `src`: only `bioetl.application.services.control_plane` and manifest callers may import this shim until deprecation review. | `2026-09-30` | Migrate all direct imports to `bioetl.application.services.control_plane.manifest.diagnostics.checkpoint_projection` and keep this shim only for transition compatibility. | No first-party `src` imports of `run_manifest_diagnostics_checkpoint_projection` remain, except those added during this compatibility transition issue. |
| `src/bioetl/application/services/control_plane/run_manifest_diagnostics_finalization.py` | Compatibility shim for moved finalization wrappers. | `bioetl.application.services.control_plane.manifest.diagnostics.finalization` | `compat-shim` | `bioetl.application.services.control_plane` | `2026-05 compatibility surface cleanup` | `src`: only `bioetl.application.services.control_plane` and manifest callers may import this shim until deprecation review. | `2026-09-30` | Migrate all direct imports to `bioetl.application.services.control_plane.manifest.diagnostics.finalization` and keep this shim only for transition compatibility. | No first-party `src` imports of `run_manifest_diagnostics_finalization` remain, except those added during this compatibility transition issue. |
