...
- `src/` direct imports of `get_default_registry` from `bioetl.composition.registry` outside `src/bioetl/composition/factories/pipeline/registry.py` and `src/bioetl/composition/types.py`: `0`
