...
| Source modules in module coverage inventory | `2440` | `reports/quality/module-coverage-inventory.json` |
| Unmeasured / uncovered modules | `0` / `0` | `reports/quality/module-coverage-inventory.json` |
| Coverage inventory status counts | `1538` fully covered, `899` partially covered, `3` with no executable lines | `reports/quality/module-coverage-inventory.json` |
