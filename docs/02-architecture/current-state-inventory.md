...
| Coverage inventory status counts | `1612` fully covered, `853` partially covered, `4` with no executable lines | `reports/quality/module-coverage-inventory.json` |
