...
| --- | ---: | --- |
| Architecture quality score | `8.57` (`good_targeted_improvements`) | `reports/quality/debt-governance-gates.json`, `reports/quality/architecture-quality-scorecard.json` |
...
| Full-app duplication hotspot baseline | `44` clusters | `reports/quality/full-app-duplication-baseline.json` |
