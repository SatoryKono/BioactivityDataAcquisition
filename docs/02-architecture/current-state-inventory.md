...
| Coverage inventory status counts | `1611` fully covered, `854` partially covered, `4` with no executable lines | `reports/quality/module-coverage-inventory.json` |
