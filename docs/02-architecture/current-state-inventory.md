...
| Source modules in module coverage inventory | `2492` | `reports/quality/module-coverage-inventory.json` (refreshed 2026-09-25) |
...
| Coverage inventory status counts | `2484` fully covered, `7` partially covered, `1` with no executable lines | `reports/quality/module-coverage-inventory.json` (refreshed 2026-09-25) |
