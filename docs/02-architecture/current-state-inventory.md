...
| Source modules in module coverage inventory | `2464` | `reports/quality/module-coverage-inventory.json` |
| Unmeasured / uncovered modules | `0` / `0` | `reports/quality/module-coverage-inventory.json` |
| Coverage inventory status counts | `1563` fully covered, `897` partially covered, `4` with no executable lines | `reports/quality/module-coverage-inventory.json` |
