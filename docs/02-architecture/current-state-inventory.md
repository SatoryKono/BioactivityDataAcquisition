...
| Source modules in module coverage inventory | `2493` | `reports/quality/module-coverage-inventory.json` |
...
| Coverage inventory status counts | `2485` fully covered, `7` partially covered, `1` with no executable lines | `reports/quality/module-coverage-inventory.json` |
...
- Module coverage currently has `0` unmeasured and `0` uncovered source modules
  in `reports/quality/module-coverage-inventory.json`, while `7` modules remain
