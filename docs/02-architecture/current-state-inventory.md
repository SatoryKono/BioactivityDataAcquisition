...
| Coverage inventory status counts | `1570` fully covered, `892` partially covered, `4` with no executable lines | `reports/quality/module-coverage-inventory.json` |
