...
| Source modules in module coverage inventory | `2448` | `reports/quality/module-coverage-inventory.json` |
| Unmeasured / uncovered modules | `0` / `0` | `reports/quality/module-coverage-inventory.json` |
| Coverage inventory status counts | `1546` fully covered, `899` partially covered, `3` with no executable lines | `reports/quality/module-coverage-inventory.json` |
