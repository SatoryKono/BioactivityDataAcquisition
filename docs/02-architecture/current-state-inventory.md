...
| --- | ---: | --- |
| Architecture quality score | `9.25` (`good_targeted_improvements`) | `reports/quality/debt-governance-gates.json`, `reports/quality/architecture-quality-scorecard.json` |
...
| Coverage inventory status counts | `1620` fully covered, `860` partially covered, `4` with no executable lines | `reports/quality/module-coverage-inventory.json` |
