...
| DIAG-T002 | Diagram lint no ERROR             | Проверка правил policy                                   | `scripts/diagrams/lint/lint_diagrams.py`                       | Auto      | PR             | Hard |
...
| DIAG-T008 | Orphan nodes controlled           | Чистота графа                                            | `scripts/diagrams/fix/prune_orphan_nodes.py --check`          | Auto      | PR             | Soft |
...
| DIAG-T014 | SVG text nodes present            | Не потерян текст в SVG                                   | `scripts/diagrams/check/check_svg_text_visibility.py`           | Auto      | PR             | Hard |
| DIAG-T015 | Edge labels present               | Не потеряны подписи связей                               | `scripts/diagrams/check/check_svg_text_visibility.py`           | Auto      | PR             | Hard |
...
| DIAG-T018 | Link style guide compliance       | Семантика линий                                          | `scripts/diagrams/check/check_diagram_quality_gates.py`         | Auto      | PR             | Hard |
| DIAG-T019 | classDef coverage                 | Типизация узлов                                          | `scripts/diagrams/check/check_diagram_quality_gates.py`         | Auto      | PR             | Soft |
| DIAG-T020 | Large diagram decomposition       | Наличие L1/L2/L3                                         | `scripts/diagrams/check/check_diagram_quality_gates.py`         | Auto      | PR             | Hard |
| DIAG-T021 | Legend present for large          | Пояснение семантики                                      | `scripts/diagrams/check/check_diagram_quality_gates.py`         | Auto      | PR             | Hard |
| DIAG-T022 | Label length threshold            | Читаемость текста                                        | `scripts/diagrams/check/check_diagram_quality_gates.py`         | Auto      | PR             | Soft |
| DIAG-T023 | `<br/>` overuse check             | Снижение рендер-рисков                                   | `scripts/diagrams/check/check_diagram_quality_gates.py`         | Auto      | PR             | Soft |
...
| DIAG-T033 | Class method render integrity     | Целостность сигнатур методов в classDiagram              | `scripts/diagrams/check/check_class_method_render_integrity.py` | Auto      | PR             | Hard |
...
1. Добавлен `scripts/diagrams/check/check_diagram_quality_gates.py` (DIAG-T018..T023).
