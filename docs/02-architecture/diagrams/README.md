...
| `architecture/13-port-protocol-contracts.mmd`                    | `architecture/13g-port-contracts-data-sources.mmd`, `architecture/13h-port-contracts-storage.mmd`, `architecture/13i-port-contracts-observability.mmd`, `architecture/13d-port-contracts-services.mmd`                           |
