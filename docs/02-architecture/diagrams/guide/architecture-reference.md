...
1. [Обзорные Архитектурные Диаграммы](#architecture-overview)
1. [Потоки Данных](#data-flows)
1. [Компонентные Диаграммы](#component-diagrams)
1. [Паттерны и Механизмы](#patterns-and-mechanisms)
1. [Конфигурация и Схемы](#configuration-and-schemas)
...
## 3. Компонентные Диаграммы { #component-diagrams }
...
## 4. Паттерны и Механизмы { #patterns-and-mechanisms }
...
## 5. Конфигурация и Схемы { #configuration-and-schemas }
...
Скрипт рендеринга: [`render.sh`](../tooling/render.sh) или `python -m scripts.diagrams render`.
