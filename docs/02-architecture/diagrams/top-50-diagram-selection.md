...
*Scoring aligned with RULES.md v5.22 and codebase analysis of 534 Python files*
...
*Selection based on analysis of RULES.md v5.22, 34 ADRs, and 534 Python source files across 5 architectural layers.*
