...
- **Файлы**: kebab-case, префикс `NN-`, формат `NN-<entity>-<provider>-<topic>.md` для pipeline docs
...
- Атомарная запись (temp → os.replace) для файлов
...
- `00-rules-summary.md` — краткая сводка правил
- `01-new-entity-implementation-policy.md` — политика ABC/Default/Impl
- `02-new-entity-naming-policy.md` — полная политика именования
- `03-python-code-style.md` — стиль Python кода
- `10-documentation-standards.md` — стандарты документации

> Content merged into [00-rules-summary.md](./00-rules-summary.md), the authoritative quick overview for BioETL rules.
