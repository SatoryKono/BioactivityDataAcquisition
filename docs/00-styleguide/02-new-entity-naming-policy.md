...
|    ID | Rule ID | Описание (не менее 20 слов)                                                                                                                                                                  |                                                                  Identifier regexes | Актуальность |
| ----: | ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------: | -----------: |
| 06.06 | DOC-004 | Pipeline-документы для `provider/entity` размещаются в `docs/02-pipelines/<provider>/<entity>/NN-<entity>-<provider>-<topic>.md` для строгой связи документа и соответствующего кода пайплайна. | `^docs/02-pipelines/[a-z0-9_]+/[a-z0-9_]+/\d{2}-[a-z0-9_]+-[a-z0-9_]+-[a-z0-9_]+\.md$` |         true |
