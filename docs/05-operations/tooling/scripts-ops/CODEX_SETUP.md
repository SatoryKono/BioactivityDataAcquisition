...
2. **Use read-only sandbox**: When exploring unfamiliar code
3. **Iterative refinement**: Ask follow-up questions in same session
4. **Version control**: Always review changes before applying
5. **Test thoroughly**: Codex output should be reviewed before production
