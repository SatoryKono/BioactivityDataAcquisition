...
1. **Use context**: Ask clarifying questions in the same session
1. **Always review**: Check Codex output before accepting changes
1. **Test after**: Run unit tests after applying code changes
1. **Save sessions**: Codex saves session history for resume
