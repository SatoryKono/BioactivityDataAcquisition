...
| Issue                                | Solution                                                                                                                                |
| ------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------- |
| **"Container is NOT RUNNING"**       | Start it: `docker run -d --name bioetl-neo4j -p 7474:7474 -p 7687:7687 -e NEO4J_AUTH=neo4j/[REDACTED] neo4j:5.15-community` |
...
docker exec -it bioetl-neo4j cypher-shell -u neo4j -p [REDACTED]
