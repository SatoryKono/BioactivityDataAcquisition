...
1. Run the workflow with workflow_dispatch or execute locally:
       ...
       python -m scripts.engineering.repo.github_settings_review --json-out reports/quality/github-settings-review.json --markdown-out reports/quality/github-settings-review.md
