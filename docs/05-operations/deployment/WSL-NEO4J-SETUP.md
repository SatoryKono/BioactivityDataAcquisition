...
| `scripts/ops/load_repo_env.sh` | Env variable loader |
...
docker exec bioetl-neo4j cypher-shell -u neo4j -p [REDACTED] "RETURN 1"
...
4. Falls back to defaults: `neo4j/[REDACTED]`
