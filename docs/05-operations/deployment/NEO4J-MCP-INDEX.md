...
| `scripts/ops/mcp_neo4j_memory_wrapper.sh` | MCP wrapper script | ✅ Ready |
...
NEO4J_PASSWORD=[REDACTED]     # Password
NEO4J_DATABASE=neo4j                      # Database name

# Alternative (parses to above)
NEO4J_AUTH=neo4j/[REDACTED]   # Format: username/password

# Individual credential overrides
NEO4J_AUTH_USERNAME=neo4j
NEO4J_AUTH_PASSWORD=[REDACTED]
```
...
- **Project MCP Config**: `scripts/dev/setup_copilot_codex_mcp.py`
