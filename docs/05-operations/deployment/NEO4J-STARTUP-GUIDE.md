...
- **Username**: `neo4j`
- **Password**: `[REDACTED]` (или ваша кастомная пароль)
...
| `NEO4J_PASSWORD` | `NEO4J_AUTH` или `NEO4J_AUTH_PASSWORD` | `[REDACTED]` |
...
1. ✅ Запустить Neo4j: `docker run -d --name bioetl-neo4j -p 7474:7474 -p 7687:7687 -e NEO4J_AUTH=neo4j/[REDACTED] neo4j:5.15-community`
