...
Operator topology companion to
[01-monitoring-guide.md](01-monitoring-guide.md). Optional ADR-010 stack;
do not start `docker-compose.monitoring.yml` unless dashboard/render work is
