...
2. **Fallback**: Unknown types map to `OTHER`
3. **Usage**: Used in publication enrichment pipelines
...
2. **Consistency**: Designed to be consistent with CrossRef mappings where possible
3. **Extensibility**: New OpenAlex types can be added without breaking existing mappings
