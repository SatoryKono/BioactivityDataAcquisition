...
| `author-s2-ids` | `str \| None` | JSON-массив Semantic Scholar author IDs |
| `author-orcids` | `str \| None` | JSON-массив ORCID идентификаторов |
| `author-h-indices` | `str \| None` | JSON-массив h-index значений |
...
| `subject-fields` | `str \| None` | JSON-массив научных областей |
