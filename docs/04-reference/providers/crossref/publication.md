...
| `author_details` | `str \| None` | JSON-массив объектов автора (given, family, orcid, sequence)  |
...
| `publication_type`  | `str \| None` | Сырой тип CrossRef (journal-article, и т.д.)|
| `issn`              | `str \| None` | Основной ISSN                               |
| `issn_list`         | `str \| None` | JSON-массив всех ISSN                       |
| `language`          | `str \| None` | Код языка публикации                        |
| `license_url`       | `str \| None` | URL лицензии                                |
| `subject_keywords`  | `list[str]`   | Предметные области                          |
