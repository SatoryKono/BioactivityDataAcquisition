# composite_publication passport

> Generated documentation projection. Do not edit manually.

- Kind: `pipeline`
- Typed identity: `composite:composite_publication`
- Schema: `1.0.0`
...
```json
{
  ...
  "identity": {
    "aliases": [],
    "entity": "publication",
    "pipeline_id": "composite_publication",
    "pipeline_type": "composite",
    "provider": "composite",
    "status": "active",
    "typed_id": "composite:composite_publication"
  },
  "kind": "pipeline",
  "observability": {
    "correlation_fields": [
  ...
  "source_references": [
    {
      "path": "configs/composites/publication.yaml",
      "role": "composite_config"
    },
    {
      "path": "configs/contracts/composite/publication.yaml",
      "role": "gold_contract"
    }
  ]
}
