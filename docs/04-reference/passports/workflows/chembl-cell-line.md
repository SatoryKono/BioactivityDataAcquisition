...
- `workflow_config`: `configs/workflows/chembl_cell_line.yaml`
...
```json
{
  ...
  "identity": {
    "status": "active",
    "typed_id": "workflow:chembl_cell_line",
    "version": "1.0.0",
    "workflow_id": "chembl_cell_line"
  },
  "kind": "workflow",
  "observability": {
    "correlation_fields": [
  ...
  "source_references": [
    {
      "path": "configs/workflows/chembl_cell_line.yaml",
