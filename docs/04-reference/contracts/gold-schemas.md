...
1. [Обзор](#overview)
1. [Архитектура Gold-слоя](#gold-layer-architecture)
1. [Фильтрация Silver → Gold](#silver-to-gold-filtering)
1. [Контракты по провайдерам](#provider-contracts)
   - [ChEMBL](#chembl)
   - [PubChem](#pubchem)
   - [UniProt](#uniprot)
   - [PubMed](#pubmed)
   ...
   - [Composite](#composite)
1. [Системные поля](#system-fields)
1. [Режимы записи](#write-modes)
1. [Примеры запросов](#query-examples)
...
## Архитектура Gold-слоя { #gold-layer-architecture }
...
## Фильтрация Silver → Gold { #silver-to-gold-filtering }
...
## Контракты по провайдерам { #provider-contracts }
