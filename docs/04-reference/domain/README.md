...
domain events, ports, invariants, and workflow state-machine semantics.
...
3. Use [workflow-state-machine.md](workflow-state-machine.md) for formal
   workflow/control-plane semantics.
4. Use [ports.md](ports.md) and [events.md](events.md) when wiring or auditing
