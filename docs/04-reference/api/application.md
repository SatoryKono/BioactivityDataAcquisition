...
> Curated published reference of sanctioned public seams (not an autogenerated dump). Layer overview: [Application Layer](../../02-architecture/02-application-layer.md)
...
| `application.services`      | Application services (runner, config, export, health, admin)     | No active package-root facade; import defining submodules directly                                          |
