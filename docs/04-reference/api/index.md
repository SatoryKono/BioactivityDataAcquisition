...
- The JSON summary section contains two coupling metrics:
  ...
  - `cross_layer_group_edges_total` — full graph count before slicing; enforced by `test_cross_layer_group_edges_total_budget` with the current ratchet baseline and budget set to `266`.
