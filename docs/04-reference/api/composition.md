...
> Curated published reference of sanctioned public seams (not an autogenerated dump). Layer overview: [Composition Layer](../../02-architecture/05-composition-layer.md)
...
| `composition.services`         | Thin re-exports for metadata/version helpers                | `versioning` namespace only; import owner modules for metadata/version helpers                                                                                                     |
