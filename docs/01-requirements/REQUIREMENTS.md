...
Version: 1.12
Status: active
Aligned with: `docs/00-project/RULES.md` v6.1.5
...
| `REQ-DATA-*`, `REQ-DELTA-*` | Bronze append-only; Silver/Gold Delta; Gold strict/fail-closed (`RULES.md` §2.1) | ADR-001, ADR-002, ADR-018 | `src/bioetl/infrastructure/storage/`, `src/bioetl/domain/schemas/` | `tests/contract/test_gold_*.py`, storage integration tests |
