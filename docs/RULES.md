...
- **5.7** (2025-12-27): Medallion & Determinism Update (Фаза 5). Добавлена §6.1 "Детерминизм и Воспроизводимость". Добавлены секции §2.1.1 и §2.1.2 с описанием режимов записи `SilverWriteMode` и `GoldWriteMode`. Pre-Refactoring Verification Requirement: добавлено требование сверки с CLAUDE.md §0.
