...
- **ChemblWriteService**: формирует артефакты при сохранении (см. `docs/02-pipelines/chembl/17-chembl-write-service.md`)
- **PipelineOutputService**: использует артефакты для сохранения (см. `docs/02-pipelines/core/25-pipeline-output-service.md`)
