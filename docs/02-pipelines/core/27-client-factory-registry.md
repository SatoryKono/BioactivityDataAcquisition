...
- **ChemblCommonPipeline**: использует реестр для получения фабрик клиентов (см. `docs/02-pipelines/chembl/common/18-chembl-common-pipeline.md`)
- **ChemblDescriptorFactory**: использует реестр для создания дескрипторов (см. `docs/02-pipelines/chembl/common/21-chembl-descriptor-factory.md`)
