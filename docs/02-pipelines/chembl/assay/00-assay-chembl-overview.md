...
Пайплайн наследуется от `PipelineBase` и использует общую инфраструктуру ChEMBL-пайплайнов. Наследует общий функционал ChEMBL-пайплайнов и переопределяет точки расширения для специфики assay.
