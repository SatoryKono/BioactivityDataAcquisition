...
- **ChemblCommonPipeline**: использует сервис для извлечения данных (см. `docs/02-pipelines/chembl/common/18-chembl-common-pipeline.md`)
