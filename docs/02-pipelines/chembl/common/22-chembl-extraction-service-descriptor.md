# 22 ChEMBL Extraction Service Descriptor
...
- **ChemblExtractionService**: использует дескриптор для извлечения данных (см. `docs/02-pipelines/chembl/common/20-chembl-extraction-service.md`)
- **ChemblDescriptorFactory**: создаёт дескрипторы (см. `docs/02-pipelines/chembl/common/21-chembl-descriptor-factory.md`)
