...
| Manifest fingerprint               | [manifest/service.py](../../src/bioetl/application/services/control_plane/manifest/service.py)                        | Calls `normalize_run_manifest_spec()`, then canonical JSON, then SHA-256                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| Ledger persist payload             | [ledger/service.py](../../src/bioetl/application/services/control_plane/ledger/service.py)                            | Calls `normalize_run_ledger_payload()` before append                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
- [manifest/service.py](../../src/bioetl/application/services/control_plane/manifest/service.py)
...
- [manifest/service.py](../../src/bioetl/application/services/control_plane/manifest/service.py) already normalizes payloads before hashing
...
- [ledger/service.py](../../src/bioetl/application/services/control_plane/ledger/service.py) already calls `normalize_run_ledger_payload()`
