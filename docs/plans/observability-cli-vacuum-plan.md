...
### O5: Аудит логирования без run_id
...
### O7: Архитектурный тест на f-string в логах
...
### V1: Документация существующей автоматизации

**Статус:** ⏳ Требуется

**Файл:** `docs/operations/vacuum-retention.md` (новый)
