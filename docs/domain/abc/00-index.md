...
- Клиентский контракт: `DataClientABC` (`src/bioetl/domain/clients/contracts.py`).
- Пайплайновые хуки и политики: `PipelineHookABC`, `ErrorPolicyABC` (`src/bioetl/domain/pipelines/contracts.py`).
