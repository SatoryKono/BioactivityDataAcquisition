...
- **SchemaRegistry**: реестр схем (см. `docs/infrastructure/core/05-schema-registry.md`)
- **DefaultValidationService**: сервис валидации (см. `docs/infrastructure/core/06-validation-service.md`)
- **DocumentSchema**: схема документов (см. `docs/application/pipelines/chembl/document/00-document-chembl-overview.md`)
